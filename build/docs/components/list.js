        ...
        return [
            ...
            new e.section([
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.b.list.container([
                            new bsts_1.b.list.item({ active: true }, "An active item"),
                            new bsts_1.b.list.item("A second item"),
                            new bsts_1.b.list.item("A third item"),
                            new bsts_1.b.list.item("A fourth item"),
                            new bsts_1.b.list.item("And a fifth one"),
            ...
            new e.section([
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.b.list.container([
                            new bsts_1.b.list.item({ disabled: true }, "A disabled item"),
                            new bsts_1.b.list.item("A second item"),
                            new bsts_1.b.list.item("A third item"),
                            new bsts_1.b.list.item("A fourth item"),
                            new bsts_1.b.list.item("And a fifth one"),
            ...
            new e.section([
                ...
                new e.text("Use {{b.tabList.item({href:''})}}s to create actionable list group items with hover, disabled, and active states by set {{action:true}} property. Bootstrap separate these pseudo-classes to ensure list groups made of non-interactive elements (like {{h.li}}s or {{h.div}}s) don’t provide a click or tap affordance."),
                new e.text("{{bsts}} not {{b::use the standard}} {{cb::.btn}}{{b:: classes here}}."),
                new e.code({
                    outputAttr: { class: "list-group-w-400px" },
                    output: () => {
                        return new bsts_1.b.tabList.container([
                            new bsts_1.b.tabList.item({ href: "#", active: true }, "The current link item"),
                            new bsts_1.b.tabList.item({ href: "#" }, "A second link item"),
                            new bsts_1.b.tabList.item({ href: "#" }, "A third link item"),
                            new bsts_1.b.tabList.item({ href: "#" }, "A fourth link item"),
                            new bsts_1.b.tabList.item({ disabled: true }, "A disabled link item"),
                        ]);
                    },
                }),
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.b.tabList.container([
                            new bsts_1.b.tabList.item({ href: "#", action: true, active: true }, "The current link item"),
                            new bsts_1.b.tabList.item({ href: "#", action: true }, "A second link item"),
                            new bsts_1.b.tabList.item({ href: "#", action: true }, "A third link item"),
                            new bsts_1.b.tabList.item({ href: "#", action: true }, "A fourth link item"),
                            new bsts_1.b.tabList.item({ disabled: true, action: true }, "A disabled link item"),
                        ]);
                    },
                }),
            ]),
            ...
            new e.section([
                ...
                new e.code({
                    outputAttr: { class: "list-group-w-400px" },
                    output: () => {
                        return new bsts_1.b.list.container({ flush: true }, [
                            new bsts_1.b.list.item("An item"),
                            new bsts_1.b.list.item("A second item"),
                            new bsts_1.b.list.item("A third item"),
                            new bsts_1.b.list.item("A fourth item"),
            ...
            new e.section([
                ...
                new e.code({
                    outputAttr: { class: "list-group-w-400px" },
                    output: () => {
                        return new bsts_1.b.list.container({ numbered: true }, [
                            new bsts_1.b.list.item("A list item"),
                            new bsts_1.b.list.item("A list item"),
                            new bsts_1.b.list.item("A list item"),
                        ]);
                    },
                ...
                new e.code({
                    outputAttr: { class: "list-group-w-400px" },
                    output: () => {
                        return new bsts_1.b.list.container({ numbered: true }, [1, 2, 3].map((_i) => {
                            return new bsts_1.b.list.item({ display: "flex", justifyContent: "between", alignItem: "start" }, [
                                new bsts_1.h.div({ marginStart: 2, marginEnd: "auto" }, [
                                    new bsts_1.h.div({ fontWeight: "bold" }, "Subheading"),
                                    "Content for list item",
                                ]),
                                new bsts_1.b.badge({ bgColor: "primary", rounded: "pill" }, "14"),
                            ]);
                        }));
                    },
                }),
            ...
            new e.section([
                ...
                new e.text("Add {{horizontal:true}} to change the layout of list group items from vertical to horizontal across all breakpoints. Alternatively, choose a responsive variant {{horizontal:'{sm|md|lg|xl|xxl}'}} to make a list group horizontal starting at that breakpoint’s {{min-width}}. Currently {{b::horizontal list groups cannot be combined with flush list groups}}."),
                new e.code({
                    showViewport: true,
                    ...
                    output: () => {
                        ...
                        return [
                            new bsts_1.b.list.container({ horizontal: true }, items),
                            new bsts_1.b.list.container({ horizontal: "sm" }, items),
                            new bsts_1.b.list.container({ horizontal: "md" }, items),
                            new bsts_1.b.list.container({ horizontal: "lg" }, items),
                            new bsts_1.b.list.container({ horizontal: "xl" }, items),
                            new bsts_1.b.list.container({ horizontal: "xxl" }, items),
                            ,
                        ];
                    },
                }),
                ...
                new e.code({
                    ...
                    output: () => {
                        let items = [
                            new bsts_1.b.list.item({ flex: "fill" }, "An item"),
                            new bsts_1.b.list.item({ flex: "fill" }, "A second item"),
                            new bsts_1.b.list.item({ flex: "fill" }, "A third item"),
                        ];
                        return [
                            new bsts_1.b.list.container({ horizontal: true }, items),
                            new bsts_1.b.list.container({ horizontal: "sm" }, items),
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.b.list.container([
                            ...
                            return new bsts_1.b.list.item({ color: i }, `A simple ${i ? i : "default"} list group item`);
                        }));
                    },
                }),
            ]),
            ...
            new e.section([
                ...
                new e.text("The {{color:'<value>'}} property also work with {{action:true}} for {{new b.tabList.item}} component. Note the addition of the hover styles here not present in the previous example. Also supported is the {{active:true}} state; apply it to indicate an active selection on a contextual list group item."),
                new e.code({
                    outputAttr: { class: "list-group-w-400px" },
                    output: () => {
                        return new bsts_1.b.tabList.container([
                            ...
                            return new bsts_1.b.tabList.item({ href: "#", action: true, color: i }, `A simple ${i ? i : "default"} list group item`);
                        }));
                    },
                }),
            ...
            new e.section([
                ...
                new e.code({
                    outputAttr: { class: "list-group-w-400px" },
                    output: () => {
                        return new bsts_1.b.list.container(["first", "second", "third"].map((i) => {
                            return new bsts_1.b.list.item([
                                new bsts_1.b.input({ type: "checkbox", id: `${i}Checkbox`, marginEnd: 2 }),
                                new bsts_1.b.label({ for: `${i}Checkbox`, class: "form-check-label" }, `${bsts_1.core.uppercaseFirst(i)} checkbox`),
                            ]);
                        }));
                    },
                }),
                    ...
                    output: () => {
                        return new bsts_1.b.list.container(["first", "second", "third"].map((i) => {
                            return new bsts_1.b.list.item([
                                ...
                                new bsts_1.b.label({ for: `${i}Radio`, class: "form-check-label" }, `${bsts_1.core.uppercaseFirst(i)} radio`),
                            ]);
                        }));
                    },
                }),
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.b.list.container(["first", "second", "third"].map((i) => {
                            return new bsts_1.b.list.item([
                                new bsts_1.b.input({ type: "checkbox", id: `${i}CheckboxStretched`, marginEnd: 2 }),
                                new bsts_1.b.label({ for: `${i}CheckboxStretched`, class: "form-check-label", stretched: true }, `${bsts_1.core.uppercaseFirst(i)} checkbox`),
                            ]);
                        }));
                    },
                }),
                ...
                new e.code({
                    output: () => {
                        ...
                        return new bsts_1.h.div({ row: true }, [
                            new bsts_1.h.div({ col: [5, "md-4"] }, new bsts_1.b.tabList.container({ id: "list-tab" }, data.map((i, ix) => {
                            ...
                            new bsts_1.h.div({ col: [7, "md-8"] }, new bsts_1.b.tabList.tab.content({ id: "nav-tabContent" }, data.map((i, ix) => {
                                return new bsts_1.b.tabList.tab.pane({
                                    active: ix === 0,
                                    id: `list-${i}`,
                                    labelledby: `#list-${i}-list`,
                                }, `Some placeholder content in a paragraph relating to "${bsts_1.core.uppercaseFirst(i)}". And some more content, used here just to pad out and fill this tab panel. In production, you would obviously have more real content here. And not just text. It could be anything, really. Text, images, forms.`);
                            }))),
                        ]);
                    },
                }),
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        const data = ["home", "profile", "messages", "settings"];
                        return new bsts_1.h.div({ row: true }, [
                            new bsts_1.h.div({ col: [5, "md-4"] }, new bsts_1.b.tabList.container({ id: "list-useprop-tab" }, data.map((i, ix) => {
                                return new bsts_1.b.tabList.item({
                                    active: ix === 0,
                            ...
                            new bsts_1.h.div({ col: [7, "md-8"] }, new bsts_1.b.tabList.tab.content({ id: "nav-useprop-tabContent" }, data.map((i, ix) => {
                                return new bsts_1.b.tabList.tab.pane({
                                    active: ix === 0,
                                    id: `list-useprop-${i}`,
            ...
            new e.section([
                ...
                new e.code({
                    ...
                    output: () => {
                        const btnAttach = new bsts_1.b.button({
                            textWrap: false,
                            on: {
                                click: (e) => {
                                    var _a;
                                    ...
                                    elem.forEach((i) => {
                                        const tabTrigger = bsts_1.b.tabList.init(i);
                        ...
                        }, new bsts_1.b.caption({ icon: "paperclip" }, "Attach tab"));
                        const data = ["home", "profile", "messages", "settings"];
                        return [
                            new bsts_1.h.div({ row: true }, new bsts_1.h.div({ col: [5, "md-4"], display: "grid" }, btnAttach)),
                            new bsts_1.h.div({ row: true }, [
                                new bsts_1.h.div({ col: [5, "md-4"] }, new bsts_1.b.tabList.container({ id: "list-manual-tab" }, data.map((i, ix) => {
                                    return new bsts_1.b.tabList.item({
                                        active: ix === 0,
                                ...
                                new bsts_1.h.div({ col: [7, "md-8"] }, new bsts_1.b.tabList.tab.content({ id: "nav-manual-tabContent" }, data.map((i, ix) => {
                                    return new bsts_1.b.tabList.tab.pane({
                                        active: ix === 0,
                                        id: `list-manual-${i}`,
                ...
                new e.code({
                    ...
                    output: () => {
                        const data = ["home", "profile", "messages", "settings"];
                        return new bsts_1.h.div({ row: true }, [
                            new bsts_1.h.div({ col: [5, "md-4"] }, new bsts_1.b.tabList.container({ id: "list-direct-tab" }, data.map((i, ix) => {
                                return new bsts_1.b.tabList.item({
                                    active: ix === 0,
                                    ...
                                    on: {
                                        click: (e) => {
                                            e.preventDefault();
                                            const target = e.target;
                                            bsts_1.b.tabList.show(target); //direct init and show the tab
                                        },
                                    },
                                }, bsts_1.core.uppercaseFirst(i));
                            }))),
                            new bsts_1.h.div({ col: [7, "md-8"] }, new bsts_1.b.tabList.tab.content({ id: "nav-direct-tabContent" }, data.map((i, ix) => {
                                return new bsts_1.b.tabList.tab.pane({
                                    active: ix === 0,
                                    id: `list-direct-${i}`,
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        const data = ["home", "profile", "messages", "settings"];
                        return new bsts_1.h.div({ row: true }, [
                            new bsts_1.h.div({ col: [5, "md-4"] }, new bsts_1.b.tabList.container({ id: "list-noanimate-tab" }, data.map((i, ix) => {
                                return new bsts_1.b.tabList.item({
                                    active: ix === 0,
                            ...
                            new bsts_1.h.div({ col: [7, "md-8"] }, new bsts_1.b.tabList.tab.content({ id: "nav-noanimate-tabContent" }, data.map((i, ix) => {
                                return new bsts_1.b.tabList.tab.pane({
                                    active: ix === 0,
                                    id: `list-noanimate-${i}`,
                ...
                new e.code({
                    ...
                    output: () => {
                        ...
                        const clickTabEvent = (event) => {
                            ...
                            bsts_1.b.tabList.show(target);
                        };
                        const tabContainer = new bsts_1.h.div({ row: true }, [
                            new bsts_1.h.div({ col: [5, "md-4"] }, new bsts_1.b.tabList.container({ id: "list-method-tab" }, data.map((i, ix) => {
                                return new bsts_1.b.tabList.item({
                                    active: ix === 0,
                            ...
                            new bsts_1.h.div({ col: [7, "md-8"] }, new bsts_1.b.tabList.tab.content({ id: "nav-method-tabContent" }, data.map((i, ix) => {
                                return new bsts_1.b.tabList.tab.pane({
                                    active: ix === 0,
                                    id: `list-method-${i}`,
                        ...
                        const getInstanceButton = new bsts_1.b.button({
                            ...
                            on: {
                                click: (event) => {
                                    ...
                                    let elemInstance = [];
                                    elem.forEach((i) => {
                                        elemInstance.push(bsts_1.b.tabList.getInstance(i));
                                    });
                        ...
                        const getOrCreateInstanceButton = new bsts_1.b.button({
                            ...
                            on: {
                                click: (event) => {
                                    ...
                                    let elemInstance = [];
                                    elem.forEach((i) => {
                                        elemInstance.push(bsts_1.b.tabList.getOrCreateInstance(i));
                                    });
                        ...
                        const showButton = new bsts_1.b.button({
                            on: {
                                click: (event) => {
                                    const elem = document.querySelectorAll("#list-method-tab a");
                                    if (elem) {
                                        let i = elem[bsts_1.core.rndBetween(0, elem.length - 1)];
                                        if (i) {
                                            bsts_1.b.tabList.show(i);
            ...
            new e.section([
                ...
                new e.code({
                    ...
                    output: () => {
                        const data = ["home", "profile", "messages", "settings"];
                        return new bsts_1.h.div({ row: true }, [
                            new bsts_1.h.div({ col: [5, "md-4"] }, new bsts_1.b.tabList.container({ id: "list-event-tab" }, data.map((i, ix) => {
                                return new bsts_1.b.tabList.item({
                                    active: ix === 0,
                            ...
                            new bsts_1.h.div({ col: [7, "md-8"] }, new bsts_1.b.tabList.tab.content({ id: "nav-event-tabContent" }, data.map((i, ix) => {
                                return new bsts_1.b.tabList.tab.pane({
                                    active: ix === 0,
                                    id: `list-event-${i}`,
