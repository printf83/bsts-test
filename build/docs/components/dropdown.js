    ...
    item: () => {
        return [
            new e.section([
                ...
                new e.text("Dropdowns are toggleable ({{b.dropdown.button}}), contextual overlays for displaying lists of links and more using {{b.dropdown.menu}}. They’re made interactive with the included Bootstrap dropdown JavaScript plugin. They’re toggled by clicking, not by hovering; this is {{https://markdotto.com/2012/02/27/bootstrap-explained-dropdowns/::an intentional design decision}}."),
                new e.text("Dropdowns are built on a third party library, {{https://popper.js.org/::Popper}}, which provides dynamic positioning and viewport detection. Be sure to include {{https://cdn.jsdelivr.net/npm/@popperjs/core@2.11.6/dist/umd/popper.min.js::popper.min.js}} before Bootstrap’s JavaScript or use {{bootstrap.bundle.min.js}} / {{bootstrap.bundle.js}} which contains Popper. Popper isn’t used to position dropdowns in navbars though as dynamic positioning isn’t required."),
            ]),
            //----------------------
            new e.section([
                new e.title("Accessibility"),
                new e.text("The {{https://www.w3.org/TR/wai-aria/::WAI ARIA}} standard defines an actual {{https://www.w3.org/TR/wai-aria/#menu::role='menu' widget}}, but this is specific to application-like menus which trigger actions or functions. ARIA menus can only contain menu items, checkbox menu items, radio button menu items, radio button groups, and sub-menus."),
                new e.text("Bootstrap’s dropdowns, on the other hand, are designed to be generic and applicable to a variety of situations and markup structures. For instance, it is possible to create dropdowns that contain additional inputs and form controls, such as search fields or login forms. For this reason, Bootstrap does not expect (nor automatically add) any of the {{role}} and {{aria-}} attributes required for true ARIA menus. Authors will have to include these more specific attributes themselves."),
            ...
            new e.section([
                ...
                new e.text("While {{b.dropdown.button}} is the recommended control for a dropdown toggle, there might be situations where you have to use an {{b.dropdown.button(href:'')}} component that create {{h.a}} component. {{bsts}} automaticly add {{role='button'}} property which recomended by Bootstrap to appropriately convey control’s purpose to assistive technologies such as screen readers."),
                new e.code({
                    output: () => {
                        return new bsts_1.b.dropdown.container([
                            new bsts_1.b.dropdown.button({ color: "secondary", href: "#" }, "Dropdown link"),
                            new bsts_1.b.dropdown.menu([
                                new bsts_1.b.dropdown.item({ href: "#" }, "Action"),
                                new bsts_1.b.dropdown.item({ href: "#" }, "Another action"),
                                new bsts_1.b.dropdown.item({ href: "#" }, "Something else here"),
            ...
            new e.section([
                ...
                new e.text("Bootstrap use this extra property to reduce the horizontal {{padding}} on either side of the caret by 25% and remove the {{margin-left}} that’s added for regular button dropdowns. Those extra changes keep the caret centered in the split button and provide a more appropriately sized hit area next to the main button."),
                new e.code({
                    outputAttr: { display: "flex", flex: "wrap", gap: 2 },
                    output: () => {
                        return ["primary", "secondary", "success", "info", "warning", "danger"].map((i) => {
            ...
            new e.section([
                ...
                new e.code({
                    outputAttr: { display: "flex", flex: "wrap", gap: 2 },
                    output: () => {
                        let menu = new bsts_1.b.dropdown.menu([
                            new bsts_1.b.dropdown.item({ href: "#" }, "Action"),
                            new bsts_1.b.dropdown.item({ href: "#" }, "Another action"),
                            new bsts_1.b.dropdown.item({ href: "#" }, "Something else here"),
                            new bsts_1.b.dropdown.divider(),
                        ...
                        return [
                            new bsts_1.b.dropdown.container([
                                new bsts_1.b.dropdown.button({ color: "secondary", weight: "lg" }, "Large button "),
                                menu,
                            ]),
                            new bsts_1.b.dropdown.container([
                                new bsts_1.b.button({ color: "secondary", weight: "lg" }, "Large split button"),
                                new bsts_1.b.dropdown.button({ color: "secondary", weight: "lg", split: true }),
                                menu,
                            ]),
                        ];
                    },
                ...
                new e.code({
                    ...
                    output: () => {
                        ...
                        return [
                            new bsts_1.b.dropdown.container([
                                new bsts_1.b.dropdown.button({ color: "secondary", weight: "sm" }, "Small button "),
                                menu,
                            ]),
                            new bsts_1.b.dropdown.container([
                                new bsts_1.b.button({ color: "secondary", weight: "sm" }, "Small split button"),
                                new bsts_1.b.dropdown.button({ color: "secondary", weight: "sm", split: true }),
                                menu,
                            ]),
                        ];
                    },
            ...
            new e.section([
                ...
                new e.alert({ color: "warning", callout: true }, "{{b::Heads up!}} Dark variants for components were deprecated in v5.3.0 with the introduction of color modes. Instead of adding {{.dropdown-menu-dark}}, set {{theme:'dark'}} on {{b.dropdown.menu}} component, a parent wrapper ({{new b.dropdown.container}}), or the component itself."),
                new e.code({
                    output: () => {
                        return new bsts_1.b.dropdown.container([
                            new bsts_1.b.dropdown.button({ color: "secondary" }, "Dropdown button"),
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.b.navbar.container({ expand: "lg", theme: "dark", bgColor: "dark" }, new bsts_1.b.navbar.innercontainer({ container: "fluid" }, [
                            ...
                            new bsts_1.b.navbar.collapse({ id: "navbarNavDarkDropdown" }, new bsts_1.b.navbar.itemcontainer([
            ...
            new e.section([
                ...
                new e.alert({ color: "info", callout: true }, "{{b::Directions are flipped in RTL mode}}. As such, {{.dropstart}} will appear on the right side."),
            ]),
            //----------------------
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.dropdown.container({ drop: "down-center" }, [
                            new bsts_1.b.dropdown.button({ color: "secondary" }, "Centered dropdown"),
                            new bsts_1.b.dropdown.menu([
                                new bsts_1.b.dropdown.item({ href: "#" }, "Action"),
                                new bsts_1.b.dropdown.item({ href: "#" }, "Action two"),
                                new bsts_1.b.dropdown.item({ href: "#" }, "Action three"),
                            ]),
                        ]);
                    },
                }),
            ...
            new e.section([
                ...
                new e.code({
                    ...
                    output: () => {
                        ...
                        return [
                            new bsts_1.b.dropdown.container({ drop: "up" }, [
                                new bsts_1.b.dropdown.button({ color: "secondary" }, "Dropup "),
                                menu,
                            ]),
                            new bsts_1.b.dropdown.container({ drop: "up" }, [
                                new bsts_1.b.button({ color: "secondary" }, "Split dropup"),
                                new bsts_1.b.dropdown.button({ color: "secondary", split: true }),
                                menu,
                            ]),
                        ];
                    },
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.dropdown.container({ drop: "up-center" }, [
                            new bsts_1.b.dropdown.button({ color: "secondary" }, "Centered dropup"),
                            new bsts_1.b.dropdown.menu([
                                new bsts_1.b.dropdown.item({ href: "#" }, "Action"),
                                new bsts_1.b.dropdown.item({ href: "#" }, "Action two"),
                                new bsts_1.b.dropdown.item({ href: "#" }, "Action three"),
            ...
            new e.section([
                ...
                new e.code({
                    ...
                    output: () => {
                        ...
                        return [
                            new bsts_1.b.dropdown.container({ drop: "end" }, [
                                new bsts_1.b.dropdown.button({ color: "secondary" }, "Dropend "),
                                menu,
                            ]),
                            new bsts_1.b.dropdown.container({ drop: "end" }, [
                                new bsts_1.b.button({ color: "secondary" }, "Split dropend"),
                                new bsts_1.b.dropdown.button({ color: "secondary", split: true }),
                                menu,
                            ]),
                        ];
            ...
            new e.section([
                ...
                new e.code({
                    ...
                    output: () => {
                        ...
                        return [
                            new bsts_1.b.dropdown.container({ drop: "start" }, [
                                new bsts_1.b.dropdown.button({ color: "secondary" }, " Dropstart"),
                                menu,
                            ]),
                            new bsts_1.b.dropdown.container({ drop: "start" }, [
                                ...
                                new bsts_1.b.dropdown.button({ color: "secondary", split: true }),
                                menu,
                                new bsts_1.b.button({ color: "secondary" }, "Split dropstart"),
                            ]),
                        ];
                    },
                }),
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.dropdown.container([
                            new bsts_1.b.dropdown.button({ color: "secondary" }, "Dropdown button"),
                            new bsts_1.b.dropdown.menu([
                                new bsts_1.b.dropdown.item("Action"),
                                new bsts_1.b.dropdown.item("Another action"),
                                new bsts_1.b.dropdown.item("Something else here"),
                            ]),
                        ]);
                    },
                }),
                ...
                new e.code({
                    showCodepen: false,
                    output: () => {
                        return new bsts_1.b.dropdown.menu({ debug: true }, [
                            new bsts_1.b.dropdown.text("Dropdown item text"),
                            new bsts_1.b.dropdown.item("Action"),
                            new bsts_1.b.dropdown.item("Another action"),
                            new bsts_1.b.dropdown.item("Something else here"),
                        ]);
            ...
            new e.section([
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.b.dropdown.menu({ debug: true }, [
                            new bsts_1.b.dropdown.item({ href: "#" }, "Regular link"),
                            new bsts_1.b.dropdown.item({ href: "#", active: true }, "Active link"),
                            new bsts_1.b.dropdown.item({ href: "#" }, "Another link"),
                        ]);
                    },
                }),
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.b.dropdown.menu({ debug: true }, [
                            new bsts_1.b.dropdown.item({ href: "#" }, "Regular link"),
                            new bsts_1.b.dropdown.item({ href: "#", active: true, current: "page" }, "Active link"),
                            new bsts_1.b.dropdown.item({ href: "#" }, "Another link"),
                        ]);
                    },
                }),
            ...
            new e.section([
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.b.dropdown.menu({ debug: true }, [
                            new bsts_1.b.dropdown.item({ href: "#" }, "Regular link"),
                            new bsts_1.b.dropdown.item({ href: "#", disabled: true }, "Disabled link"),
                            new bsts_1.b.dropdown.item({ href: "#" }, "Another link"),
                        ]);
                    },
                }),
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.dropdown.container([
                            new bsts_1.b.dropdown.button({ color: "secondary" }, "Right-aligned menu example"),
                            new bsts_1.b.dropdown.menu({ positionView: "end" }, [
                                new bsts_1.b.dropdown.item("Action"),
                                new bsts_1.b.dropdown.item("Another action"),
                                new bsts_1.b.dropdown.item("Something else here"),
                            ]),
            ...
            new e.section([
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.b.dropdown.container([
                            new bsts_1.b.dropdown.button({ color: "secondary" }, "Left-aligned but right aligned when large screen"),
                            new bsts_1.b.dropdown.menu({ positionView: "lg-end", positioning: "static" }, [
                                new bsts_1.b.dropdown.item("Action"),
                                new bsts_1.b.dropdown.item("Another action"),
                                new bsts_1.b.dropdown.item("Something else here"),
                            ]),
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.b.dropdown.container([
                            new bsts_1.b.dropdown.button({ color: "secondary" }, "Right-aligned but left aligned when large screen"),
                            new bsts_1.b.dropdown.menu({ positionView: ["end", "lg-start"], positioning: "static" }, [
                                new bsts_1.b.dropdown.item("Action"),
                                new bsts_1.b.dropdown.item("Another action"),
                                new bsts_1.b.dropdown.item("Something else here"),
                            ]),
                ...
                new e.code({
                    ...
                    output: () => {
                        return [
                            ...
                            return new bsts_1.b.dropdown.container({ drop: i.drop }, [
                                new bsts_1.b.dropdown.button({ color: "secondary" }, i.label),
                                new bsts_1.b.dropdown.menu({
                                    positionView: i.positionView,
                                }, [
                                    new bsts_1.b.dropdown.item("Action"),
                                    new bsts_1.b.dropdown.item("Another action"),
                                    new bsts_1.b.dropdown.item("Something else here"),
            ...
            new e.section([
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.b.dropdown.menu({ debug: true }, [
                            new bsts_1.b.dropdown.header("Dropdown header"),
                            new bsts_1.b.dropdown.item({ href: "#" }, "Action"),
                            new bsts_1.b.dropdown.item({ href: "#" }, "Another action"),
                        ]);
                    },
            ...
            new e.section([
                ...
                new e.code({
                    showCodepen: false,
                    output: () => {
                        return new bsts_1.b.dropdown.menu({
                            debug: true,
                            padding: 4,
                            textColor: "body-secondary",
                            style: { maxWidth: "200px" },
                        }, [
                            new bsts_1.h.p("Some example text that's free-flowing within the dropdown menu."),
                            new bsts_1.h.p({ marginBottom: 0 }, "And this is more example text."),
                        ]);
                    },
                }),
            ]),
            ...
            new e.section([
                        ...
                        return new bsts_1.b.dropdown.menu({
                            ...
                            new bsts_1.h.form({
                                ...
                                new bsts_1.h.div({ marginBottom: 3 }, [
                                    new bsts_1.b.label({ for: "exampleDropdownFormEmail1" }, "Email address"),
                                    new bsts_1.b.input({
                                        type: "email",
                                ...
                                new bsts_1.h.div({ marginBottom: 3 }, [
                                    new bsts_1.b.label({ for: "exampleDropdownFormPassword1" }, "Password"),
                                    new bsts_1.b.input({
                                        type: "email",
                                ...
                                new bsts_1.h.div({ marginBottom: 3 }, [
                                    new bsts_1.h.div({ class: "form-check" }, [
                                        ...
                                        new bsts_1.b.label({ for: "dropdownCheck" }, "Remember me"),
                                    ]),
                                ]),
                                new bsts_1.b.button({ type: "submit" }, "Sign in"),
                            ]),
                            new bsts_1.b.dropdown.divider(),
                            new bsts_1.b.dropdown.item({ href: "#" }, "New around here? Sign up"),
                            new bsts_1.b.dropdown.item({ href: "#" }, "Forgot password?"),
                        ]);
                    },
                }),
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.h.div({ class: "dropdown" }, [
                            new bsts_1.b.dropdown.button({ autoClose: "outside" }, "Dropdown form"),
                            new bsts_1.b.dropdown.menu(new bsts_1.h.form({
                                padding: 3,
                            }, [
                                new bsts_1.h.div({ marginBottom: 3 }, [
                                    new bsts_1.b.label({ for: "exampleDropdownFormEmail2" }, "Email address"),
                                    new bsts_1.b.input({
                                        type: "email",
                                ...
                                new bsts_1.h.div({ marginBottom: 3 }, [
                                    new bsts_1.b.label({ for: "exampleDropdownFormPassword2" }, "Password"),
                                    new bsts_1.b.input({
                                        type: "email",
                                ...
                                new bsts_1.h.div({ marginBottom: 3 }, [
                                    new bsts_1.h.div({ class: "form-check" }, [
                                        ...
                                        new bsts_1.b.label({ for: "dropdownCheck2" }, "Remember me"),
                                    ]),
                                ]),
                                new bsts_1.b.button({ type: "submit" }, "Sign in"),
                            ])),
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.dropdown.container([
                            new bsts_1.b.dropdown.button({ autoClose: "outside" }, "Dropdown form"),
                            new bsts_1.b.dropdown.menu({ style: { width: "18rem" } }, new bsts_1.h.form({
                                padding: 3,
                            }, [
                                new bsts_1.h.div({ marginBottom: 3 }, [
                                    new bsts_1.b.label({ for: "exampleDropdownFormEmail3" }, "Email address"),
                                    new bsts_1.b.input({
                                        type: "email",
                                ...
                                new bsts_1.h.div({ marginBottom: 3 }, [
                                    new bsts_1.b.label({ for: "exampleDropdownFormPassword3" }, "Password"),
                                    new bsts_1.b.input({
                                        type: "email",
                                ...
                                new bsts_1.h.div({ marginBottom: 3 }, [
                                    new bsts_1.h.div({ class: "form-check" }, [
                                        ...
                                        new bsts_1.b.label({ for: "dropdownCheck3" }, "Remember me"),
                                    ]),
                                ]),
                                new bsts_1.b.button({ type: "submit" }, "Sign in"),
                            ])),
            ...
            new e.section([
                ...
                new e.code({
                    ...
                    output: () => {
                        ...
                        return [
                            new bsts_1.b.dropdown.container([
                                new bsts_1.b.dropdown.button({ color: "secondary", viewOffset: "10,20" }, "Offset "),
                                menu,
                            ]),
                            new bsts_1.b.dropdown.container([
                                new bsts_1.b.button({ color: "secondary" }, "Reference"),
                                new bsts_1.b.dropdown.button({ color: "secondary", split: true, reference: "parent" }),
                                menu,
                            ]),
                        ];
                    },
            ...
            new e.section([
                ...
                new e.code({
                    ...
                    output: () => {
                        ...
                        return [
                            new bsts_1.b.dropdown.container([
                                new bsts_1.b.dropdown.button({ color: "secondary" }, "Default dropdown "),
                                menu,
                            ]),
                            new bsts_1.b.dropdown.container([
                                new bsts_1.b.dropdown.button({ color: "secondary", autoClose: "inside" }, "Clickable inside "),
                                menu,
                            ]),
                            new bsts_1.b.dropdown.container([
                                new bsts_1.b.dropdown.button({ color: "secondary", autoClose: "outside" }, "Clickable outside "),
                                menu,
                            ]),
                            new bsts_1.b.dropdown.container([
                                new bsts_1.b.dropdown.button({ color: "secondary", autoClose: "manual" }, "Manual close "),
                                menu,
                            ]),
                        ];
                    },
            ...
            new e.section([
                ...
                new e.alert({ color: "info", callout: true }, [
                    ...
                    new bsts_1.h.ul([new bsts_1.h.li("{{--bs-dropdown-item-border-radius}}")]),
                ]),
            ...
            new e.section([
                new e.title("Usage"),
                new e.text("Via data attributes or JavaScript, the dropdown plugin toggles hidden content (dropdown menus) by toggling the {{.show}} class on the parent {{.dropdown-menu}}. The {{data-bs-toggle='dropdown'}} attribute is relied on for closing dropdown menus at an application level, so it’s a good idea to always use it."),
                new e.alert({ color: "info", callout: true }, "On touch-enabled devices, opening a dropdown adds empty {{mouseover}} handlers to the immediate children of the {{<body>}} element. This admittedly ugly hack is necessary to work around a {{https://www.quirksmode.org/blog/archives/2014/02/mouse_event_bub.html::quirk in iOS’ event delegation}}, which would otherwise prevent a tap anywhere outside of the dropdown from triggering the code that closes the dropdown. Once the dropdown is closed, these additional empty {{mouseover}} handlers are removed."),
            ]),
            //----------------------
            new e.section([
                    ...
                    item: [
                        ...
                        [
                            ...
                            [
                                ...
                                new bsts_1.h.ul([
                                    new bsts_1.h.li("{{true}} - the dropdown will be closed by clicking outside or inside the dropdown menu."),
                                    new bsts_1.h.li("{{false}} - the dropdown will be closed by clicking the toggle button and manually calling hide or toggle method. (Also will not be closed by pressing {{k::Esc}} key)"),
                                    new bsts_1.h.li("{{'inside'}} - the dropdown will be closed (only) by clicking inside the dropdown menu."),
                                    new bsts_1.h.li("{{'outside'}} - the dropdown will be closed (only) by clicking outside the dropdown menu."),
                                ]),
            ...
            new e.section([
                ...
                new e.code({
                    ...
                    showConsole: true,
                    output: () => {
                        const dropdownMenu = new bsts_1.b.dropdown.menu({
                            id: "example-dropdown",
                            reference: "parent",
                        }, [
                            new bsts_1.b.dropdown.item({ href: "#" }, "Action"),
                        ...
                        const dropdownContainer = new bsts_1.b.dropdown.container([
                            new bsts_1.b.dropdown.button("Dropdown button"),
                            dropdownMenu,
                        ]);
                        const initButton = new bsts_1.b.button({
                            ...
                            on: {
                                click: (event) => {
                                    const elem = bsts_1.b.dropdown.init("#example-dropdown");
                                    e.console(event.target, "b.dropdown.init", elem ? elem : "null", elem ? "success" : "danger");
                                },
                            },
                        }, "init");
                        const getInstanceButton = new bsts_1.b.button({
                            ...
                            on: {
                                click: (event) => {
                                    const elem = bsts_1.b.dropdown.getInstance("#example-dropdown");
                                    e.console(event.target, "b.dropdown.getInstance", elem ? elem : "null", elem ? "success" : "danger");
                                },
                            },
                        }, "getInstance");
                        const getOrCreateInstanceButton = new bsts_1.b.button({
                            ...
                            on: {
                                click: (event) => {
                                    const elem = bsts_1.b.dropdown.getOrCreateInstance("#example-dropdown");
                                    e.console(event.target, "b.dropdown.getOrCreateInstance", elem, elem ? "success" : "danger");
                                },
                            },
                        }, "getOrCreateInstance");
                        const hideButton = new bsts_1.b.button({
                            on: {
                                click: () => {
                                    bsts_1.b.dropdown.hide("#example-dropdown");
                                },
                            },
                        }, "hide");
                        const showButton = new bsts_1.b.button({
                            on: {
                                click: () => {
                                    bsts_1.b.dropdown.show("#example-dropdown");
                                },
                            },
                        }, "show");
                        const toggleButton = new bsts_1.b.button({
                            on: {
                                click: () => {
                                    bsts_1.b.dropdown.toggle("#example-dropdown");
                                },
                            },
                        }, "toggle");
                        const updateButton = new bsts_1.b.button({
                            on: {
                                click: () => {
                                    bsts_1.b.dropdown.update("#example-dropdown");
                                },
                            },
                        }, "update");
                        const disposeButton = new bsts_1.b.button({
                            ...
                            on: {
                                click: () => {
                                    bsts_1.b.dropdown.dispose("#example-dropdown");
                                },
                            },
                        }, "dispose");
                        ...
                        return new bsts_1.b.dropdown.container({
                            on: {
                                "shown.bs.dropdown": (event) => {
                                    const evnt = event;
                                    e.console(evnt.target, "shown.bs.dropdown", `Target: {{b::${bsts_1.core.elemInfo(evnt.target)}}}{{br}}
											RelatedTarget: {{b::${bsts_1.core.elemInfo(evnt.relatedTarget)}}}`, "success");
                                },
                                "hidden.bs.dropdown": (event) => {
                                    const target = event.target;
                                    e.console(target, "hidden.bs.dropdown", `Target: {{b::${bsts_1.core.elemInfo(target)}}}`, "success");
                                },
                            },
                        }, [
                            new bsts_1.b.dropdown.button({ color: "secondary" }, "Dropdown button"),
