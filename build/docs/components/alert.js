    ...
    item: () => {
        return [
            new e.section([
                ...
                new e.text("Alerts ({{b.alert.container}}) are available for any length of text, as well as an optional close button. For proper styling, use one of the eight required contextual classes (e.g., {{color:'success'}}). For inline dismissal, use the {{nav:docs/components/alert#dismissing::alerts JavaScript plugin}}."),
                ...
                new e.code({
                    output: () => {
                        return ["primary", "secondary", "success", "danger", "warning", "info", "light", "dark"].map((i) => {
                            return new bsts_1.b.alert.container({ color: i }, `A simple ${i} alert—check it out!`);
                        });
                    },
                }),
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return ["primary", "secondary", "success", "danger", "warning", "info", "light", "dark"].map((i) => {
                            return new bsts_1.b.alert.container({ color: i, callout: true }, `A simple ${i} callout—check it out!`);
                        });
                    },
                }),
            ]),
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return [
                            new bsts_1.h.div({ id: "liveAlertPlaceholder" }),
                            new bsts_1.h.div(new bsts_1.b.button({
                                color: "primary",
                                on: {
                                    click: (_e) => {
                                        let container = document.getElementById("liveAlertPlaceholder");
                                        bsts_1.core.appendChild(container, new bsts_1.b.alert.container({ color: "success", dismissible: true }, "Nice, you triggered this alert message!"));
                                    },
                                },
                            }, "Show live alert")),
                        ];
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return ["primary", "secondary", "success", "danger", "warning", "info", "light", "dark"].map((i) => {
                            return new bsts_1.b.alert.container({ color: i }, [
                                `A simple ${i} alert with `,
                                new bsts_1.b.alert.link({ href: "#" }, "an example link"),
                                ".",
                            ]);
                        });
                    },
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.alert.container({ color: "success" }, [
                            new bsts_1.b.alert.header(4, "Well done!"),
                            new bsts_1.h.p("Aww yeah, you successfully read this important alert message. This example text is going to run a bit longer so that you can see how spacing within an alert works with this kind of content."),
                            new bsts_1.h.hr(),
                            new bsts_1.h.p({ marginBottom: 0 }, "Whenever you need to, be sure to use margin utilities to keep things nice and tidy."),
                        ]);
                    },
                }),
            ]),
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.alert.container({ color: "info" }, new bsts_1.b.caption({ gap: 3, icon: bsts_1.b.icon.bi("info-circle-fill", { fontSize: 5 }) }, " An example alert with an icon"));
                    },
                }),
                ...
                new e.code({
                    output: () => {
                        return [
                            { color: "info", icon: bsts_1.b.icon.bi("info-circle-fill", { fontSize: 5 }) },
                            { color: "success", icon: bsts_1.b.icon.bi("check-circle-fill", { fontSize: 5 }) },
                            { color: "warning", icon: bsts_1.b.icon.bi("exclamation-triangle-fill", { fontSize: 5 }) },
                            { color: "danger", icon: bsts_1.b.icon.bi("x-circle-fill", { fontSize: 5 }) },
                        ].map((i) => {
                            return new bsts_1.b.alert.container({ color: i.color }, [
                                new bsts_1.b.caption({ gap: 3, icon: i.icon }, `An example ${i.color} alert with an icon`),
                            ]);
                        });
                    },
                }),
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.alert.container({ color: "warning", dismissible: true }, "{{b::Holy guacamole!}} You should check in on some of those fields below.");
                    },
                }),
                new e.alert({ color: "warning", callout: true }, "When an alert is dismissed, the element is completely removed from the page structure. If a keyboard user dismisses the alert using the close button, their focus will suddenly be lost and, depending on the browser, reset to the start of the page/document. For this reason, Bootstrap recommend including additional JavaScript that listens for the {{on:{'closed.bs.alert':Event} }} and programmatically sets {{focus()}} to the most appropriate location in the page. If you’re planning to move focus to a non-interactive element that normally does not receive focus, make sure to add {{tabindex:'-1'}} to the element."),
            ]),
            //----------------------
            ...
            new e.section([
                ...
                new e.alert({ color: "warning", callout: true }, [
                    new bsts_1.h.p("For the sole purpose of dismissing an alert, it isn’t necessary to initialize the component manually via the JS API. By making use of {{b.alert.btnclose}} component, the alert component will be initialized automatically and properly dismissed."),
                    new bsts_1.h.p("See the {{nav:docs/components/alerts#triggers::triggers}} section for more details."),
                ]),
            ]),
            //----------------------
            new e.section([
            ...
            new e.section([
                ...
                new e.code({
                    showConsole: true,
                    output: () => {
                        const exampleAlert = new bsts_1.h.div({ id: "example-alert-container" }, new bsts_1.b.alert.container({
                            id: "example-alert",
                            animation: true,
                            color: "primary",
                            marginBottom: 0,
                            ...
                            new bsts_1.h.div({ display: "flex", overflow: "auto" }, [
                                ...
                                new bsts_1.h.div({ marginStart: "auto" }, new bsts_1.b.btngroup({ vertical: true, weight: "sm" }, [
                                    new bsts_1.b.button({
                                        ...
                                        on: {
                                            click: (event) => {
                                                const elem = bsts_1.b.alert.init("#example-alert");
                                    ...
                                    new bsts_1.b.button({
                                        ...
                                        on: {
                                            click: (event) => {
                                                const elem = bsts_1.b.alert.getInstance("#example-alert");
                                    ...
                                    new bsts_1.b.button({
                                        ...
                                        on: {
                                            click: (event) => {
                                                const elem = bsts_1.b.alert.getOrCreateInstance("#example-alert");
                                    ...
                                    new bsts_1.b.button({
                                        ...
                                        on: {
                                            click: () => {
                                                bsts_1.b.alert.close("#example-alert");
                                            },
                                        },
                                    }, "close"),
                                    new bsts_1.b.button({
                                        ...
                                        on: {
                                            click: () => {
                                                bsts_1.b.alert.dispose("#example-alert");
                                            },
                                        },
                                    }, "dispose"),
                                    new bsts_1.b.button({
                                        on: {
                                            click: () => {
                                                bsts_1.core.replaceWith(document.getElementById("example-alert-container"), exampleAlert);
                                            },
                                        },
                                    }, "reset"),
                                ])),
            ...
            new e.section([
                ...
                new e.code({
                    showConsole: true,
                    output: () => {
                        return new bsts_1.b.alert.container({
                            color: "info",
                            dismissible: true,
                            on: {
                                "close.bs.alert": (event) => {
                                    const target = event.target;
                                    e.console(target, "close.bs.alert", `Target: {{b::${bsts_1.core.elemInfo(target)}}}`, "info");
                                },
                            },
