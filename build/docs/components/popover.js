    ...
    item: () => {
        return [
            new e.section([
                ...
                new e.alert({ color: "info", callout: true }, "By default, this component uses the built-in content sanitizer, which strips out any HTML elements that are not explicitly allowed. See the {{https://getbootstrap.com/docs/5.3/getting-started/javascript/#sanitizer::sanitizer section in Bootstrap JavaScript documentation}} for more details."),
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        ...
                        }, new bsts_1.b.button({ weight: "lg", color: "danger" }, "Click to toggle popover"));
                    },
                }),
            ]),
            //----------------------
            ...
            new e.section([
                ...
                new e.text("When you have some styles on a parent element that interfere with a popover, you’ll want to specify a custom {{container}} by set {{parent:'container'}} so that the popover’s HTML appears within that element instead. This is common in responsive tables, input groups, and the like."),
                new e.codepreview({
                    type: "js",
                    code: `
                ...
                new e.text("Another situation where you’ll want to set an explicit custom {{container}} are popovers inside a {{nav:docs/components/modal::modal dialog}}, to make sure that the popover itself is appended to the modal. This is particularly important for popovers that contain interactive elements – modal dialogs will trap focus, so unless the popover is a child element of the modal, users won’t be able to focus or activate these interactive elements."),
                new e.codepreview({
                    type: "js",
                    code: `
            ...
            new e.section([
                ...
                new e.text("You can customize the appearance of popovers using {{nav:docs/components/popover#variables::CSS variables}}. Bootstrap set a custom class with {{customClass:'custom-popover'}} property to scope Bootstrap custom appearance and use it to override some of the local CSS variables."),
                new e.code({
                    css: `
					.custom-popover {
                    ...
                    output: () => {
                        ...
                        }, new bsts_1.b.button({ color: "secondary" }, "Custom popover"));
                    },
                }),
            ]),
            //----------------------
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.popover({
                            ...
                            content: "And here's some amazing content. It's very engaging. Right?",
                            trigger: "focus",
                        }, new bsts_1.b.button({ weight: "lg", color: "danger" }, "Dismissible popover"));
                    },
                }),
            ]),
            //----------------------
            new e.section([
                ...
                new e.text("Elements with the {{disabled}} attribute aren’t interactive, meaning users cannot hover or click them to trigger a popover (or tooltip). As a workaround, you’ll want to trigger the popover from a wrapper {{h.div}} or {{h.span}}, ideally made keyboard-focusable using {{tabindex:'0'}}."),
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.popover({
                            ...
                            trigger: ["hover", "focus"],
                        }, new bsts_1.b.button({ color: "primary", disabled: true }, "Disabled button"));
                    },
                }),
            ]),
            //----------------------
            ...
            new e.section([
                ...
                new e.alert({ color: "info", callout: true }, [
                    new bsts_1.b.alert.header(4, "Data attributes for individual popovers"),
            ...
            new e.section([
                ...
                new e.code({
                    showConsole: true,
                    output: () => {
                        const myDefaultAllowList = bootstrap_1.Tooltip.Default.allowList;
                        ...
                        return [
                            new bsts_1.h.div({ display: "flex", overflow: "auto" }, [
                                new bsts_1.h.div({
                                    ...
                                    rounded: true,
                                    position: "relative",
                                }, new bsts_1.h.div({ position: "absolute", top: 50, start: 50, tMiddle: true }, new bsts_1.b.popover({
                                    autoInit: false,
                                    id: "example-popover",
                                    placement: "top",
                                    ...
                                    on: {
                                        "hidden.bs.popover": (event) => {
                                            bsts_1.b.popover.setContent("#example-popover", {
                                ...
                                new bsts_1.h.div({ marginStart: "auto" }, new bsts_1.b.btngroup({ vertical: true, weight: "sm" }, [
                                    new bsts_1.b.button({
                                        ...
                                        on: {
                                            click: () => {
                                                bsts_1.b.popover.enable("#example-popover");
                                            },
                                        },
                                    }, "enable"),
                                    new bsts_1.b.button({
                                        ...
                                        on: {
                                            click: (event) => {
                                                const elem = bsts_1.b.popover.getInstance("#example-popover");
                                    ...
                                    new bsts_1.b.button({
                                        ...
                                        on: {
                                            click: (event) => {
                                                const elem = bsts_1.b.popover.getOrCreateInstance("#example-popover");
                                    ...
                                    new bsts_1.b.button({
                                        on: {
                                            click: () => {
                                                bsts_1.b.popover.toggle("#example-popover");
                                            },
                                        },
                                    }, "toggle"),
                                    new bsts_1.b.button({
                                        ...
                                        on: {
                                            click: () => {
                                                bsts_1.b.popover.toggleEnabled("#example-popover");
                                            },
                                        },
                                    }, "toggleEnabled"),
                                    new bsts_1.b.button({
                                        on: {
                                            click: () => {
                                                bsts_1.b.popover.show("#example-popover");
                                            },
                                        },
                                    }, "show"),
                                    new bsts_1.b.button({
                                        on: {
                                            click: () => {
                                                bsts_1.b.popover.hide("#example-popover");
                                            },
                                        },
                                    }, "hide"),
                                    new bsts_1.b.button({
                                        on: {
                                            click: () => {
                                                bsts_1.b.popover.update("#example-popover");
                                            },
                                        },
                                    }, "update"),
                                    new bsts_1.b.button({
                                    ...
                                    new bsts_1.b.button({
                                        ...
                                        on: {
                                            click: () => {
                                                bsts_1.b.popover.disable("#example-popover");
                                            },
                                        },
                                    }, "disabled"),
                                    new bsts_1.b.button({
                                        ...
                                        on: {
                                            click: () => {
                                                bsts_1.b.popover.dispose("#example-popover");
                                            },
                                        },
                                    }, "dispose"),
                                ])),
                        ...
                        return new bsts_1.b.popover({
                            ...
                            on: {
                                "shown.bs.popover": (event) => {
                                    ...
                                    e.console(target, "shown.bs.popover", `Target: {{b::${bsts_1.core.elemInfo(target)}}}`, "success");
                                },
                                "hidden.bs.popover": (event) => {
                                    const target = event.target;
                                    e.console(target, "hidden.bs.popover", `Target: {{b::${bsts_1.core.elemInfo(target)}}}`, "danger");
                                },
                                "inserted.bs.popover": (event) => {
                                    const target = event.target;
                                    e.console(target, "inserted.bs.popover", `Target: {{b::${bsts_1.core.elemInfo(target)}}}`, "info");
                                },
                            },
                        }, new bsts_1.b.button({ weight: "lg" }, "Click to toggle popover"));
                    },
                }),
            ]),
        ];
