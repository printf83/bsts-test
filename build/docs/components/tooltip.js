    ...
    item: () => {
        return [
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.h.p({ textColor: "body-secondary" }, [
                            "Placeholder text to demonstrate some ",
                            new bsts_1.b.tooltip({ content: "Default tooltip" }, new bsts_1.h.a({ href: "#" }, "inline links")),
                            " with tooltips. This is now just filler, no killer. Content placed here just to mimic the presence of ",
                            new bsts_1.b.tooltip({ content: "Another tooltip" }, new bsts_1.h.a({ href: "#" }, "real text")),
                            ...
                            new bsts_1.b.tooltip({ content: "Another one here too" }, new bsts_1.h.a({ href: "#" }, "these tooltips on links")),
                            " can work in practice, once you use them on ",
                            new bsts_1.b.tooltip({ content: "The last tip!" }, new bsts_1.h.a({ href: "#" }, "your own")),
                            " site or project.",
                        ]);
                    },
                }),
            ...
            new e.section([
                ...
                new e.text("You can customize the appearance of tooltips using {{nav:docs/components/tooltip#variables::CSS variables}}. Bootstrap set a custom class with {{customClass:'custom-tooltip'}} property to scope Bootstrap custom appearance and use it to override some of the local CSS variables."),
                new e.codepreview({
                    type: "css",
                    code: `
						.custom-tooltip {
                ...
                new e.code({
                    ...
                    output: () => {
                        ...
                        }, new bsts_1.b.button({ color: "secondary" }, "Custom tooltip"));
                    },
                }),
            ]),
            //----------------------
            new e.section([
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.b.tooltip({
                            ...
                            allowHtml: true,
                        }, new bsts_1.b.button({ color: "secondary" }, "Tooltip on HTML"));
                    },
                }),
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.b.tooltip({
                            content: "Default tooltip",
                        }, new bsts_1.s(`<svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 100 100"><rect width="100%" height="100%" fill="#563d7c"></rect><circle cx="50" cy="50" r="30" fill="#007bff"></circle></svg>`));
                    },
                }),
            ]),
            //----------------------
            ...
            new e.section([
                ...
                new e.alert({ color: "info", callout: true }, [
                    new bsts_1.b.alert.header(4, "Data attributes for individual tooltips"),
                        ...
                        return [
                            new bsts_1.h.div({ display: "flex", overflow: "auto" }, [
                                new bsts_1.h.div({
                                    ...
                                    rounded: true,
                                    position: "relative",
                                }, new bsts_1.h.div({ position: "absolute", top: 50, start: 50, tMiddle: true }, new bsts_1.b.tooltip({
                                    autoInit: false,
                                    id: "example-tooltip",
                                    allowHtml: true,
                                    content: "Default tooltip",
                                    on: {
                                        "hidden.bs.tooltip": () => {
                                            bsts_1.b.tooltip.setContent("#example-tooltip", {
                                ...
                                new bsts_1.h.div({ marginStart: "auto" }, new bsts_1.b.btngroup({ vertical: true, weight: "sm" }, [
                                    new bsts_1.b.button({
                                        ...
                                        on: {
                                            click: () => {
                                                bsts_1.b.tooltip.enable("#example-tooltip");
                                            },
                                        },
                                    }, "enable"),
                                    new bsts_1.b.button({
                                        ...
                                        on: {
                                            click: (event) => {
                                                const elem = bsts_1.b.tooltip.getInstance("#example-tooltip");
                                    ...
                                    new bsts_1.b.button({
                                        ...
                                        on: {
                                            click: (event) => {
                                                const elem = bsts_1.b.tooltip.getOrCreateInstance("#example-tooltip");
                                    ...
                                    new bsts_1.b.button({
                                        on: {
                                            click: () => {
                                                bsts_1.b.tooltip.toggle("#example-tooltip");
                                            },
                                        },
                                    }, "toggle"),
                                    new bsts_1.b.button({
                                        ...
                                        on: {
                                            click: () => {
                                                bsts_1.b.tooltip.toggleEnabled("#example-tooltip");
                                            },
                                        },
                                    }, "toggleEnabled"),
                                    new bsts_1.b.button({
                                        on: {
                                            click: () => {
                                                bsts_1.b.tooltip.show("#example-tooltip");
                                            },
                                        },
                                    }, "show"),
                                    new bsts_1.b.button({
                                        on: {
                                            click: () => {
                                                bsts_1.b.tooltip.hide("#example-tooltip");
                                            },
                                        },
                                    }, "hide"),
                                    new bsts_1.b.button({
                                        on: {
                                            click: () => {
                                                bsts_1.b.tooltip.update("#example-tooltip");
                                            },
                                        },
                                    }, "update"),
                                    new bsts_1.b.button({
                                    ...
                                    new bsts_1.b.button({
                                        ...
                                        on: {
                                            click: () => {
                                                bsts_1.b.tooltip.disable("#example-tooltip");
                                            },
                                        },
                                    }, "disabled"),
                                    new bsts_1.b.button({
                                        ...
                                        on: {
                                            click: () => {
                                                bsts_1.b.tooltip.dispose("#example-tooltip");
                                            },
                                        },
                                    }, "dispose"),
                                ])),
                        ...
                        return new bsts_1.b.tooltip({
                            ...
                            on: {
                                "shown.bs.tooltip": (event) => {
                                    ...
                                    e.console(target, "shown.bs.tooltip", `target: {{b::${bsts_1.core.elemInfo(target)}}}`, "success");
                                },
                                "hidden.bs.tooltip": (event) => {
                                    const target = event.target;
                                    e.console(target, "hidden.bs.tooltip", `target: {{b::${bsts_1.core.elemInfo(target)}}}`, "danger");
                                },
                                "inserted.bs.tooltip": (event) => {
                                    const target = event.target;
                                    e.console(target, "inserted.bs.tooltip", `target: {{b::${bsts_1.core.elemInfo(target)}}}`, "info");
                                },
                            },
                        }, new bsts_1.b.button({ color: "primary" }, "Tooltip event"));
                    },
                }),
            ]),
        ];
