    ...
    item: () => {
        return [
            new e.section([
                ...
                new e.text("The base {{b.nav.header.container}} component is built with flexbox and provide a strong foundation for building all types of navigation components. It includes some style overrides (for working with lists), some link padding for larger hit areas, and basic disabled styling."),
                new e.alert({ color: "info", callout: true }, [
                    new bsts_1.h.p("The base {{b.nav.header.container}} component does not include any {{active}} state property. The following examples include the class, mainly to demonstrate that this particular class does not trigger any special styling."),
                    new bsts_1.h.p("To convey the active state to assistive technologies, use the {{aria-current}} attribute — using the page value for current page, or {{true}} for the current item in a set."),
                    new bsts_1.h.p("By default, {{bsts}} set {{aria-current:'page'}} when {{active:true}} on {{b.nav.header.link}}. Change it using {{current:true}} to change this behavior."),
                ]),
                new e.code({
                    output: () => {
                        return new bsts_1.b.nav.header.container([
                            new bsts_1.b.nav.header.item(new bsts_1.b.nav.header.link({ active: true, href: "#" }, "Active")),
                            new bsts_1.b.nav.header.item(new bsts_1.b.nav.header.link({ href: "#" }, "Link")),
                            new bsts_1.b.nav.header.item(new bsts_1.b.nav.header.link({ href: "#" }, "Link")),
                            new bsts_1.b.nav.header.item(new bsts_1.b.nav.header.link({ disabled: true, href: "#" }, "Disabled")),
                        ]);
                    },
                }),
                ...
                new e.text("{{b.nav.header.container}} component will generate {{h.ul}} component. If the order of your items is important, or roll your own with a {{b.nav.header.containerNav}} component to generate {{h.nav}}. Because the {{h.hav}} uses {{display: flex}}, the nav links behave the same as nav items would, but without the extra markup ({{b.nav.header.item}})."),
                new e.code({
                    output: () => {
                        return new bsts_1.b.nav.header.containerNav([
                            new bsts_1.b.nav.header.link({ active: true, href: "#" }, "Active"),
                            new bsts_1.b.nav.header.link({ href: "#" }, "Link"),
                            new bsts_1.b.nav.header.link({ href: "#" }, "Link"),
                            new bsts_1.b.nav.header.link({ disabled: true, href: "#" }, "Disabled"),
                        ]);
                    },
                }),
            ...
            new e.section([
                ...
                new e.text("Change the style of {{b.nav.header.container}}s component with modifiers and utilities. Mix and match as needed, or build your own."),
            ]),
            //----------------------
            new e.section([
            ...
            new e.section([
                ...
                new e.text("Force your {{b.nav.header.container}}’s contents to extend the full available width one of two modifier classes. To proportionately fill all available space with your {{b.nav.header.item}}, use {{itemWidth:'fill'}}. Notice that all horizontal space is occupied, but not every nav item has the same width."),
                new e.code({
                    output: () => {
                        return new bsts_1.b.nav.header.container({
                            type: "pill",
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.nav.header.container({ type: "tab" }, [
                            new bsts_1.b.nav.header.item(new bsts_1.b.nav.header.link({ active: true, href: "#" }, "Active")),
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        ...
                        return [
                            new bsts_1.b.nav.header.container({ type: "tab", role: "tablist", id: "myTab" }, d.map((i) => {
                                return new bsts_1.b.nav.header.item({ role: "presentation" }, new bsts_1.b.nav.header.button({
                                    active: i.active,
                                    disabled: i.disabled,
                                    id: `${i.id}-tab`,
                            ...
                            new bsts_1.b.nav.content.container({ id: "myTabContent", marginTop: 3 }, d.map((i) => {
                                return new bsts_1.b.nav.content.item({
                                    active: i.active,
                                    id: `${i.id}-tab-pane`,
                                    role: "tabpanel",
                                    labelledby: `${i.id}-tab`,
                ...
                new e.code({
                    output: () => {
                        ...
                        return [
                            new bsts_1.b.nav.header.containerNav({ type: "tab", role: "tablist", id: "nav-tab" }, d.map((i) => {
                                return new bsts_1.b.nav.header.button({
                                    active: i.active,
                                    disabled: i.disabled,
                                    id: `${i.id}-tab`,
                            ...
                            new bsts_1.b.nav.content.container({ id: "nav-tabContent", marginTop: 3 }, d.map((i) => {
                                return new bsts_1.b.nav.content.item({
                                    active: i.active,
                ...
                new e.code({
                    output: () => {
                        ...
                        return [
                            new bsts_1.b.nav.header.container({ type: "pill", role: "tablist", id: "pills-tab" }, d.map((i) => {
                                return new bsts_1.b.nav.header.item({ role: "presentation" }, new bsts_1.b.nav.header.button({
                                    active: i.active,
                                    disabled: i.disabled,
                                    id: `pills-${i.id}-tab`,
                            ...
                            new bsts_1.b.nav.content.container({ id: "pills-tabContent", marginTop: 3 }, d.map((i) => {
                                return new bsts_1.b.nav.content.item({
                                    active: i.active,
                ...
                new e.code({
                    ...
                    output: () => {
                        const content = (title) => `This is some placeholder content the {{b::${title} tab's}} associated content. Clicking another tab will toggle the visibility of this one for the next. The tab JavaScript swaps classes to control the content visibility and styling. You can use it with tabs, pills, and any other {{type:'tab|pill|underline'}}powered navigation.`;
                        return new bsts_1.h.div({ display: "md-flex", alignItem: "md-start" }, bsts_1.b.nav.tab({
                            type: "pill",
                            vertical: true,
                            flex: "md-column",
                            marginEnd: "md-3",
            ...
            new e.section([
                ...
                new e.text("Dynamic tabbed interfaces, as described in the {{https://www.w3.org/WAI/ARIA/apg/patterns/tabpanel/::ARIA Authoring Practices Guide tabs pattern}}, require {{role:'tablist'}}, {{role:'tab'}}, {{role:'tabpanel'}}, and additional {{aria-}} attributes in order to convey their structure, functionality, and current state to users of assistive technologies (such as screen readers). As a best practice, Bootstrap recommend using {{h.button}} elements for the tabs, as these are controls that trigger a dynamic change, rather than links that navigate to a new page or location."),
                new e.text("{{bsts}} will update this on next release."),
                new e.text("In line with the ARIA Authoring Practices pattern, only the currently active tab receives keyboard focus. When the JavaScript plugin is initialized, it will set {{tabindex='-1'}} on all inactive tab controls. Once the currently active tab has focus, the cursor keys activate the previous/next tab, with the plugin changing the {{https://www.w3.org/WAI/ARIA/apg/practices/keyboard-interface/::roving tabindex}} accordingly. However, note that the JavaScript plugin does not distinguish between horizontal and vertical tab lists when it comes to cursor key interactions: regardless of the tab list’s orientation, both the up and left cursor go to the previous tab, and down and right cursor go to the next tab."),
                new e.alert({ color: "warning", callout: true }, "In general, to facilitate keyboard navigation, it’s recommended to make the tab panels themselves focusable as well, unless the first element containing meaningful content inside the tab panel is already focusable. The JavaScript plugin does not try to handle this aspect—where appropriate, you’ll need to explicitly make your tab panels focusable by adding {{tabindex:'0'}} in your component."),
                new e.alert({ color: "danger", callout: true }, " The tab JavaScript plugin {{b::does not}} support tabbed interfaces that contain dropdown menus, as these cause both usability and accessibility issues. From a usability perspective, the fact that the currently displayed tab’s trigger element is not immediately visible (as it’s inside the closed dropdown menu) can cause confusion. From an accessibility point of view, there is currently no sensible way to map this sort of construct to a standard WAI ARIA pattern, meaning that it cannot be easily made understandable to users of assistive technologies."),
            ]),
            //----------------------
            new e.section([
                ...
                new e.code({
                    output: () => {
                        ...
                        return [
                            ...
                            new bsts_1.b.nav.content.container({ id: "prop-tabContent", marginTop: 3 }, d.map((i) => {
                                return new bsts_1.b.nav.content.item({
                                    active: i.active,
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        const content = (title) => `This is some placeholder content the {{b::${title} tab's}} associated content. Clicking another tab will toggle the visibility of this one for the next. The tab JavaScript swaps classes to control the content visibility and styling. You can use it with tabs, pills, and any other {{type:'tab|pill|underline'}}powered navigation.`;
                        return new bsts_1.b.card.container(bsts_1.b.nav.tab({
                            card: true,
                            item: [
                                { label: "Home", active: true, elem: content("Home") },
                                { label: "Profile", elem: content("Profile") },
            ...
            new e.section([
                ...
                new e.code({
                    ...
                    output: () => {
                        ...
                        return new bsts_1.b.modal.container({ debug: true }, [
                            ...
                            new bsts_1.b.modal.body({ padding: 0 }, new bsts_1.b.card.container({ border: false }, bsts_1.b.nav.tab({
                                card: true,
                                on: {
                                    "shown.bs.tab": (event) => {
                                        const target = event.target.closest(".modal");
                                        // readjust the modal’s position
                                        bsts_1.b.modal.handleUpdate(target);
                                    },
                                },
                                item: [
                                    {
                                        label: new bsts_1.b.caption({
                                            icon: "house-fill",
                ...
                new e.code({
                    ...
                    output: () => {
                        const content = (title) => `This is some placeholder content the {{b::${title} tab's}} associated content. Clicking another tab will toggle the visibility of this one for the next. The tab JavaScript swaps classes to control the content visibility and styling. You can use it with tabs, pills, and any other {{type:'tab|pill|underline'}}powered navigation.`;
                        const tabCard = new bsts_1.b.card.container({ border: false }, bsts_1.b.nav.tab({
                            card: true,
                            on: {
                                "shown.bs.tab": (event) => {
                                    const target = event.target.closest(".modal");
                        ...
                        const modal = bsts_1.b.modal.create({
                        ...
                        const btnShow = new bsts_1.b.button({ target: "#modal-tab-example", toggle: "modal" }, "Show tab in modal");
                ...
                new e.code({
                    ...
                    output: () => {
                        const showTabPaneEventHandler = (event) => {
                            event.preventDefault();
                            bsts_1.b.tabList.show(event.target);
                        };
                        const content = (title) => `This is some placeholder content the {{b::${title} tab's}} associated content. Clicking another tab will toggle the visibility of this one for the next. The tab JavaScript swaps classes to control the content visibility and styling. You can use it with tabs, pills, and any other {{type:'tab|pill|underline'}}powered navigation.`;
                        const d = [
                        ...
                        const navTabContainer = [
                            new bsts_1.b.nav.header.containerNav({ type: "tab", role: "tablist", id: "example-nav-tab" }, d.map((i) => {
                                return new bsts_1.b.nav.header.button({
                                    active: i.active,
                            ...
                            new bsts_1.b.nav.content.container({ id: "example-nav-tabContent", marginTop: 3 }, d.map((i) => {
                                return new bsts_1.b.nav.content.item({
                                    active: i.active,
                        ...
                        const getInstanceButton = new bsts_1.b.button({
                            ...
                            on: {
                                click: (event) => {
                                    const elem = bsts_1.b.tabList.getInstance("#example-nav-tab button.active");
                        ...
                        const getOrCreateInstanceButton = new bsts_1.b.button({
                            ...
                            on: {
                                click: (event) => {
                                    const elem = bsts_1.b.tabList.getOrCreateInstance("#example-nav-tab button.active");
                        ...
                        const showButton = new bsts_1.b.button({
                            on: {
                                click: (event) => {
                                    const elem = document.querySelectorAll("#example-nav-tab button");
                                    bsts_1.b.tabList.show(elem[bsts_1.core.rndBetween(0, elem.length - 1)]);
                                },
                            },
                        }, "show (random)");
                        ...
                        return [
                            new bsts_1.b.nav.header.containerNav({
                                ...
                                on: {
                                    "shown.bs.tab": (event) => {
                                        const evnt = event;
                                        e.console(evnt.target, "shown.bs.tab", `Target: {{b::${bsts_1.core.elemInfo(evnt.target)}}}{{br}}RelatedTarget: {{b::${bsts_1.core.elemInfo(evnt.relatedTarget)}}}`, "success");
                                    },
                                    "hidden.bs.tab": (event) => {
                                        const evnt = event;
                                        e.console(evnt.target, "hidden.bs.tab", `Target: {{b::${bsts_1.core.elemInfo(evnt.target)}}}{{br}}RelatedTarget: {{b::${bsts_1.core.elemInfo(evnt.relatedTarget)}}}`, "danger");
                                    },
                                },
                            }, d.map((i) => {
                                return new bsts_1.b.nav.header.button({
                            ...
                            new bsts_1.b.nav.content.container({ id: "event-tabContent", marginTop: 3 }, d.map((i) => {
                                return new bsts_1.b.nav.content.item({
                                    active: i.active,
                                    animation: false,
