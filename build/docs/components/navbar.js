        ...
        return [
            ...
            new e.section([
                ...
                new e.code({
                    showViewport: true,
                    output: () => {
                        return new bsts_1.b.navbar.container({ bgColor: "body-tertiary", expand: "lg" }, new bsts_1.b.navbar.innercontainer({ container: "fluid" }, [
                            ...
                            new bsts_1.b.navbar.collapse({ id: "navbarSupportedContent" }, [
                                new bsts_1.b.navbar.itemcontainer({ marginEnd: "auto", marginBottom: [2, "lg-0"] }, [
                                    ...
                                    new bsts_1.b.navbar.item(new bsts_1.b.navbar.link({ href: "#" }, "Link")),
                                    ...
                                    new bsts_1.b.navbar.item(new bsts_1.b.navbar.link({ href: "#", disabled: true }, "Disabled")),
                                ]),
                                new bsts_1.h.form({ display: "flex", role: "search" }, [
                                    ...
                                    new bsts_1.b.button({ type: "submit", color: "success", outline: true }, "Search"),
                                ]),
                            ]),
                        ]));
                    },
            ...
            new e.section({ id: "brand_text" }, [
                ...
                new e.code({
                    ...
                    output: () => {
                        return [
                            new bsts_1.b.navbar.container({ bgColor: "body-tertiary" }, new bsts_1.b.navbar.innercontainer({ container: "fluid" }, new bsts_1.b.navbar.brand({ href: "#" }, "Navbar"))),
                            new bsts_1.b.navbar.container({ bgColor: "body-tertiary" }, new bsts_1.b.navbar.innercontainer({ container: "fluid" }, new bsts_1.b.navbar.brand({ marginBottom: 0, class: "h1" }, "Navbar"))),
                        ];
                    },
                }),
            ]),
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.navbar.container({ bgColor: "body-tertiary" }, new bsts_1.b.navbar.innercontainer({ container: "fluid" }, new bsts_1.b.navbar.brand({ href: "#" }, new bsts_1.b.icon({ textColor: "primary", id: "bootstrap" }))));
                    },
                }),
            ]),
            //----------------------
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.navbar.container({ bgColor: "body-tertiary" }, new bsts_1.b.navbar.innercontainer({ container: "fluid" }, new bsts_1.b.navbar.brand({ href: "#" }, new bsts_1.b.caption({ icon: new bsts_1.b.icon({ textColor: "primary", id: "bootstrap" }) }, "Bootstrap"))));
                    },
                }),
            ]),
            //----------------------
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.b.navbar.container({ bgColor: "body-tertiary", expand: "lg" }, new bsts_1.b.navbar.innercontainer({ container: "fluid" }, [
                            ...
                            new bsts_1.b.navbar.collapse({ id: "navbarNavContent" }, [
                                new bsts_1.b.navbar.itemcontainer([
                                    new bsts_1.b.navbar.item(new bsts_1.b.navbar.link({ href: "#", active: true }, "Home")),
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.b.navbar.container({ bgColor: "body-tertiary", expand: "lg" }, new bsts_1.b.navbar.innercontainer({ container: "fluid" }, [
                            ...
                            new bsts_1.b.navbar.collapse({ id: "navbarNavAltMarkup" }, [
                                new bsts_1.h.div({ class: "navbar-nav" }, [
                                    new bsts_1.b.navbar.link({ href: "#", active: true }, "Home"),
                                    new bsts_1.b.navbar.link({ href: "#" }, "Features"),
                                    new bsts_1.b.navbar.link({ href: "#" }, "Pricing"),
                                    new bsts_1.b.navbar.link({ href: "#", disabled: true }, "Disabled"),
                                ]),
                            ]),
                        ]));
                    },
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.b.navbar.container({ bgColor: "body-tertiary", expand: "lg" }, new bsts_1.b.navbar.innercontainer({ container: "fluid" }, [
                            ...
                            new bsts_1.b.navbar.collapse({ id: "navbarNavDropdown" }, [
                                new bsts_1.b.navbar.itemcontainer([
                                    new bsts_1.b.navbar.item(new bsts_1.b.navbar.link({ href: "#", active: true }, "Home")),
                                    new bsts_1.b.navbar.item(new bsts_1.b.navbar.link({ href: "#" }, "Features")),
                                    new bsts_1.b.navbar.item(new bsts_1.b.navbar.link({ href: "#" }, "Pricing")),
                                    new bsts_1.b.navbar.item({ dropdown: true }, [
                                        new bsts_1.b.dropdown.button({ navItem: true, href: "#" }, "Dropdown link"),
                                        new bsts_1.b.dropdown.menu([
                                            new bsts_1.b.dropdown.item({ href: "#" }, "Action"),
                                            new bsts_1.b.dropdown.item({ href: "#" }, "Another action"),
                                            new bsts_1.b.dropdown.item({ href: "#" }, "Something else here"),
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.navbar.container({ bgColor: "body-tertiary" }, new bsts_1.b.navbar.innercontainer({ container: "fluid" }, new bsts_1.h.form({ display: "flex", role: "search" }, [
                            new bsts_1.b.input({
                                type: "search",
                                marginEnd: 2,
                                placeholder: "Search",
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.navbar.container({ bgColor: "body-tertiary" }, new bsts_1.b.navbar.innercontainer({ container: "fluid" }, [
                            new bsts_1.b.navbar.brand("Navbar"),
                            new bsts_1.h.form({ display: "flex", role: "search" }, [
                                new bsts_1.b.input({
                                    type: "search",
                                    marginEnd: 2,
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.navbar.container({ bgColor: "body-tertiary" }, new bsts_1.b.navbar.innercontainer({ container: "fluid" }, new bsts_1.b.inputgroup.container([
                            new bsts_1.b.inputgroup.text({ id: "basic-addon1" }, "@"),
                            new bsts_1.b.input({
                                type: "text",
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.navbar.container({ bgColor: "body-tertiary" }, new bsts_1.h.form({ container: "fluid", justifyContent: "start" }, [
                            new bsts_1.b.button({ color: "success", outline: true, marginEnd: 2 }, "Main button"),
                            new bsts_1.b.button({ color: "secondary", outline: true, weight: "sm" }, "Smaller button"),
                        ]));
                    },
                }),
            ]),
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.navbar.container({ bgColor: "body-tertiary" }, new bsts_1.b.navbar.innercontainer({ container: "fluid" }, new bsts_1.b.navbar.text("Navbar text with an inline element")));
                    },
                }),
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.b.navbar.container({ bgColor: "body-tertiary", expand: "lg" }, new bsts_1.b.navbar.innercontainer({ container: "fluid" }, [
                            new bsts_1.b.navbar.brand({ href: "#" }, "Navbar w/ text"),
                            new bsts_1.b.navbar.toggle.collapse({
                                target: "#navbarText",
                                controlfor: "navbarText",
                                label: "Toggle navigation",
                            }),
                            new bsts_1.b.navbar.collapse({ id: "navbarText" }, [
                                new bsts_1.b.navbar.itemcontainer({ marginEnd: "auto", marginBottom: [2, "lg-0"] }, [
                                    new bsts_1.b.navbar.item(new bsts_1.b.navbar.link({ href: "#", active: true }, "Home")),
                                    new bsts_1.b.navbar.item(new bsts_1.b.navbar.link({ href: "#" }, "Features")),
                                    new bsts_1.b.navbar.item(new bsts_1.b.navbar.link({ href: "#" }, "Pricing")),
                                ]),
                                new bsts_1.b.navbar.text("Navbar text with an inline element"),
                            ]),
                        ]));
                    },
                }),
            ...
            new e.section([
                ...
                new e.text("Navbar themes are easier than ever thanks to Bootstrap’s combination of Sass and CSS variables. The default is Bootstrap “light navbar” for use with light background colors, but you can also apply {{theme:'dark'}} to the {{b.navbar.container}} parent for dark background colors. Then, customize with {{bgColor}} property."),
                new e.code({
                    outputAttr: { display: "grid", gap: 3 },
                    output: () => {
                        ...
                        return [
                            ...
                            new bsts_1.b.navbar.container({ style: { backgroundColor: "#e3f2fd" } }, navbarItem("primary")),
                        ];
                    },
                }),
            ]),
            ...
            new e.section([
                ...
                new e.text("Although it’s not required, you can wrap a navbar in a {{h.div({container:true})}} to center it on a page–though note that an inner container is still required. Or you can add a container inside the {{b.navbar.container}} to only center the contents of a {{nav:docs/components/navbar#placement::fixed or static top navbar}}."),
                new e.code({
                    showViewport: true,
                    output: () => {
                        return new bsts_1.h.div({ container: true }, new bsts_1.b.navbar.container({ bgColor: "body-tertiary", expand: "lg" }, new bsts_1.b.navbar.innercontainer({ container: "fluid" }, new bsts_1.b.navbar.brand({ href: "#" }, "Navbar"))));
                    },
                }),
                ...
                new e.code({
                    showViewport: true,
                    output: () => {
                        return new bsts_1.b.navbar.container({ bgColor: "body-tertiary", expand: "lg" }, new bsts_1.b.navbar.innercontainer({ container: "md" }, new bsts_1.b.navbar.brand({ href: "#" }, "Navbar")));
                    },
                }),
            ]),
            //----------------------
            new e.section([
                ...
                new e.text("Use Bootstrap {{nav:docs/utilities/position::position utilities}} to place navbars in non-static positions. Choose from fixed to the top, fixed to the bottom, stickied to the top (scrolls with the page until it reaches the top, then stays there), or stickied to the bottom (scrolls with the page until it reaches the bottom, then stays there)."),
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.navbar.container({ bgColor: "body-tertiary" }, new bsts_1.b.navbar.innercontainer({ container: "fluid" }, new bsts_1.b.navbar.brand({ href: "#" }, "Default")));
                    },
                }),
                new e.code({
                    output: () => {
                        return new bsts_1.b.navbar.container({ bgColor: "body-tertiary", fixed: "top" }, new bsts_1.b.navbar.innercontainer({ container: "fluid" }, new bsts_1.b.navbar.brand({ href: "#" }, "Fixed top")));
                    },
                }),
                new e.code({
                    output: () => {
                        return new bsts_1.b.navbar.container({ bgColor: "body-tertiary", fixed: "bottom" }, new bsts_1.b.navbar.innercontainer({ container: "fluid" }, new bsts_1.b.navbar.brand({ href: "#" }, "Fixed bottom")));
                    },
                }),
                new e.code({
                    output: () => {
                        return new bsts_1.b.navbar.container({ bgColor: "body-tertiary", sticky: "top" }, new bsts_1.b.navbar.innercontainer({ container: "fluid" }, new bsts_1.b.navbar.brand({ href: "#" }, "Sticky top")));
                    },
                }),
                new e.code({
                    output: () => {
                        return new bsts_1.b.navbar.container({ bgColor: "body-tertiary", sticky: "bottom" }, new bsts_1.b.navbar.innercontainer({ container: "fluid" }, new bsts_1.b.navbar.brand({ href: "#" }, "Sticky bottom")));
                    },
                }),
            ]),
            //----------------------
            new e.section([
                ...
                new e.text("Add {{scroll:true}} to a {{b.navbar.itemcontainer}} (or other navbar sub-component) to enable vertical scrolling within the toggleable contents of a collapsed navbar. By default, scrolling kicks in at {{75vh}} (or 75% of the viewport height), but you can override that with the local CSS custom property {{--bs-navbar-height}} or custom styles. At larger viewports when the navbar is expanded, content will appear as it does in a default navbar."),
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.b.navbar.container({ bgColor: "body-tertiary", expand: "lg" }, new bsts_1.b.navbar.innercontainer({ container: "fluid" }, [
                            new bsts_1.b.navbar.brand({ href: "#" }, "Navbar scroll"),
                            new bsts_1.b.navbar.toggle.collapse({
                                target: "#navbarScroll",
                                controlfor: "navbarScroll",
                                label: "Toggle navigation",
                            }),
                            new bsts_1.b.navbar.collapse({ id: "navbarScroll" }, [
                                new bsts_1.b.navbar.itemcontainer({
                                    marginEnd: "auto",
                                    marginBottom: [2, "lg-0"],
                                    scroll: true,
                                    ...
                                    new bsts_1.b.navbar.item(new bsts_1.b.navbar.link({ href: "#" }, "Link")),
                                    new bsts_1.b.navbar.item({ dropdown: true }, [
                                        new bsts_1.b.dropdown.button({ navItem: true }, "Link"),
                                        new bsts_1.b.dropdown.menu([
                                            new bsts_1.b.dropdown.item({ href: "#" }, "Action"),
                                            new bsts_1.b.dropdown.item({ href: "#" }, "Another action"),
                                            new bsts_1.b.dropdown.divider(),
                                    ...
                                    new bsts_1.b.navbar.item(new bsts_1.b.navbar.link({ href: "#", disabled: true }, "Link")),
                                ]),
                                new bsts_1.h.form({ display: "flex", role: "search" }, [
                                    new bsts_1.b.input({
                                        type: "search",
            ...
            new e.section([
                ...
                new e.text("Navbar togglers are left-aligned by default, but should they follow a sibling element like a {{b.navbar.container}}, they’ll automatically be aligned to the far right. Reversing your markup will reverse the placement of the toggler. Below are examples of different toggle styles."),
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.b.navbar.container({ bgColor: "body-tertiary", expand: "lg" }, new bsts_1.b.navbar.innercontainer({ container: "fluid" }, [
                            ...
                            new bsts_1.b.navbar.collapse({ id: "navbarTogglerDemo01" }, [
                                new bsts_1.b.navbar.brand({ href: "#" }, "Hidden brand"),
                                new bsts_1.b.navbar.itemcontainer({ marginEnd: "auto", marginBottom: [2, "lg-0"] }, [
                                    new bsts_1.b.navbar.item(new bsts_1.b.navbar.link({ href: "#", active: true }, "Home")),
                                    new bsts_1.b.navbar.item(new bsts_1.b.navbar.link({ href: "#" }, "Link")),
                                    new bsts_1.b.navbar.item(new bsts_1.b.navbar.link({ href: "#", disabled: true }, "Disabled")),
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.b.navbar.container({ bgColor: "body-tertiary", expand: "lg" }, new bsts_1.b.navbar.innercontainer({ container: "fluid" }, [
                            ...
                            new bsts_1.b.navbar.collapse({ id: "navbarTogglerDemo02" }, [
                                new bsts_1.b.navbar.itemcontainer({ marginEnd: "auto", marginBottom: [2, "lg-0"] }, [
                                    new bsts_1.b.navbar.item(new bsts_1.b.navbar.link({ href: "#", active: true }, "Home")),
                                    new bsts_1.b.navbar.item(new bsts_1.b.navbar.link({ href: "#" }, "Link")),
                                    new bsts_1.b.navbar.item(new bsts_1.b.navbar.link({ href: "#", disabled: true }, "Disabled")),
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.b.navbar.container({ bgColor: "body-tertiary", expand: "lg" }, new bsts_1.b.navbar.innercontainer({ container: "fluid" }, [
                            ...
                            new bsts_1.b.navbar.brand({ href: "#" }, "Navbar"),
                            new bsts_1.b.navbar.collapse({ id: "navbarTogglerDemo03" }, [
                                new bsts_1.b.navbar.itemcontainer({ marginEnd: "auto", marginBottom: [2, "lg-0"] }, [
                                    new bsts_1.b.navbar.item(new bsts_1.b.navbar.link({ href: "#", active: true }, "Home")),
                                    new bsts_1.b.navbar.item(new bsts_1.b.navbar.link({ href: "#" }, "Link")),
                                    new bsts_1.b.navbar.item(new bsts_1.b.navbar.link({ href: "#", disabled: true }, "Disabled")),
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.h.div([
                            new bsts_1.b.collapse.container({ id: "navbarToggleExternalContent" }, new bsts_1.h.div({ theme: "dark", padding: 4, bgColor: "body-tertiary" }, [
                                new bsts_1.h.h(5, { textColor: "body-emphasis", h: 4 }, "Collapsed content"),
                                new bsts_1.h.span({ textColor: "body-secondary" }, "Toggleable via the navbar brand."),
                            ])),
                            new bsts_1.b.navbar.container({ theme: "dark", bgColor: "body-tertiary" }, new bsts_1.b.navbar.innercontainer({ container: "fluid" }, [
                                new bsts_1.b.navbar.brand({ href: "#" }, "Navbar"),
                                new bsts_1.b.navbar.toggle.collapse({
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.navbar.container({ bgColor: "body-tertiary", fixed: "top" }, new bsts_1.b.navbar.innercontainer({ container: "fluid" }, [
                            new bsts_1.b.navbar.brand({ href: "#" }, "Offcanvas navbar"),
                            ...
                            new bsts_1.b.offcanvas.container({
                                ...
                                new bsts_1.b.offcanvas.header([
                                    new bsts_1.b.offcanvas.title({ id: "offcanvasNavbarLabel" }, "Offcanvas"),
                                ...
                                new bsts_1.b.offcanvas.body([
                                    ...
                                    new bsts_1.h.form({ display: "flex", role: "search", marginTop: 3 }, [
                                        new bsts_1.b.input({
                                            type: "search",
                                            marginEnd: 2,
                                            placeholder: "Search",
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.navbar.container({ bgColor: "body-tertiary", expand: "lg", fixed: "top" }, new bsts_1.b.navbar.innercontainer({ container: "fluid" }, [
                            new bsts_1.b.navbar.brand({ href: "#" }, "Offcanvas lg navbar"),
                            new bsts_1.b.navbar.toggle.offcanvas({
                            ...
                            new bsts_1.b.offcanvas.container({
                                ...
                                new bsts_1.b.offcanvas.header([
                                    new bsts_1.b.offcanvas.title({ id: "offcanvasLgNavbarLabel" }, "Offcanvas"),
                                    new bsts_1.b.offcanvas.btnclose(),
                                ]),
                                new bsts_1.b.offcanvas.body([
                                    new bsts_1.b.navbar.itemcontainer({
                                        ...
                                        new bsts_1.b.navbar.item({ paddingTop: "lg-1" }, new bsts_1.b.navbar.link({ href: "#", active: true }, "Home")),
                                        new bsts_1.b.navbar.item({ paddingTop: "lg-1" }, new bsts_1.b.navbar.link({ href: "#" }, "Link")),
                                        new bsts_1.b.navbar.item({ dropdown: true, paddingTop: "lg-1" }, [
                                            new bsts_1.b.dropdown.button({ navItem: true }, "Dropdown"),
                                            new bsts_1.b.dropdown.menu([
                                                new bsts_1.b.dropdown.item({ href: "#" }, "Action"),
                                                new bsts_1.b.dropdown.item({ href: "#" }, "Another action"),
                                    ...
                                    new bsts_1.h.form({ hstack: true, role: "search", marginTop: [3, "lg-0"] }, [
                                        new bsts_1.b.input({
                                            type: "search",
                                            marginEnd: 2,
                                            placeholder: "Search",
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.navbar.container({ theme: "dark", bgColor: "body-tertiary", fixed: "top" }, new bsts_1.b.navbar.innercontainer({ container: "fluid" }, [
                            new bsts_1.b.navbar.brand({ href: "#" }, "Offcanvas dark navbar"),
                            new bsts_1.b.navbar.toggle.offcanvas({
                            ...
                            new bsts_1.b.offcanvas.container({
                                ...
                                new bsts_1.b.offcanvas.header([
                                    new bsts_1.b.offcanvas.title({ id: "offcanvasDarkNavbarLabel" }, "Dark offcanvas"),
                                    new bsts_1.b.offcanvas.btnclose(),
                                ]),
                                new bsts_1.b.offcanvas.body([
                                    new bsts_1.b.navbar.itemcontainer({
