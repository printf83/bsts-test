    ...
    item: () => {
        return [
            ...
            new e.section([
                ...
                new e.text("If you don’t want the button text to wrap, you can add the {{textWrap:false}} class to the button. In Sass, you can set {{$btn-white-space: nowrap}} to disable text wrapping for each button."),
            ]),
            //----------------------
            new e.section([
                ...
                new e.text("When using button classes on {{h.a}} component that are used to trigger in-page functionality (like collapsing content), rather than linking to new pages or sections within the current page, these links should be given a {{role:'button'}} to appropriately convey their purpose to assistive technologies such as screen readers."),
                new e.code({
                    outputAttr: { display: "flex", flex: "wrap", gap: 2 },
                    output: () => {
                        let id = bsts_1.core.UUID();
                        return [
                            new bsts_1.b.button({ color: "primary", href: "#" }, "Link"),
                            new bsts_1.b.button({ color: "primary" }, "Button"),
                            new bsts_1.b.button({ color: "primary", type: "submit" }, "Submit"),
                            new bsts_1.b.button({ color: "primary", type: "reset" }, "Reset"),
                            new bsts_1.b.input({ type: "checkbox", id: `chk${id}`, toggle: true }),
                            new bsts_1.b.label({ for: `chk${id}`, color: "primary" }, "Check"),
                        ];
                    },
                }),
            ]),
            ...
            new e.section([
                ...
                new e.code({
                    ...
                    output: () => {
                        return [
                            new bsts_1.b.button({ weight: "lg", color: "primary" }, "Large button"),
                            new bsts_1.b.button({ weight: "lg", color: "secondary" }, "Large button"),
                        ];
                    },
                }),
                new e.code({
                    ...
                    output: () => {
                        return [
                            new bsts_1.b.button({ weight: "sm", color: "primary" }, "Small button"),
                            new bsts_1.b.button({ weight: "sm", color: "secondary" }, "Small button"),
                        ];
                    },
                }),
            ...
            new e.section([
                ...
                new e.code({
                    ...
                    output: () => {
                        return [
                            new bsts_1.b.button({ color: "primary", disabled: true }, "Primary button"),
                            new bsts_1.b.button({ color: "secondary", disabled: true }, "Button"),
                            new bsts_1.b.button({ color: "primary", outline: true, disabled: true }, "Primary button"),
                            new bsts_1.b.button({ color: "secondary", outline: true, disabled: true }, "Button"),
                        ];
                    },
                }),
                ...
                new e.code({
                    ...
                    output: () => {
                        return [
                            new bsts_1.b.button({ color: "primary", href: "#", disabled: true }, "Primary link"),
                            new bsts_1.b.button({ color: "secondary", href: "#", disabled: true }, "Link"),
                        ];
                    },
                }),
            ]),
            ...
            new e.section([
                ...
                new e.text("To cover cases where you have to keep the {{href}} property on a disabled link, the {{disabled:true}} property uses {{pointer-events: none}} to try to disable the link functionality of {{h.a}}s. Note that this CSS property is not yet standardized for HTML, but all modern browsers support it. In addition, even in browsers that do support {{pointer-events: none}}, keyboard navigation remains unaffected, meaning that sighted keyboard users and users of assistive technologies will still be able to activate these links. So to be safe, in addition to {{aria-disabled='true'}}, also include a {{tabindex='-1'}} attribute on these links to prevent them from receiving keyboard focus, and use custom JavaScript to disable their functionality altogether."),
            ...
            new e.section([
                ...
                new e.text("Create responsive stacks of full-width, “block buttons” like those in Bootstrap 4 with a mix of Bootstrap display and gap utilities. By using utilities instead of button specific classes, Bootstrap have much greater control over spacing, alignment, and responsive behaviors."),
                new e.code({
                    output: () => {
                ...
                new e.code({
                    showViewport: true,
                    output: () => {
                        return new bsts_1.h.div({ display: ["grid", "md-flex"], gap: 2 }, [
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.h.div({ display: "grid", gap: 2, col: 6, marginX: "auto" }, [
                            new bsts_1.b.button("Button"),
                            new bsts_1.b.button("Button"),
                        ]);
                    },
                ...
                new e.code({
                    showViewport: true,
                    output: () => {
                        return new bsts_1.h.div({ display: ["grid", "md-flex"], gap: 2, justifyContent: "md-end" }, [
                            new bsts_1.b.button("Button"),
                            new bsts_1.b.button("Button"),
                        ]);
                    },
            ...
            new e.section([
                ...
                new e.alert({ color: "info", callout: true }, " Visually, these toggle buttons are identical to the {{nav:docs/forms/check_radio#checkbox_toggle_buttons::checkbox toggle buttons}}. However, they are conveyed differently by assistive technologies: the checkbox toggles will be announced by screen readers as “checked”/“not checked” (since, despite their appearance, they are fundamentally still checkboxes), whereas these toggle buttons will be announced as “button”/“button pressed”. The choice between these two approaches will depend on the type of toggle you are creating, and whether or not the toggle will make sense to users when announced as a checkbox or as an actual button."),
            ]),
            //----------------------
            new e.section([
                new e.subtitle("Toggle states"),
                new e.text("Add {{toggle:true}} to toggle a button’s {{active}} state. If you’re pre-toggling a button, you must manually add the {{active:true}} property. The {{aria:{pressed:'true'/}/}} add automaticly by {{bsts}} to ensure that it is conveyed appropriately to assistive technologies."),
                new e.code({
                    outputAttr: { display: "flex", flex: "wrap", gap: 2 },
                    output: () => {
                        return [
                            new bsts_1.b.button({ toggle: true }, "Toggle button"),
                            new bsts_1.b.button({ toggle: true, active: true }, "Active toggle button"),
                            new bsts_1.b.button({ toggle: true, disabled: true }, "Disabled toggle button"),
                        ];
                    },
                }),
                new e.code({
                    ...
                    output: () => {
                        return [
                            new bsts_1.b.button({ href: "#", toggle: true }, "Toggle button"),
                            new bsts_1.b.button({ href: "#", toggle: true, active: true }, "Active toggle button"),
                            new bsts_1.b.button({ href: "#", toggle: true, disabled: true }, "Disabled toggle button"),
                        ];
                    },
                }),
            ]),
                        ...
                        return [
                            new bsts_1.h.div({ display: "flex", overflow: "auto" }, [
                                new bsts_1.h.div({
                                    ...
                                    rounded: true,
                                    position: "relative",
                                }, new bsts_1.h.div({ position: "absolute", top: 50, start: 50, tMiddle: true }, new bsts_1.b.button({
                                    id: "example-button",
                                    outline: true,
                                    color: "primary",
                                    weight: "lg",
                                ...
                                new bsts_1.h.div({ marginStart: "auto" }, new bsts_1.b.btngroup({ vertical: true, weight: "sm" }, [
                                    new bsts_1.b.button({
                                        ...
                                        on: {
                                            click: (event) => {
                                                const elem = bsts_1.b.button.init("#example-button");
                                    ...
                                    new bsts_1.b.button({
                                        ...
                                        on: {
                                            click: (event) => {
                                                const elem = bsts_1.b.button.getInstance("#example-button");
                                    ...
                                    new bsts_1.b.button({
                                        ...
                                        on: {
                                            click: (event) => {
                                                const elem = bsts_1.b.button.getOrCreateInstance("#example-button");
                                    ...
                                    new bsts_1.b.button({
                                        on: {
                                            click: () => {
                                                bsts_1.b.button.toggle("#example-button");
                                            },
                                        },
                                    }, "toggle"),
                                    new bsts_1.b.button({
                                        ...
                                        on: {
                                            click: () => {
                                                bsts_1.b.button.dispose("#example-button");
                                            },
                                        },
                                    }, "dispose"),
                                ])),
