    ...
    item: () => {
        return [
            new e.section([
                ...
                new e.text("Bootstrap use a large block of connected links for Bootstrap pagination, making links hard to miss and easily scalable—all while providing large hit areas. Pagination is built with list HTML elements so screen readers can announce the number of available links. {{b.pagination.container}} use a wrapping {{h.nav}} element to identify it as a navigation section to screen readers and other assistive technologies."),
                new e.text("In addition, as pages likely have more than one such navigation section, it’s advisable to provide a descriptive {{label}} for the {{b.pagination.container}} to reflect its purpose. For example, if the pagination component is used to navigate between a set of search results, an appropriate label could be {{label:'Search results pages'}}."),
                new e.code({
                    output: () => {
                        return new bsts_1.b.pagination.container({ label: "Page navigation example" }, [
                            new bsts_1.b.pagination.item({ href: "#" }, "Previous"),
                            new bsts_1.b.pagination.item({ href: "#" }, "1"),
                            new bsts_1.b.pagination.item({ href: "#" }, "2"),
                            new bsts_1.b.pagination.item({ href: "#" }, "3"),
                            new bsts_1.b.pagination.item({ href: "#" }, "Next"),
                        ]);
                    },
                }),
            ]),
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.pagination.container({ label: "Page navigation example" }, [
                            new bsts_1.b.pagination.item({ href: "#", label: "Previous" }, new bsts_1.h.span({ aria: { hidden: true } }, new bsts_1.b.icon("chevron-bar-left"))),
                            new bsts_1.b.pagination.item({ href: "#" }, "1"),
                            new bsts_1.b.pagination.item({ href: "#" }, "2"),
                            new bsts_1.b.pagination.item({ href: "#" }, "3"),
                            new bsts_1.b.pagination.item({ href: "#", label: "Next" }, new bsts_1.h.span({ aria: { hidden: true } }, new bsts_1.b.icon("chevron-bar-right"))),
                        ]);
                    },
                }),
            ]),
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.pagination.container({ label: "..." }, [
                            new bsts_1.b.pagination.item({ disabled: true }, "Previous"),
                            new bsts_1.b.pagination.item({ href: "#" }, "1"),
                            new bsts_1.b.pagination.item({ href: "#", active: true }, "2"),
                            new bsts_1.b.pagination.item({ href: "#" }, "3"),
                            new bsts_1.b.pagination.item({ href: "#" }, "Next"),
                        ]);
                    },
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.pagination.container({ label: "..." }, [
                            new bsts_1.b.pagination.item({ disabled: true }, "Previous"),
                            new bsts_1.b.pagination.item({ href: "#" }, "1"),
                            new bsts_1.b.pagination.item({ active: true }, "2"),
                            new bsts_1.b.pagination.item({ href: "#", disabled: true }, "3"),
                            new bsts_1.b.pagination.item({ href: "#" }, "Next"),
                        ]);
                    },
                }),
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.pagination.container({ label: "...", weight: "lg" }, [
                            new bsts_1.b.pagination.item({ active: true }, "1"),
                            new bsts_1.b.pagination.item({ href: "#" }, "2"),
                            new bsts_1.b.pagination.item({ href: "#" }, "3"),
                        ]);
                    },
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.pagination.container({ label: "...", weight: "sm" }, [
                            new bsts_1.b.pagination.item({ active: true }, "1"),
                            new bsts_1.b.pagination.item({ href: "#" }, "2"),
                            new bsts_1.b.pagination.item({ href: "#" }, "3"),
                        ]);
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.pagination.container({ label: "Page navigation example", justifyContent: "center" }, [
                            new bsts_1.b.pagination.item({ disabled: true }, "Previous"),
                            new bsts_1.b.pagination.item({ href: "#" }, "1"),
                            new bsts_1.b.pagination.item({ href: "#" }, "2"),
                            new bsts_1.b.pagination.item({ href: "#" }, "3"),
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.pagination.container({ label: "Page navigation example", justifyContent: "end" }, [
                            new bsts_1.b.pagination.item({ disabled: true }, "Previous"),
                            new bsts_1.b.pagination.item({ href: "#" }, "1"),
                            new bsts_1.b.pagination.item({ href: "#" }, "2"),
                            new bsts_1.b.pagination.item({ href: "#" }, "3"),
            ...
            new e.section([
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.b.pagination.container({
                            label: "Event example",
                            total: 1284,
                            limit: 10,
                            maxBtnCount: 5,
