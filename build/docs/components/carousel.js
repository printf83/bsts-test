    ...
    item: () => {
        return [
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.carousel.container({ id: "carouselExample" }, [
                            new bsts_1.b.carousel.indicators.container([0, 1, 2, 3, 4, 5, 6].map((_i, ix) => {
                                return new bsts_1.b.carousel.indicators.button({
                                    target: "#carouselExample",
                                    slide: ix,
                                    active: ix === 0 ? true : undefined,
                                });
                            })),
                            new bsts_1.b.carousel.inner.container([0, 1, 2, 3, 4, 5, 6].map((i, ix) => {
                                return new bsts_1.b.carousel.inner.item.container({ active: ix === 0 ? true : undefined }, [
                                    new bsts_1.b.carousel.inner.item.img({
                                        src: `https://picsum.photos/seed/bsts_${i}/710/400.webp`,
                                    }),
                                    new bsts_1.b.carousel.inner.item.caption([
                                        new bsts_1.h.h(5, `Slide #${ix + 1}`),
                                        new bsts_1.h.p(`Some representative placeholder content for the slide #${ix + 1}.`),
                                    ]),
                                ]);
                            })),
                            new bsts_1.b.carousel.inner.control.prev({ target: "#carouselExample" }),
                            new bsts_1.b.carousel.inner.control.next({ target: "#carouselExample" }),
                        ]);
                    },
                }),
                new e.text("Carousels don’t automatically normalize slide dimensions. As such, you may need to use additional utilities or custom styles to appropriately size content. While carousels support previous/next controls and indicators, they’re not explicitly required. Add and customize as you see fit."),
                new e.text("{{b::You must add the}} {{.active}} {{b::class to one of the slides}}, otherwise the carousel will not be visible. Also be sure to set a unique {{id}} on the {{.carousel}} for optional controls, especially if you’re using multiple carousels on a single page. Control and indicator elements must have a {{data-bs-target}} attribute (or {{href}} for links) that matches the {{id}} of the {{.carousel}} element."),
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.carousel.container({
                            itemControl: true,
                            itemIndicator: true,
                            item: [0, 1, 2, 3, 4, 5, 6].map((i) => {
                                return {
                                    src: `https://picsum.photos/seed/bsts_${i}/710/400.webp`,
                                    caption: [
                                        new bsts_1.h.h(5, `Slide #${i + 1}`),
                                        new bsts_1.h.p(`Some representative placeholder content for the slide #${i + 1}.`),
                                    ],
                                };
                            }),
                        });
            ...
            new e.section([
                ...
                new e.text("Add {{fade:true}} to your carousel to animate slides with a fade transition instead of a slide. Depending on your carousel content (e.g., text only slides), you may want to add {{bgColor:'body'}} or some custom CSS to the {{b.carousel.inner.item.container}} for proper crossfading."),
                new e.code({
                    output: () => {
                        return new bsts_1.b.carousel.container({
                            fade: true,
            ...
            new e.section([
                ...
                new e.text("You can make your carousels autoplay on page load by setting the {{ride}} option to {{carousel}}. Autoplaying carousels automatically pause while hovered with the mouse. This behavior can be controlled with the {{pause}} option. In browsers that support the {{https://www.w3.org/TR/page-visibility/::Page Visibility API}}, the carousel will stop cycling when the webpage is not visible to the user (such as when the browser tab is inactive, or when the browser window is minimized)."),
                new e.text("{{bsts}} automaticly handle this."),
                new e.alert({ color: "info", callout: true }, [
                    new bsts_1.h.p("For accessibility reasons, Bootstrap recommend avoiding the use of autoplaying carousels. If your page does include an autoplaying carousel, Bootstrap recommend providing an additional button or control to explicitly pause/stop the carousel."),
                    new bsts_1.h.p("See {{https://www.w3.org/TR/WCAG21/#pause-stop-hide::WCAG 2.1 Success Criterion 2.2.2 Pause, Stop, Hide}}."),
                ]),
                new e.code({
                    output: () => {
                        return new bsts_1.b.carousel.container({
            ...
            new e.section([
                ...
                new e.alert({ color: "warning", callout: true }, "{{b::Heads up!}} Dark variants for components were deprecated in v5.3.0 with the introduction of color modes. Instead of adding {{.carousel-dark}}, set {{theme:'dark'}} on the {{b.carousel.container}}, a parent wrapper, or the component itself."),
                new e.code({
                    output: () => {
                        return new bsts_1.b.carousel.container({
                            theme: "dark",
                            ...
                            item: ["first", "second", "third", "fourth", "fifth"].map((i, ix) => {
                                return {
                                    src: `https://picsum.photos/seed/bsts_${ix}/710/400.webp`,
                                    caption: [
                                        new bsts_1.h.h(5, `${bsts_1.core.uppercaseFirst(i)} slide label`),
                                        new bsts_1.h.p(`Some representative placeholder content for the ${i} slide.`),
                                    ],
                                };
                            }),
                        });
            ...
            new e.section([
                ...
                new e.text("Use data attributes to easily control the position of the carousel. {{data-bs-slide}} accepts the keywords {{prev}} or {{next}}, which alters the slide position relative to its current position. Alternatively, use {{data-bs-slide-to}} to pass a raw slide index to the carousel {{data-bs-slide-to='2'}}, which shifts the slide position to a particular index beginning with {{0}}."),
            ]),
            //----------------------
            new e.section([
            ...
            new e.section([
                ...
                new e.code({
                    ...
                    output: () => {
                        return [
                            new bsts_1.h.div({ display: "flex", overflow: "auto" }, [
                                new bsts_1.h.div({
                                    width: 100,
                                    marginEnd: 3,
                                    ...
                                    rounded: true,
                                    position: "relative",
                                }, new bsts_1.h.div({ position: "absolute", top: 50, start: 50, tMiddle: true }, new bsts_1.b.carousel.container({
                                    id: "example-carousel",
                                    itemIndicator: true,
                                    item: [0, 1, 2, 3, 4, 5, 6].map((i) => {
                                        return {
                                ...
                                new bsts_1.h.div({ marginStart: "auto" }, new bsts_1.b.btngroup({ vertical: true, weight: "sm" }, [
                                    new bsts_1.b.button({
                                        color: "success",
                                        on: {
                                            click: (event) => {
                                                const elem = bsts_1.b.carousel.init("#example-carousel", {
                                                    interval: 1500,
                                                });
                                    ...
                                    new bsts_1.b.button({
                                        ...
                                        on: {
                                            click: (event) => {
                                                const elem = bsts_1.b.carousel.getInstance("#example-carousel");
                                    ...
                                    new bsts_1.b.button({
                                        ...
                                        on: {
                                            click: (event) => {
                                                const elem = bsts_1.b.carousel.getOrCreateInstance("#example-carousel");
                                    ...
                                    new bsts_1.b.button({
                                        on: {
                                            click: () => {
                                                bsts_1.b.carousel.cycle("#example-carousel");
                                            },
                                        },
                                    }, "cycle"),
                                    new bsts_1.b.button({
                                        on: {
                                            click: () => {
                                                bsts_1.b.carousel.pause("#example-carousel", false);
                                            },
                                        },
                                    }, "pause"),
                                    new bsts_1.b.button({
                                        on: {
                                            click: () => {
                                                bsts_1.b.carousel.next("#example-carousel");
                                            },
                                        },
                                    }, "next"),
                                    new bsts_1.b.button({
                                        on: {
                                            click: () => {
                                                bsts_1.b.carousel.nextWhenVisible("#example-carousel");
                                            },
                                        },
                                    }, "nextWhenVisible"),
                                    new bsts_1.b.button({
                                        on: {
                                            click: () => {
                                                bsts_1.b.carousel.prev("#example-carousel");
                                            },
                                        },
                                    }, "prev"),
                                    new bsts_1.b.button({
                                        on: {
                                            click: () => {
                                                bsts_1.b.carousel.to("#example-carousel", bsts_1.core.rndBetween(0, 6));
                                            },
                                        },
                                    }, "to (random)"),
                                    new bsts_1.b.button({
                                        ...
                                        on: {
                                            click: () => {
                                                bsts_1.b.carousel.dispose("#example-carousel");
                                            },
                                        },
                                    }, "dispose"),
                                ])),
                            ...
                            on: {
                                "slide.bs.carousel": (event) => {
                                    ...
                                    e.console(event.target, "slide.bs.carousel", `Direction: {{b::${carouselEvent.direction}}}{{br}}
															...
															RelatedTarget: {{b::${bsts_1.core.elemInfo(carouselEvent.relatedTarget)}}}`, "info");
                                },
                            },
                        });
                    },
