    ...
    item: () => {
        return [
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        let mainID = bsts_1.core.UUID();
                        return new bsts_1.b.accordion.container({ id: mainID }, [
                            {
                            ...
                            let itemID = bsts_1.core.UUID();
                            return new bsts_1.b.accordion.item([
                                new bsts_1.b.accordion.header({
                                    id: `heading-${itemID}`,
                                    target: `#collapse-${itemID}`,
                                    controlfor: `collapse-${itemID}`,
                                    expanded: i.show,
                                }, i.title),
                                new bsts_1.b.accordion.body({ id: `collapse-${itemID}`, parent: `#${mainID}`, show: i.show }, i.elem),
                            ]);
                        }));
                    },
                }),
            ...
            new e.section([
                ...
                new e.text("Please read the {{nav:docs/components/collapse#accessibility::collapse accessibility section}} for more information."),
            ]),
            //----------------------
