    ...
    item: () => {
        return [
            new e.section([
                ...
                new e.text("Offcanvas is a sidebar component that can be toggled via JavaScript to appear from the left, right, top, or bottom edge of the viewport. Buttons or anchors are used as triggers that are attached to specific elements you toggle, and {{data}} attributes are used to invoke Bootstrap JavaScript."),
                new e.ul({
                    item: [
            ...
            new e.section([
                ...
                new e.text("Below is an offcanvas example that is shown by default (via {{debug}} on {{b.offcanvas.container}}). Offcanvas includes support for a header ({{b.offcanvas.header}}) with a close button ({{b.offcanvas.btnclose}}) and an optional body ({{b.offcanvas.body}}) component for some initial {{padding}}. Bootstrap suggest that you include offcanvas headers with dismiss actions whenever possible, or provide an explicit dismiss action."),
                new e.code({
                    previewAttr: { bgColor: "body-tertiary", padding: 0 },
                    showCodepen: false,
                    output: () => {
                        return new bsts_1.b.offcanvas.container({
                            debug: true,
                            labelledby: "offcanvasLabel",
                        }, [
                            new bsts_1.b.offcanvas.header([
                                new bsts_1.b.offcanvas.title({ id: "offcanvasLabel" }, "Offcanvas"),
                                new bsts_1.b.offcanvas.btnclose(),
                            ]),
                            new bsts_1.b.offcanvas.body("Content for the offcanvas goes here. You can place just about any Bootstrap component or custom elements here."),
                        ]);
                    },
                }),
            ]),
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return [
                            new bsts_1.b.offcanvas.button({ target: "#offcanvasScrolling", controlfor: "offcanvasScrolling" }, "Enable body scrolling"),
                            new bsts_1.b.offcanvas.container({
                                ...
                                new bsts_1.b.offcanvas.header([
                                    new bsts_1.b.offcanvas.title({ id: "offcanvasScrollingLabel" }, "Offcanvas with body scrolling"),
                                    new bsts_1.b.offcanvas.btnclose(),
                                ]),
                                new bsts_1.b.offcanvas.body(new bsts_1.h.p("Try scrolling the rest of the page to see this option in action.")),
                            ]),
                        ];
                    },
                }),
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return [
                            new bsts_1.b.offcanvas.button({ target: "#offcanvasWithBothOptions", controlfor: "offcanvasWithBothOptions" }, "Enable both scrolling & backdrop"),
                            new bsts_1.b.offcanvas.container({
                                ...
                                new bsts_1.b.offcanvas.header([
                                    new bsts_1.b.offcanvas.title({ id: "offcanvasWithBothOptionsLabel" }, "Backdrop with scrolling"),
                                    new bsts_1.b.offcanvas.btnclose(),
                                ]),
                                new bsts_1.b.offcanvas.body(new bsts_1.h.p("Try scrolling the rest of the page to see this option in action.")),
                            ]),
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return [
                            new bsts_1.b.offcanvas.button({ target: "#staticBackdrop", controlfor: "staticBackdrop" }, "Toggle static offcanvas"),
                            new bsts_1.b.offcanvas.container({
                                id: "staticBackdrop",
                                backdrop: "static",
                                ...
                                new bsts_1.b.offcanvas.header([
                                    new bsts_1.b.offcanvas.title({ id: "staticBackdropLabel" }, "Offcanvas"),
                                    new bsts_1.b.offcanvas.btnclose(),
                                ]),
                                new bsts_1.b.offcanvas.body(new bsts_1.h.div("I will not close if you click outside of me.")),
                            ]),
                        ];
                    },
                }),
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.b.offcanvas.container({
                            ...
                            new bsts_1.b.offcanvas.header([
                                new bsts_1.b.offcanvas.title({ id: "offcanvasDarkLabel" }, "Offcanvas"),
                                new bsts_1.b.offcanvas.btnclose(),
                            ]),
                            new bsts_1.b.offcanvas.body("Place offcanvas content here."),
                        ]);
                    },
                }),
            ]),
            ...
            new e.section([
                ...
                new e.text("Responsive offcanvas classes hide content outside the viewport from a specified breakpoint and down. Above that breakpoint, the contents within will behave as usual. For example, {{show:'lg'}} hides content in an offcanvas below the {{lg}} breakpoint, but shows the content above the {{lg}} breakpoint."),
                new e.code({
                    showViewport: true,
                    output: () => {
                        return [
                            new bsts_1.b.offcanvas.button({
                                target: "#offcanvasResponsive",
                                controlfor: "offcanvasResponsive",
                                display: "lg-none",
                            }, "Toggle offcanvas"),
                            new bsts_1.b.alert.container({ color: "info", display: ["none", "lg-block"] }, "Resize your browser to show the responsive offcanvas toggle."),
                            new bsts_1.b.offcanvas.container({
                                ...
                                new bsts_1.b.offcanvas.header([
                                    new bsts_1.b.offcanvas.title({ id: "offcanvasResponsiveLabel" }, "Responsive offcanvas"),
                                    new bsts_1.b.offcanvas.btnclose({ target: "#offcanvasResponsive" }),
                                ]),
                                new bsts_1.b.offcanvas.body(new bsts_1.h.p({ marginBottom: 0 }, "This is content within an {{show:lg}}.")),
                            ]),
                        ];
                    },
                }),
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return [
                            new bsts_1.b.offcanvas.button({ target: "#offcanvasTop", controlfor: "offcanvasTop" }, "Toggle top offcanvas"),
                            new bsts_1.b.offcanvas.container({
                                id: "offcanvasTop",
                                placement: "top",
                                ...
                                new bsts_1.b.offcanvas.header([
                                    new bsts_1.b.offcanvas.title({ id: "offcanvasTopLabel" }, "Offcanvas top"),
                                    new bsts_1.b.offcanvas.btnclose(),
                                ]),
                                new bsts_1.b.offcanvas.body("..."),
                            ]),
                ...
                new e.code({
                    output: () => {
                        return [
                            new bsts_1.b.offcanvas.button({ target: "#offcanvasEnd", controlfor: "offcanvasEnd" }, "Toggle end offcanvas"),
                            new bsts_1.b.offcanvas.container({
                                id: "offcanvasEnd",
                                placement: "end",
                                ...
                                new bsts_1.b.offcanvas.header([
                                    new bsts_1.b.offcanvas.title({ id: "offcanvasEndLabel" }, "Offcanvas end"),
                                    new bsts_1.b.offcanvas.btnclose(),
                                ]),
                                new bsts_1.b.offcanvas.body("..."),
                            ]),
                ...
                new e.code({
                    output: () => {
                        return [
                            new bsts_1.b.offcanvas.button({ target: "#offcanvasBottom", controlfor: "offcanvasBottom" }, "Toggle bottom offcanvas"),
                            new bsts_1.b.offcanvas.container({
                                id: "offcanvasBottom",
                                placement: "bottom",
                                ...
                                new bsts_1.b.offcanvas.header([
                                    new bsts_1.b.offcanvas.title({ id: "offcanvasBottomLabel" }, "Offcanvas bottom"),
                                    new bsts_1.b.offcanvas.btnclose(),
                                ]),
                                new bsts_1.b.offcanvas.body("..."),
                            ]),
            ...
            new e.section([
                ...
                new e.codepreview({
                    ...
                    source: "https://github.com/twbs/bootstrap/blob/v5.3.0/scss/_offcanvas.scss",
                    code: `
            ...
            new e.section([
                ...
                new e.alert({ color: "warning", callout: true }, " While both ways to dismiss an offcanvas are supported, keep in mind that dismissing from outside an offcanvas does not match the {{https://www.w3.org/WAI/ARIA/apg/patterns/dialogmodal/::ARIA Authoring Practices Guide dialog (modal) pattern}}. Do this at your own risk."),
            ]),
            //----------------------
            new e.section([
            ...
            new e.section([
                ...
                new e.code({
                    showConsole: true,
                    output: () => {
                        const offcanvasContainer = new bsts_1.b.offcanvas.container({
                            id: "example-offcanvas",
                            labelledby: "example-offcanvas-label",
                        }, [
                            new bsts_1.b.offcanvas.header([
                                new bsts_1.b.offcanvas.title({ id: "example-offcanvas-label" }, "Offcanvas"),
                                new bsts_1.b.offcanvas.btnclose(),
                            ]),
                            new bsts_1.b.offcanvas.body("Content for the offcanvas goes here. You can place just about any Bootstrap component or custom elements here."),
                        ]);
                        const initButton = new bsts_1.b.button({
                            ...
                            on: {
                                click: (event) => {
                                    const oc = bsts_1.b.offcanvas.init("#example-offcanvas", {
                                        keyboard: false,
                                        backdrop: false,
                                        scroll: true,
                                    });
                        ...
                        const getInstanceButton = new bsts_1.b.button({
                            ...
                            on: {
                                click: (event) => {
                                    const oc = bsts_1.b.offcanvas.getInstance("#example-offcanvas");
                        ...
                        const getOrCreateInstanceButton = new bsts_1.b.button({
                            ...
                            on: {
                                click: (event) => {
                                    const oc = bsts_1.b.offcanvas.getOrCreateInstance("#example-offcanvas");
                        ...
                        const showButton = new bsts_1.b.button({
                            on: {
                                click: (event) => {
                                    bsts_1.b.offcanvas.show("#example-offcanvas", event.target);
                                },
                            },
                        }, "show");
                        const hideButton = new bsts_1.b.button({
                            on: {
                                click: () => {
                                    bsts_1.b.offcanvas.hide("#example-offcanvas");
                                },
                            },
                        }, "hide");
                        const toggleButton = new bsts_1.b.button({
                            on: {
                                click: (event) => {
                                    bsts_1.b.offcanvas.toggle("#example-offcanvas", event.target);
                                },
                            },
                        }, "toggle");
                        const disposeButton = new bsts_1.b.button({
                            ...
                            on: {
                                click: () => {
                                    bsts_1.b.offcanvas.dispose("#example-offcanvas");
                                },
                            },
                        }, "dispose");
            ...
            new e.section([
                ...
                new e.code({
                    ...
                    output: () => {
                        return [
                            new bsts_1.b.offcanvas.button({ target: "#offcanvasEventExample", controlfor: "offcanvasEventExample" }, "Show offcanvas event"),
                            new bsts_1.b.offcanvas.container({
                                ...
                                on: {
                                    "shown.bs.offcanvas": (event) => {
                                        const evnt = event;
                                        e.console(evnt.target, "shown.bs.offcanvas", `Target: {{b::${bsts_1.core.elemInfo(evnt.target)}}}{{br}}RelatedTarget: {{b::${bsts_1.core.elemInfo(evnt.relatedTarget)}}}`, "success");
                                    },
                                    "hidden.bs.offcanvas": (event) => {
                                        const target = event.target;
                                        e.console(target, "hidden.bs.offcanvas", `Target: {{b::${bsts_1.core.elemInfo(target)}}}`, "danger");
                                    },
                                    "hidePrevented.bs.offcanvas": (event) => {
                                        const target = event.target;
                                        e.console(target, "hidePrevented.bs.offcanvas", `Target: {{b::${bsts_1.core.elemInfo(target)}}}`, "warning");
                                    },
                                },
                            }, [
                                new bsts_1.b.offcanvas.header([
                                    new bsts_1.b.offcanvas.title({ id: "offcanvasEventExampleLabel" }, "Offcanvas"),
                                    new bsts_1.b.offcanvas.btnclose(),
                                ]),
                                new bsts_1.b.offcanvas.body([
                                    new bsts_1.h.div("Some text as placeholder. In real life you can have the elements you have chosen. Like, text, images, lists, etc."),
