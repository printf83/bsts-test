        ...
        return [
            ...
            new e.section([
                ...
                new e.alert({ color: "info", callout: true }, [
                    new bsts_1.h.h(5, "Using embedded SVG"),
            ...
            new e.section([
                ...
                new e.text("Since breadcrumbs provide a navigation, it’s a good idea to add a meaningful label such as {{label:'breadcrumb'}} to describe the type of navigation provided in the {{b.breadcrumb.container}} component, and automaticly applying an {{aria-current='page'}} to the last item of the set to indicate that it represents the current page."),
