...
exports.toast = {
    ...
    item: () => {
        return [
            new e.section([
                new e.text("Toasts are lightweight notifications designed to mimic the push notifications that have been popularized by mobile and desktop operating systems. They’re built with flexbox, so they’re easy to align and position."),
            ]),
            //----------------------
            new e.section([
                            ...
                            new bsts_1.b.button({
                                ...
                                on: {
                                    click: (_e) => {
                                        ...
                                        const toastBootstrap = bsts_1.b.toast.getOrCreateInstance(toastLiveExample);
                                        toastBootstrap.show();
                                    },
                                },
                            }, "Show live toast"),
                            new bsts_1.b.toast.container({ placement: "bottom-end" }, new bsts_1.b.toast.item({ id: "liveToast", live: "assertive", atomic: true }, [
                                new bsts_1.b.toast.header([
                                    new bsts_1.h.div({
                                        bgColor: "primary",
                                        rounded: true,
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.button({
                            on: {
                                click: (_e) => {
                                    const tItem = new bsts_1.b.toast.item({ live: "assertive", atomic: true }, [
                                        new bsts_1.b.toast.header([
                                            new bsts_1.h.div({
                                                bgColor: "primary",
                                                rounded: true,
                                            ...
                                            new bsts_1.h.strong({ marginEnd: "auto" }, "Bootstrap"),
                                            new bsts_1.b.toast.timer(),
                                            new bsts_1.b.toast.btnclose(),
                                        ]),
                                        new bsts_1.b.toast.body("Hello, world! This is a toast message."),
                                    ]);
                                    //show the above toast on the top-end
                                    bsts_1.b.toast.show(tItem, "top-end");
                                },
                            },
                        }, "Show live toast");
                    },
                ...
                new e.code({
                    ...
                    output: () => {
                        const fnToast = (color, elem, icon) => {
                            ...
                            switch (color) {
                                case "danger":
                                    tElem = new bsts_1.b.caption({
                                        icon: bsts_1.b.icon.bi(icon || "x-circle-fill", {
                                            fontSize: 5,
                                        }),
                                        elem: elem,
                                    });
                                ...
                                case "dark":
                                    tElem = new bsts_1.b.caption({
                                        icon: bsts_1.b.icon.bi(icon || "info-circle-fill", {
                                            fontSize: 5,
                                        }),
                                        elem: elem,
                                    });
                                ...
                                case "success":
                                    tElem = new bsts_1.b.caption({
                                        icon: bsts_1.b.icon.bi(icon || "check-circle-fill", {
                                            fontSize: 5,
                                        }),
                                        elem: elem,
                                    });
                                ...
                                case "warning":
                                    tElem = new bsts_1.b.caption({
                                        icon: bsts_1.b.icon.bi(icon || "exclamation-triangle-fill", {
                                            fontSize: 5,
                                        }),
                                        elem: elem,
                                    });
                        ...
                        const item = (msg, timer) => {
                            return new bsts_1.b.toast.item({ debug: true, live: "assertive", atomic: true }, [
                                new bsts_1.b.toast.header([
                                    ...
                                    new bsts_1.h.strong({ marginEnd: "auto" }, "Bootstrap"),
                                    new bsts_1.h.small(timer),
                                    new bsts_1.b.toast.btnclose(),
                                ]),
                                new bsts_1.b.toast.body(msg),
                            ]);
                        };
                        return new bsts_1.b.toast.container({ debug: true }, [
            ...
            new e.section([
                ...
                new e.code({
                    showCodepen: false,
                    output: () => {
                        return new bsts_1.b.toast.item({ debug: true, alignItem: "center", live: "assertive", atomic: true }, [
                            new bsts_1.b.toast.body([
                                "Hello, world! This is a toast message.",
                                new bsts_1.h.div({ marginTop: 2, paddingTop: 2, border: "top", display: "flex", gap: 1 }, [
                                    new bsts_1.b.button({ weight: "sm" }, "Take action"),
                                    new bsts_1.b.button({ weight: "sm", color: "secondary", dismiss: "toast" }, "Close"),
                                ]),
                            ]),
                        ]);
                    },
            ...
            new e.section([
                ...
                new e.code({
                    showCodepen: false,
                    output: () => {
                        return new bsts_1.b.toast.item({
                            debug: true,
                            alignItem: "center",
                            textBgColor: "primary",
                            border: false,
                            ...
                            new bsts_1.b.toast.body("Hello, world! This is a toast message."),
                            new bsts_1.b.toast.btnclose({ white: true, marginEnd: 2, margin: "auto" }),
                        ]));
                    },
                }),
            ]),
            ...
            new e.section([
                ...
                new e.code({
                    ...
                    output: () => {
                        const container = (placement) => {
                            return new bsts_1.b.toast.container({
                                class: "debug",
                                padding: 3,
                                id: "toastPlacement",
                                placement: placement,
                                position: undefined,
                            }, new bsts_1.b.toast.item({ debug: true }, [
                                new bsts_1.b.toast.header([
                                    new bsts_1.h.div({
                                        bgColor: "primary",
                                        rounded: true,
                        ...
                        return [
                            new bsts_1.h.form([
                                new bsts_1.h.label({ for: "selectToastPlacement" }, "Toast placement"),
                                new bsts_1.b.select({
                                    marginTop: 2,
                                    ...
                                    on: {
                                        change: (e) => {
                                            ...
                                            bsts_1.core.replaceWith(document.getElementById("toastPlacement"), container(value));
                                        },
                                    },
                                }),
                            ]),
                ...
                new e.code({
                    ...
                    output: () => {
                        ...
                        return new bsts_1.h.div({ aria: { live: "polite", atomic: "true" }, position: "relative" }, new bsts_1.b.toast.container({ debug: true, placement: "top-end" }, [
                            item("See? just like this", "Just now"),
                            item("Heads up, toasts will stack automatically", "2 second ago"),
                        ]));
                    },
            ...
            new e.section([
                    ...
                    output: () => {
                        return [
                            new bsts_1.b.button({
                                on: {
                                    click: (_e) => {
                                        const tItem = new bsts_1.b.toast.item({ live: "assertive", atomic: true, delay: 10000 }, [
                                            new bsts_1.b.toast.header([
                                                new bsts_1.h.div({
                                                    bgColor: "primary",
                                                    rounded: true,
                                            ...
                                            new bsts_1.b.toast.body("This toast auto close {{delay}} set to 10 second"),
                                        ]);
                                        bsts_1.b.toast.show(tItem);
                                    },
                                },
                ...
                new e.code({
                    showCodepen: false,
                    output: () => {
                        return new bsts_1.b.toast.item({ debug: true, live: "assertive", atomic: true, autohide: false }, [
                            new bsts_1.b.toast.header([
                                new bsts_1.h.div({
                                    bgColor: "primary",
                                    rounded: true,
                        ...
                        return [
                            new bsts_1.h.div({ display: "flex", overflow: "auto" }, [
                                new bsts_1.h.div({
                                    ...
                                    rounded: true,
                                    position: "relative",
                                }, new bsts_1.h.div({ position: "absolute", top: 50, start: 50, tMiddle: true }, new bsts_1.b.toast.item({ id: "example-toast", live: "assertive", atomic: true, autohide: false }, [
                                    new bsts_1.b.toast.header([
                                        new bsts_1.h.div({
                                            bgColor: "primary",
                                            rounded: true,
                                        ...
                                        new bsts_1.h.strong({ marginEnd: "auto" }, "Bootstrap"),
                                        new bsts_1.h.small("Just now"),
                                        new bsts_1.b.toast.btnclose(),
                                    ]),
                                    new bsts_1.b.toast.body("Example toast"),
                                ]))),
                                new bsts_1.h.div({ marginStart: "auto" }, new bsts_1.b.btngroup({ vertical: true, weight: "sm" }, [
                                    new bsts_1.b.button({
                                        on: {
                                            click: () => {
                                                bsts_1.b.toast.show("#example-toast");
                                            },
                                        },
                                    }, "show"),
                                    new bsts_1.b.button({
                                        on: {
                                            click: () => {
                                                bsts_1.b.toast.hide("#example-toast");
                                            },
                                        },
                                    }, "hide"),
                                    new bsts_1.b.button({
                                        on: {
                                            click: (event) => {
                                                ...
                                                const result = bsts_1.b.toast.isShown("#example-toast");
                                    ...
                                    new bsts_1.b.button({
                                        ...
                                        on: {
                                            click: () => {
                                                bsts_1.b.toast.dispose("#example-toast");
                                            },
                                        },
                                    }, "dispose"),
                                ])),
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.b.button({
                            on: {
                                click: (btnEvent) => {
                                    const tItem = new bsts_1.b.toast.item({
                                        color: "primary",
                                        autohide: false,
                                        live: "assertive",
                                        atomic: true,
                                        on: {
                                            "shown.bs.toast": (event) => {
                                                const target = event.target;
                                                e.console(btnEvent.target, "shown.bs.toast", `Target: {{b::${bsts_1.core.elemInfo(target)}}}`, "success");
                                            },
                                            "hidden.bs.toast": (event) => {
                                                const target = event.target;
                                                e.console(btnEvent.target, "hidden.bs.toast", `Target: {{b::${bsts_1.core.elemInfo(target)}}}`, "danger");
                                            },
                                        },
                                    }, [
                                        new bsts_1.b.toast.header([
                                        ...
                                        new bsts_1.b.toast.body("Hello, world! This is a toast event example. This toast {{b::dose not}} close automaticly. Click on the close button to close this toast."),
                                    ]);
                                    //show the above toast on the top-end
                                    bsts_1.b.toast.show(tItem, "top-end");
                                },
