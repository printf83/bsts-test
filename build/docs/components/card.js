...
exports.card = {
    ...
    item: () => {
        return [
            new e.section([
                new e.title("About"),
                new e.text("A {{card}} ({{b.card.container}}) is a flexible and extensible content container. It includes options for headers ({{b.card.header}}) and footers ({{b.card.footer}}), a wide variety of content, contextual background colors, and powerful display options. If you’re familiar with Bootstrap 3, cards replace Bootstrap old panels, wells, and thumbnails. Similar functionality to those components is available as modifier classes for cards."),
            ]),
            //----------------------
            new e.section([
                new e.title("Example"),
                new e.text("Cards are built with as little markup and styles as possible, but still manage to deliver a ton of control and customization. Built with flexbox, they offer easy alignment and mix well with other Bootstrap components. They have no {{margin}} by default, so use {{nav:docs/utilities/spacing::spacing utilities}} as needed."),
                new e.text("Below is an example of a basic card with mixed content and a fixed width. Cards have no fixed width to start, so they’ll naturally fill the full width of its parent element. This is easily customized with Bootstrap various {{nav:docs/components/card#sizing::sizing options}}."),
                new e.code({
                    output: () => {
            ...
            new e.section([
                ...
                new e.text("Cards support a wide variety of content, including images ({{b.card.img}}), text ({{b.card.text}}), list groups ({{b.list.container}}), links ({{b.card.link}}), and more. Below are examples of what’s supported."),
            ]),
            //----------------------
            new e.section([
                new e.subtitle("Body"),
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.card.container(new bsts_1.b.card.body("This is some text within a card body."));
                    },
                }),
            ]),
            //----------------------
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.card.container({ style: { width: "18rem" } }, [
                            new bsts_1.b.card.header("Featured"),
                            new bsts_1.b.list.container({ flush: true }, [
                                new bsts_1.b.list.item("An item"),
                                new bsts_1.b.list.item("A second item"),
                                new bsts_1.b.list.item("A third item"),
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.card.container({ style: { width: "18rem" } }, [
                            ...
                            new bsts_1.b.card.footer("Card footer"),
                        ]);
                    },
                }),
            ]),
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.card.container([
                            new bsts_1.b.card.header("Featured"),
                            new bsts_1.b.card.body([
                                new bsts_1.b.card.title("Special title treatment"),
                                new bsts_1.b.card.text("With supporting text below as a natural lead-in to additional content."),
                                new bsts_1.b.button("Go somewhere"),
                            ]),
                        ]);
                    },
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.card.container([
                            new bsts_1.h.h(5, { class: "card-header" }, "Featured"),
                            new bsts_1.b.card.body([
                                new bsts_1.b.card.title("Special title treatment"),
                                new bsts_1.b.card.text("With supporting text below as a natural lead-in to additional content."),
                                new bsts_1.b.button("Go somewhere"),
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.card.container([
                            new bsts_1.h.div({ class: "card-header" }, "Quote"),
                            new bsts_1.b.card.body([
                                new bsts_1.b.blockquote.container({ marginBottom: 0 }, [
                                    new bsts_1.h.p("A well-known quote, contained in a blockquote element."),
                                    new bsts_1.b.blockquote.footer([
                                        "Someone famous in ",
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.card.container({ textAlign: "center" }, [
                            new bsts_1.b.card.header("Featured"),
                            new bsts_1.b.card.body([
                                new bsts_1.b.card.title("Special title treatment"),
                                new bsts_1.b.card.text("With supporting text below as a natural lead-in to additional content."),
                            ...
                            new bsts_1.b.card.footer({ textColor: "body-secondary" }, "2 days ago"),
                        ]);
                    },
                }),
            ]),
            ...
            new e.section([
                new e.title("Sizing"),
                new e.text("Cards assume no specific {{width}} to start, so they’ll be 100% wide unless otherwise stated. You can change this as needed with custom CSS, grid classes, grid Sass mixins, or utilities."),
            ]),
            //----------------------
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.h.div({ row: true }, [
                            new bsts_1.h.div({ col: "sm-6", marginBottom: [3, "sm-0"] }, new bsts_1.b.card.container(new bsts_1.b.card.body([
                                new bsts_1.b.card.title("Special title treatment"),
                                new bsts_1.b.card.text("With supporting text below as a natural lead-in to additional content."),
                                new bsts_1.b.button("Go somewhere"),
                            ]))),
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return [
                            new bsts_1.b.card.container({ width: 75, marginBottom: 3 }, new bsts_1.b.card.body([
                                new bsts_1.b.card.title("Card title"),
                                new bsts_1.b.card.text("With supporting text below as a natural lead-in to additional content."),
                                new bsts_1.b.button("Button"),
                            ])),
                            new bsts_1.b.card.container({ width: 50 }, new bsts_1.b.card.body([
                                new bsts_1.b.card.title("Card title"),
                                new bsts_1.b.card.text("With supporting text below as a natural lead-in to additional content."),
                                new bsts_1.b.button("Button"),
                            ])),
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.card.container({ textAlign: "center" }, [
                            new bsts_1.b.card.header(new bsts_1.b.card.nav({ type: "tab" }, [
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.card.container({ textAlign: "center" }, [
                            new bsts_1.b.card.header(new bsts_1.b.card.nav({ type: "pill" }, [
                                new bsts_1.b.nav.header.item(new bsts_1.b.nav.header.link({ active: true, href: "#" }, "Active")),
                                new bsts_1.b.nav.header.item(new bsts_1.b.nav.header.link({ href: "#" }, "Link")),
                                new bsts_1.b.nav.header.item(new bsts_1.b.nav.header.link({ disabled: true, href: "#" }, "Disabled")),
                            ])),
            ...
            new e.section([
                new e.title("Images"),
                new e.text("Cards include a few options for working with images. Choose from appending “image caps” at either end of a card, overlaying images with card content, or simply embedding the image in a card."),
            ]),
            //----------------------
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return [
                            new bsts_1.b.card.container({ marginBottom: 3 }, [
                                new bsts_1.b.card.img({
                                    location: "top",
                                ...
                                new bsts_1.b.card.body([
                                    new bsts_1.b.card.title("Card title"),
                                    new bsts_1.b.card.text("This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer."),
                                    new bsts_1.b.card.text(new bsts_1.h.small({ textColor: "body-secondary" }, "Last updated 3 mins ago")),
                                ]),
                            ]),
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.card.container({ textBgColor: "dark" }, [
                            new bsts_1.b.card.img({
            ...
            new e.section([
                ...
                new e.text("Using a combination of grid and utility classes, cards can be made horizontal in a mobile-friendly and responsive way. In the example below, Bootstrap remove the grid gutters with {{gutter:0}} and use {{col:'<value>'}} property to make the card horizontal at the {{md}} breakpoint. Further adjustments may be needed depending on your card content."),
                new e.code({
                    showViewport: true,
                    output: () => {
                        return new bsts_1.b.card.container({ style: { maxWidth: "540px" } }, [
                            new bsts_1.h.div({ row: true, gutter: 0 }, [
                                new bsts_1.h.div({ col: "md-4" }, new bsts_1.b.card.img({
                                    fluid: true,
                                    rounded: "start",
                                    src: "https://picsum.photos/seed/bsts_0/180/250.webp",
                                    alt: "Image",
                                })),
                                new bsts_1.h.div({ col: "md-8" }, new bsts_1.b.card.body([
                                    new bsts_1.b.card.title("Card title"),
                                    new bsts_1.b.card.text("This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer."),
                                    new bsts_1.b.card.text(new bsts_1.h.small({ textColor: "body-secondary" }, "Last updated 3 mins ago")),
                                ])),
            ...
            new e.section([
                ...
                new e.text("Set a {{bgColor}} with contrasting foreground {{textColor}} with {{nav:docs/helpers/color_background::Bootstrap textBgColor helpers}}. Previously it was required to manually pair your choice of {{nav:docs/utilities/colors::textColor}} and {{nav:docs/utilities/background::bgColor}} utilities for styling, which you still may use if you prefer."),
                new e.code({
                    output: () => {
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.card.container({
                            ...
                            new bsts_1.b.card.header({ borderColor: "success", bgColor: "transparent" }, "Header"),
                            new bsts_1.b.card.body({ textColor: "success" }, [
                                new bsts_1.b.card.title("Success card title"),
                                new bsts_1.b.card.text("Some quick example text to build on the card title and make up the bulk of the card's content."),
                            ]),
                            new bsts_1.b.card.footer({ borderColor: "success", bgColor: "transparent" }, "Footer"),
                        ]);
                    },
                }),
            ]),
            ...
            new e.section([
                ...
                new e.text("In addition to styling the content within cards, Bootstrap includes a few options for laying out series of cards. For the time being, {{b::these layout options are not yet responsive}}."),
            ]),
            //----------------------
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.card.group([
                    ...
                    output: () => {
                        return new bsts_1.b.card.group([
                            ...
                            return new bsts_1.b.card.container([
                                ...
                                new bsts_1.b.card.body([new bsts_1.b.card.title("Card title"), new bsts_1.b.card.text(i)]),
                                new bsts_1.b.card.footer(new bsts_1.h.small({ textColor: "body-secondary" }, "Last updated 3 mins ago")),
                            ]);
                        }));
                    },
                }),
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.h.div({
                            ...
                            return new bsts_1.h.div({ col: true }, new bsts_1.b.card.container([
                                new bsts_1.b.card.img({
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.h.div({
                            ...
                            return new bsts_1.h.div({ col: true }, new bsts_1.b.card.container({ height: 100 }, [
                                new bsts_1.b.card.img({
                                    src: "https://picsum.photos/seed/bsts_0/218/140.webp",
                                    alt: "Image cap",
                                    location: "top",
