    ...
    item: () => {
        return [
            new e.section([
                ...
                new e.code({
                    output: () => {
                        const myModal = new bsts_1.b.modal.container({
                            id: "myModal",
                            ...
                            new bsts_1.b.modal.header({ close: true }, new bsts_1.b.modal.title({ id: "myModalLabel" }, "Modal title")),
                            new bsts_1.b.modal.body(new bsts_1.b.input({ id: "myModalInput" })),
                        ...
                        const myModalToggle = new bsts_1.b.button({ color: "primary", toggle: "modal", target: "#myModal" }, "Launch demo modal");
            ...
            new e.section([
                ...
                new e.alert({ color: "info", callout: true }, "In the above static example, Bootstrap use {{<h5>}}, to avoid issues with the heading hierarchy in the documentation page. Structurally, however, a modal dialog represents its own separate document/context, so the {{.modal-title}} should ideally be an {{<h1>}}. If necessary, you can use the {{nav:docs/utilities/text#font_size::font size utilities}} to control the heading’s appearance. All the following live examples use this approach.{{hr}}{{bsts}} using {{h.h(1)}} because we don't have that issue."),
            ]),
            //----------------------
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return [
                            ...
                            new bsts_1.b.button({ color: "primary", toggle: "modal", target: "#exampleModal" }, "Launch demo modal"),
                            // Modal
                            new bsts_1.b.modal.container({ id: "exampleModal", labelledby: "exampleModalLabel" }, [
                                new bsts_1.b.modal.header({ close: true }, new bsts_1.b.modal.title({ id: "exampleModalLabel" }, "Modal title")),
                                new bsts_1.b.modal.body(new bsts_1.h.p("Woo-hoo, you're reading this text in a modal!")),
                                new bsts_1.b.modal.footer([
                                    new bsts_1.b.button({ dismiss: "modal", color: "secondary" }, "Close"),
                                    new bsts_1.b.button({ color: "primary" }, "Save changes"),
                                ]),
                            ...
                            new bsts_1.b.button({
                                ...
                                on: {
                                    click: (_e) => {
                                        ...
                                        const mdl = new bsts_1.b.modal.container({ labelledby: "exampleShowModalLabel" }, [
                                            new bsts_1.b.modal.header({ close: true }, new bsts_1.b.modal.title({ id: "exampleShowModalLabel" }, "Modal title")),
                                            new bsts_1.b.modal.body(new bsts_1.h.p("Woo-hoo, you're reading this text in a modal!")),
                                            new bsts_1.b.modal.footer([
                                                new bsts_1.b.button({ dismiss: "modal", color: "secondary" }, "Close"),
                                                new bsts_1.b.button({ color: "primary" }, "Save changes"),
                        ...
                        return [
                            new bsts_1.b.button({
                                ...
                                on: {
                                    click: () => {
                                        //simple modal
                                        const mdl = bsts_1.b.modal.create({
                                            title: document.title,
                                            elem: bsts_1.b.form.check({
                                                id: "testcheckbox",
                                            ...
                                            btnFn: [
                                                (event) => {
                                                    ...
                                                    const ischecked = (_a = container === null || container === void 0 ? void 0 : container.querySelectorAll("#testcheckbox")[0]) === null || _a === void 0 ? void 0 : _a.checked;
                                                    //hide modal base on rules
                                                    if (ischecked) {
                                                        bsts_1.b.toast.show(bsts_1.b.toast.create({
                                                            title: "Simple modal example",
                                                            color: "success",
                                                            elem: "Thank you for tick the checkbox.",
                                                        }));
                                                        //hide the modal because the checkbox is ticked
                                                        bsts_1.b.modal.hide(container);
                                                    }
                                                    else {
                                                        bsts_1.b.toast.show(bsts_1.b.toast.create({
                                                            title: "Simple modal example",
                                            ...
                                            on: {
                                                "shown.bs.modal": (_e) => {
                                                    ...
                                                    (_a = document.getElementById("testcheckbox")) === null || _a === void 0 ? void 0 : _a.focus();
                                                },
                                                "hidden.bs.modal": (_e) => {
                                                    var _a;
                                                    //focus to button when modal hide
                                                    (_a = document.getElementById("btntestcheckbox")) === null || _a === void 0 ? void 0 : _a.focus();
                                                },
                                            },
                                        });
                            ...
                            new bsts_1.b.button({
                                on: {
                                    click: () => {
                                        ...
                                        const mdl = bsts_1.b.modal.create({
                                            title: document.title,
                                            elem: new bsts_1.b.msg({ id: "info-circle-fill", textColor: "primary" }, "Hello world. Open {{nav:docs/forms/select#disabled::Forms select}} document from msgbox then show {{#disabled}} section"),
                                ...
                                on: {
                                    click: () => {
                                        ...
                                        const mdl = bsts_1.b.modal.create({
                                            title: document.title,
                                            backdrop: "static",
                                            elem: new bsts_1.b.msg({ id: "question-circle-fill", textColor: "success" }, "Do you like javascript?"),
                                            btn: ["yes", "no", "cancel"],
                                            btnFn: [
                                                (event) => {
                                                    //event handler for first button
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return [
                            new bsts_1.b.button({ color: "primary", toggle: "modal", target: "#staticBackdrop" }, "Launch static backdrop modal"),
                            new bsts_1.b.modal.container({
                                id: "staticBackdrop",
                                labelledby: "staticBackdropLabel",
                                backdrop: "static", //set static backdrop
                            }, [
                                new bsts_1.b.modal.header({ close: true }, new bsts_1.b.modal.title({ id: "staticBackdropLabel" }, "Modal title")),
                                new bsts_1.b.modal.body(new bsts_1.h.p("I will not close if you click outside of me. Don't even try to press escape key.")),
                                new bsts_1.b.modal.footer([
                                    new bsts_1.b.button({ dismiss: "modal", color: "secondary" }, "Close"),
                                    new bsts_1.b.button({ color: "primary" }, "Save changes"),
                                ]),
            ...
            new e.section([
                ...
                new e.code({
                    ...
                    output: () => {
                        return [
                            new bsts_1.b.button({ color: "primary", toggle: "modal", target: "#scrollingModal" }, "Launch demo modal"),
                            new bsts_1.b.modal.container({ id: "scrollingModal", labelledby: "scrollingModalLabel" }, [
                                new bsts_1.b.modal.header({ close: true }, new bsts_1.b.modal.title({ id: "scrollingModalLabel" }, "Modal title")),
                                new bsts_1.b.modal.body(new bsts_1.h.p({ style: { height: "100vh" } }, "This is some placeholder content to show the scrolling behavior for modals. Instead of repeating the text the modal, Bootstrap use an inline style set a minimum height, thereby extending the length of the overall modal and demonstrating the overflow scrolling. When content becomes longer than the height of the viewport, scrolling will move the modal as needed.")),
                                new bsts_1.b.modal.footer([
                                    new bsts_1.b.button({ dismiss: "modal", color: "secondary" }, "Close"),
                                    new bsts_1.b.button({ color: "primary" }, "Save changes"),
                                ]),
                ...
                new e.code({
                    output: () => {
                        return [
                            new bsts_1.b.button({ color: "primary", toggle: "modal", target: "#scrollableModal" }, "Launch demo modal"),
                            new bsts_1.b.modal.container({
                                id: "scrollableModal",
                                labelledby: "scrollableModalLabel",
                                scrollable: true, //set scrollable
                            }, [
                                new bsts_1.b.modal.header({ close: true }, new bsts_1.b.modal.title({ id: "scrollableModalLabel" }, "Modal title")),
                                new bsts_1.b.modal.body([
                                    ...
                                    new bsts_1.h.p("This content should appear at the bottom after you scroll."),
                                ]),
                                new bsts_1.b.modal.footer([
                                    new bsts_1.b.button({ dismiss: "modal", color: "secondary" }, "Close"),
                                    new bsts_1.b.button({ color: "primary" }, "Save changes"),
                ...
                new e.code({
                    ...
                    output: () => {
                        let modalContent = (id, elem) => {
                            return [
                                new bsts_1.b.modal.header({ close: true }, new bsts_1.b.modal.title({ id: `${id}Label` }, "Modal title")),
                                new bsts_1.b.modal.body(elem),
                                new bsts_1.b.modal.footer([
                                    new bsts_1.b.button({ dismiss: "modal", color: "secondary" }, "Close"),
                                    new bsts_1.b.button({ color: "primary" }, "Save changes"),
                                ]),
                        ...
                        return [
                            // Button trigger modal
                            new bsts_1.b.button({ color: "primary", toggle: "modal", target: "#verticalCenterModal", textWrap: false }, "Vertically centered modal"),
                            new bsts_1.b.button({
                                color: "primary",
                                toggle: "modal",
                            ...
                            }, modalContent("verticalCenterModal", new bsts_1.h.p("This is a vertically centered modal."))),
                            // Vertically centered modal
                            new bsts_1.b.modal.container({
            ...
            new e.section([
                ...
                new e.code({
                    ...
                    output: () => {
                        const modalElem = [
                            new bsts_1.h.h(2, { fontSize: 5 }, "Popover in a modal"),
                            new bsts_1.h.p([
                                "This ",
                                new bsts_1.b.popover({
                                    title: "Popover title",
                                    content: "Popover body content is set in this attribute",
                                }, new bsts_1.b.button({ color: "secondary" }, "button")),
                                " triggers a popover on click.",
                            ]),
                            new bsts_1.h.hr(),
                            new bsts_1.h.h(2, { fontSize: 5 }, "Tooltips in a modal"),
                            new bsts_1.h.p([
                                new bsts_1.b.tooltip({
                                    content: "Tooltip",
                                }, new bsts_1.h.a({ href: "#" }, "This link")),
                                " and ",
                                new bsts_1.b.tooltip({
                                    content: "Tooltip",
                                }, new bsts_1.h.a({ href: "#" }, "that link")),
                                " have tooltips on hover.",
                            ]),
                        ];
                        return [
                            // Button trigger modal
                            new bsts_1.b.button({ color: "primary", toggle: "modal", target: "#tooltipPopoverModal" }, "Launch demo modal"),
                            ...
                            // Modal
                            new bsts_1.b.modal.container({ id: "tooltipPopoverModal", labelledby: "tooltipPopoverModalLabel" }, [
                                new bsts_1.b.modal.header({ close: true }, new bsts_1.b.modal.title({ id: "tooltipPopoverModalLabel" }, "Modal title")),
                                new bsts_1.b.modal.body(modalElem),
                                new bsts_1.b.modal.footer([
                                    new bsts_1.b.button({ dismiss: "modal", color: "secondary" }, "Close"),
                                    new bsts_1.b.button({ color: "primary" }, "Save changes"),
                                ]),
                    ...
                    output: () => {
                        return [
                            ...
                            new bsts_1.b.button({
                                ...
                                on: {
                                    click: () => {
                                        const mdl = new bsts_1.b.modal.container({ labelledby: "tooltipPopoverLiveModalLabel" }, [
                                            new bsts_1.b.modal.header({ close: true }, new bsts_1.b.modal.title({ id: "tooltipPopoverLiveModalLabel" }, "Modal title")),
                                            new bsts_1.b.modal.body([
                                                new bsts_1.h.h(2, { fontSize: 5 }, "Popover in a modal"),
                                                new bsts_1.h.p([
                                                    "This ",
            ...
            new e.section([
                ...
                new e.code({
                    ...
                    output: () => {
                        return [
                            // Button trigger modal
                            new bsts_1.b.button({ color: "primary", toggle: "modal", target: "#gridModal" }, "Launch demo modal"),
                            // Modal
                            new bsts_1.b.modal.container({ id: "gridModal", labelledby: "gridModalLabel" }, [
                                new bsts_1.b.modal.header({ close: true }, new bsts_1.b.modal.title({ id: "gridModalLabel" }, "Modal title")),
                                new bsts_1.b.modal.body({ class: "bs-highlight-col" }, new bsts_1.h.div({ container: "fluid" }, [
                                    new bsts_1.b.row([
                                        new bsts_1.b.col({ col: "md-4" }, ".col-md-4"),
                                        new bsts_1.b.col({ col: "md-4", marginStart: "auto" }, ".col-md-4 .ms-auto"),
                                    ]),
                                    new bsts_1.b.row([
                                        new bsts_1.b.col({ col: "md-3", marginStart: "auto" }, ".col-md-3 .ms-auto"),
                                        new bsts_1.b.col({ col: "md-2", marginStart: "auto" }, ".col-md-2 .ms-auto"),
                                    ]),
                                    new bsts_1.b.row([
                                        new bsts_1.b.col({ col: "md-6", marginStart: "auto" }, ".col-md-6 .ms-auto"),
                                    ]),
                                    new bsts_1.b.row(new bsts_1.b.col({ col: "sm-9" }, [
                                        "Level 1: .col-sm-9",
                                        new bsts_1.b.row([
                                            new bsts_1.b.col({ col: [8, "sm-6"] }, "Level 2: .col-8 .col-sm-6"),
                                            new bsts_1.b.col({ col: [4, "sm-6"] }, "Level 2: .col-4 .col-sm-6"),
                                        ]),
                                    ])),
                                ])),
                                new bsts_1.b.modal.footer([
                ...
                new e.code({
                    ...
                    output: () => {
                        return [
                            // Button trigger modal
                            new bsts_1.b.button({ color: "primary", toggle: "modal", target: "#gridModal2" }, "Launch demo modal"),
                            // Modal
                            new bsts_1.b.modal.container({ id: "gridModal2", labelledby: "gridModalLabel2" }, [
                                new bsts_1.b.modal.header({ close: true }, new bsts_1.b.modal.title({ id: "gridModalLabel2" }, "Modal title")),
                                new bsts_1.b.modal.body({ class: "bs-highlight-col" }, 
                            ...
                            new bsts_1.b.modal.container({
                                ...
                                on: {
                                    "show.bs.modal": (e) => {
                                        ...
                                        const mdlTitle = mdl === null || mdl === void 0 ? void 0 : mdl.querySelector(".modal-title");
                                        const mdlName = mdl === null || mdl === void 0 ? void 0 : mdl.querySelector("#recipient-name");
                                        mdlTitle.textContent = `New message to ${recipient}`;
                                        mdlName.value = recipient;
                                    },
                                },
                            }, [
                                new bsts_1.b.modal.header({ close: true }, new bsts_1.b.modal.title({ id: "varyingContentModalLabel" }, "Modal title")),
                                new bsts_1.b.modal.body(new bsts_1.h.form([
                                    new bsts_1.h.div({ marginBottom: 3 }, [
                                        new bsts_1.b.label({ for: "recipient-name" }, "Recipient:"),
                                        new bsts_1.b.input({ id: "recipient-name", type: "text" }),
                                    ]),
                                    new bsts_1.h.div({ marginBottom: 3 }, [
                                        new bsts_1.b.label({ for: "message-text" }, "Message:"),
                                        new bsts_1.b.textarea({ id: "message-text" }),
                                    ]),
                                ])),
                                new bsts_1.b.modal.footer([
                                    new bsts_1.b.button({ dismiss: "modal", color: "secondary" }, "Close"),
            ...
            new e.section([
                ...
                new e.text("Toggle between multiple modals with some clever placement of the {{target}} and {{toggle}} property. For example, you could toggle a password reset modal from within an already open sign in modal. {{b::Please note multiple modals cannot be open at the same time}}—this method simply toggles between two separate modals."),
                new e.code({
                    output: () => {
                        const mdl = (id, title, content, target, targetName) => {
                            return new bsts_1.b.modal.container({
                                id: id,
                                labelledby: `${id}Label`,
                                view: "center",
                            }, [
                                new bsts_1.b.modal.header({ close: true }, new bsts_1.b.modal.title({ id: `${id}Label` }, title)),
                                new bsts_1.b.modal.body(new bsts_1.h.p(content)),
                                new bsts_1.b.modal.footer([
                                    new bsts_1.b.button({ toggle: "modal", color: "primary", target: target }, `Open ${targetName}`),
                                ]),
                            ]);
                        };
                        return [
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return [
                            // Button trigger modal
                            new bsts_1.b.button({ color: "primary", toggle: "modal", target: "#noAnimationModal" }, "Launch no animation modal"),
                            // Modal
                            new bsts_1.b.modal.container({
                                id: "noAnimationModal",
                                ...
                                new bsts_1.b.modal.header({ close: true }, new bsts_1.b.modal.title({ id: "noAnimationModalLabel" }, "Modal title")),
                                new bsts_1.b.modal.body(new bsts_1.h.p("This modal has no animation.")),
                                new bsts_1.b.modal.footer([
                                    new bsts_1.b.button({ dismiss: "modal", color: "secondary" }, "Close"),
                                    new bsts_1.b.button({ color: "primary" }, "Save changes"),
                                ]),
            ...
            new e.section([
                ...
                new e.text("Be sure to add {{labelledby:'...'}}, referencing the {{b.modal.title({id:'...'})}}, to {{b.modal.container}}. Additionally, you may give a description of your modal dialog with {{describedby}} on {{b.modal.container}}. Note that you don’t need to add {{role:'dialog'}} since Bootstrap already add it via JavaScript."),
            ]),
            //----------------------
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return [
                            // Button trigger modal
                            new bsts_1.b.button({ color: "primary", toggle: "modal", target: "#youtubeModal" }, "Launch Youtube modal"),
                            // Modal
                            new bsts_1.b.modal.container({
                                id: "youtubeModal",
                                ...
                                on: {
                                    "shown.bs.modal": (event) => {
                                        const target = event.target;
                                        const iframe = target.querySelector(".modal-body iframe");
                                ...
                                new bsts_1.b.modal.header({ close: true }, new bsts_1.b.modal.title({ id: "youtubeModalLabel" }, "Modal title")),
                                new bsts_1.b.modal.body(new bsts_1.h.div({ ratio: "16x9" }, new bsts_1.h.iframe({
                                    src: "",
                                ...
                                new bsts_1.b.modal.footer([
                                    new bsts_1.b.button({ dismiss: "modal", color: "secondary" }, "Close"),
                                    new bsts_1.b.button({ color: "primary" }, "Okay"),
                                ]),
                            ]),
                        ];
                    },
                        ...
                        return [
                            ...
                            ...d.map((i) => {
                                return new bsts_1.b.modal.container({
                                    ...
                                    new bsts_1.b.modal.header({ close: true }, new bsts_1.b.modal.title({ id: `${i.weight}SizeModalLabel` }, `${i.label}`)),
                                    new bsts_1.b.modal.body("..."),
                                ]);
                            }),
                        ];
                        ...
                        return [
                            ...
                            ...d.map((i) => {
                                return new bsts_1.b.modal.container({
                                    ...
                                    new bsts_1.b.modal.header({ close: true }, new bsts_1.b.modal.title({ id: `${i.fullscreen !== true ? i.fullscreen : "xs"}FSModalLabel` }, `${i.label}`)),
                                    new bsts_1.b.modal.body("..."),
                                    new bsts_1.b.modal.footer(new bsts_1.b.button({ dismiss: "modal", color: "secondary" }, "Close")),
                                ]);
                            }),
                        ];
                    },
            ...
            new e.section([
                ...
                new e.alert({ color: "warning", callout: true }, "While both ways to dismiss a modal are supported, keep in mind that dismissing from outside a modal does not match the {{https://www.w3.org/WAI/ARIA/apg/patterns/dialogmodal/::ARIA Authoring Practices Guide dialog (modal) pattern}}. Do this at your own risk."),
            ]),
            //----------------------
            new e.section([
            ...
            new e.section([
                ...
                new e.code({
                    showConsole: true,
                    output: () => {
                        const modalBody = new bsts_1.b.modal.body({ id: "example-modal-body" }, new bsts_1.h.p("Woo-hoo, you're reading this text in a modal!"));
                        const modalContainer = new bsts_1.b.modal.container({
                            id: "example-modal",
                            ...
                            on: {
                                "show.bs.modal": () => {
                                    ...
                                    if (mdlBody) {
                                        bsts_1.core.replaceWith(mdlBody, modalBody);
                                    }
                                },
                            },
                        }, [
                            new bsts_1.b.modal.header({ close: true }, new bsts_1.b.modal.title({ id: "example-modal-label" }, "Modal title")),
                            modalBody,
                            new bsts_1.b.modal.footer([
                                new bsts_1.b.button({ dismiss: "modal", color: "secondary" }, "Close"),
                                new bsts_1.b.button({ color: "primary" }, "Save changes"),
                        ...
                        const initButton = new bsts_1.b.button({
                            color: "success",
                            on: {
                                click: (event) => {
                                    const mdl = bsts_1.b.modal.init("#example-modal");
                                    e.console(event.target, "b.modal.init", mdl ? mdl : "null", mdl ? "success" : "danger");
                                },
                            },
                        }, "init");
                        const getInstanceButton = new bsts_1.b.button({
                            color: "success",
                            on: {
                                click: (event) => {
                                    const mdl = bsts_1.b.modal.getInstance("#example-modal");
                                    e.console(event.target, "b.modal.getInstance", mdl ? mdl : "null", mdl ? "success" : "danger");
                                },
                            },
                        }, "getInstance");
                        const getOrCreateInstanceButton = new bsts_1.b.button({
                            color: "success",
                            on: {
                                click: (event) => {
                                    const mdl = bsts_1.b.modal.getOrCreateInstance("#example-modal");
                                    e.console(event.target, "b.modal.getOrCreateInstance", mdl ? mdl : "null", mdl ? "success" : "danger");
                                },
                            },
                        }, "getOrCreateInstance");
                        const showButton = new bsts_1.b.button({
                            on: {
                                click: (event) => {
                                    bsts_1.b.modal.show("#example-modal", event.target);
                                },
                            },
                        }, "show");
                        const hideButton = new bsts_1.b.button({
                            on: {
                                click: () => {
                                    bsts_1.b.modal.hide("#example-modal");
                                },
                            },
                        }, "hide");
                        const toggleButton = new bsts_1.b.button({
                            on: {
                                click: () => {
                                    bsts_1.b.modal.toggle("#example-modal");
                                },
                            },
                        }, "toggle");
                        const handleUpdateButton = new bsts_1.b.button({
                            on: {
                                click: () => {
                                    bsts_1.b.modal.handleUpdate("#example-modal");
                                },
                            },
                        }, "handleUpdate");
                        const changeContent = new bsts_1.b.button({
                            color: "warning",
                            on: {
                                click: () => {
                                    const mdlBody = document.getElementById("example-modal-body");
                                    if (mdlBody) {
                                        bsts_1.core.replaceWith(mdlBody, new bsts_1.b.modal.body({ id: "example-modal-body" }, [
                                            new bsts_1.h.p({ style: { height: "100vh" } }, "This is some placeholder content to show the scrolling behavior for modals. Bootstrap use repeated line breaks to demonstrate how content can exceed minimum inner height, thereby showing inner scrolling. When content becomes longer than the predefined max-height of modal, content will be cropped and scrollable within the modal."),
                                            new bsts_1.h.p("This content should appear at the bottom after you scroll."),
                                        ]));
                                    }
                        ...
                        const disposeButton = new bsts_1.b.button({
                            color: "danger",
                            on: {
                                click: () => {
                                    bsts_1.b.modal.dispose("#example-modal");
                                },
                            },
                        }, "dispose");
                        const buttonGroup = new bsts_1.b.btngroup({ vertical: true, weight: "sm" }, [
                            initButton,
                            getInstanceButton,
                        ...
                        const previewContainer = new bsts_1.h.div({
                            width: 100,
                            margin: 1,
                            marginEnd: 2,
                        ...
                        const controlContainer = new bsts_1.h.div({
                            marginStart: "auto",
                            padding: 1,
                            rounded: true,
                            bgColor: "body",
                        ...
                        const mainContainer = new bsts_1.h.div({ display: "flex" }, [previewContainer, controlContainer]);
            ...
            new e.section([
                ...
                new e.code({
                    ...
                    output: () => {
                        return [
                            // Button trigger modal
                            new bsts_1.b.button({ color: "primary", toggle: "modal", target: "#eventModal" }, "Show modal event"),
                            // Modal
                            new bsts_1.b.modal.container({
                                id: "eventModal",
                                ...
                                on: {
                                    "shown.bs.modal": (event) => {
                                        const evnt = event;
                                        e.console(evnt.target, "shown.bs.modal", `Target: {{b::${bsts_1.core.elemInfo(evnt.target)}}}{{br}}
												RelatedTarget: {{b::${bsts_1.core.elemInfo(evnt.relatedTarget)}}}`, "success");
                                    },
                                    "hidden.bs.modal": (event) => {
                                        const target = event.target;
                                        e.console(target, "hidden.bs.modal", `Target: {{b::${bsts_1.core.elemInfo(target)}}}`, "danger");
                                    },
                                    "hidePrevented.bs.modal": (event) => {
                                        const target = event.target;
                                        e.console(target, "hidePrevented.bs.modal", `Target: {{b::${bsts_1.core.elemInfo(target)}}}`, "warning");
                                    },
                                },
                            }, [
                                new bsts_1.b.modal.header({ close: true }, new bsts_1.b.modal.title({ id: "eventModalLabel" }, "Modal title")),
                                new bsts_1.b.modal.body("Try press {{k::Esc}} key"),
                                new bsts_1.b.modal.footer([
                                    new bsts_1.b.button({ dismiss: "modal", color: "secondary" }, "Close"),
                                    new bsts_1.b.button({ color: "primary" }, "Okay"),
                                ]),
