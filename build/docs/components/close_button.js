    ...
    item: () => {
        return [
            new e.section([
                ...
                new e.text("Provide an option to dismiss or close a component with {{b.btnclose}}. Default styling is limited, but highly customizable. Modify the Sass variables to replace the default {{background-image}}. {{b::Be sure to include text for screen readers}}, as {{bsts}} done with {{label}}."),
                new e.code({
                    output: () => {
                        return new bsts_1.b.btnclose();
                    },
                }),
            ]),
            //----------------------
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.btnclose({ disabled: true });
                    },
                }),
            ]),
            //----------------------
            new e.section([
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.h.div({ theme: "dark" }, [new bsts_1.b.btnclose(), new bsts_1.b.btnclose({ disabled: true })]);
                    },
                }),
            ]),
            //----------------------
