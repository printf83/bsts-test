        ...
        return [
            ...
            new e.section([
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.h.div({ container: true, paddingX: 4, textAlign: "center" }, new bsts_1.h.div({ row: true, gutterX: 5 }, [
                            new bsts_1.h.div({ col: true }, new bsts_1.h.div({ padding: 3 }, "Custom column padding")),
                            new bsts_1.h.div({ col: true }, new bsts_1.h.div({ padding: 3 }, "Custom column padding")),
                        ]));
                    },
                }),
                ...
                new e.code({
                    outputAttr: { class: "p-box" },
                    output: () => {
                        return new bsts_1.h.div({ container: true, overflow: "hidden", textAlign: "center" }, new bsts_1.h.div({ row: true, gutterX: 5 }, [
                            new bsts_1.h.div({ col: true }, new bsts_1.h.div({ padding: 3 }, "Custom column padding")),
                            new bsts_1.h.div({ col: true }, new bsts_1.h.div({ padding: 3 }, "Custom column padding")),
                        ]));
                    },
            ...
            new e.section([
                ...
                new e.text("{{.gy-*}} classes can be used to control the vertical gutter widths within a row when columns wrap to new lines. Like the horizontal gutters, the vertical gutters can cause some overflow below the {{.row}} at the end of a page. If this occurs, you add a wrapper around {{.row}} with the {{.overflow-hidden}} class:"),
                new e.code({
                    outputAttr: { class: "p-box" },
                    output: () => {
                        return new bsts_1.h.div({ container: true, overflow: "hidden", textAlign: "center" }, new bsts_1.h.div({ row: true, gutterY: 5 }, [
                            new bsts_1.h.div({ col: 6 }, new bsts_1.h.div({ padding: 3 }, "Custom column padding")),
                            new bsts_1.h.div({ col: 6 }, new bsts_1.h.div({ padding: 3 }, "Custom column padding")),
                            new bsts_1.h.div({ col: 6 }, new bsts_1.h.div({ padding: 3 }, "Custom column padding")),
                            new bsts_1.h.div({ col: 6 }, new bsts_1.h.div({ padding: 3 }, "Custom column padding")),
                        ]));
            ...
            new e.section([
                ...
                new e.code({
                    outputAttr: { class: "p-box" },
                    output: () => {
                        return new bsts_1.h.div({ container: true, textAlign: "center" }, new bsts_1.h.div({ row: true, gutter: 2 }, [
                            new bsts_1.h.div({ col: 6 }, new bsts_1.h.div({ padding: 3 }, "Custom column padding")),
                            new bsts_1.h.div({ col: 6 }, new bsts_1.h.div({ padding: 3 }, "Custom column padding")),
                            new bsts_1.h.div({ col: 6 }, new bsts_1.h.div({ padding: 3 }, "Custom column padding")),
                            new bsts_1.h.div({ col: 6 }, new bsts_1.h.div({ padding: 3 }, "Custom column padding")),
            ...
            new e.section([
                ...
                new e.code({
                    ...
                    outputAttr: { class: "p-box" },
                    output: () => {
                        return new bsts_1.h.div({ container: true, textAlign: "center" }, new bsts_1.h.div({ row: true, gutter: [2, "lg-3"], rowCol: [2, "lg-5"] }, [
                            new bsts_1.h.div({ col: 6 }, new bsts_1.h.div({ padding: 3 }, "Row column")),
                            new bsts_1.h.div({ col: 6 }, new bsts_1.h.div({ padding: 3 }, "Row column")),
                            new bsts_1.h.div({ col: 6 }, new bsts_1.h.div({ padding: 3 }, "Row column")),
                            new bsts_1.h.div({ col: 6 }, new bsts_1.h.div({ padding: 3 }, "Row column")),
                            new bsts_1.h.div({ col: 6 }, new bsts_1.h.div({ padding: 3 }, "Row column")),
            ...
            new e.section([
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.h.div({ row: true, gutter: 0, textAlign: "center" }, [
                            new bsts_1.h.div({ col: ["sm-6", "md-8"] }, ".col-sm-6 .col-md-8"),
