...
exports.columns = {
    ...
    item: () => {
        return [
            new e.section([
                new e.alert({ color: "info", callout: true }, "{{b::Heads up! }}Be sure to {{nav:docs/layout/grid::read the Grid page}} first before diving into how to modify and customize your grid columns. "),
            ]),
            //----------------------
            new e.section([
            ...
            new e.section([
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.h.div({ container: true, textAlign: "center" }, new bsts_1.h.div({ row: true, alignItem: "start" }, [
                            new bsts_1.h.div({ col: true }, "One of three columns"),
                            new bsts_1.h.div({ col: true }, "One of three columns"),
                            new bsts_1.h.div({ col: true }, "One of three columns"),
                        ]));
                    },
                ...
                new e.code({
                    outputAttr: { class: ["col-box", "row-10"] },
                    output: () => {
                        return new bsts_1.h.div({ container: true, textAlign: "center" }, new bsts_1.h.div({ row: true, alignItem: "center" }, [
                            new bsts_1.h.div({ col: true }, "One of three columns"),
                            new bsts_1.h.div({ col: true }, "One of three columns"),
                            new bsts_1.h.div({ col: true }, "One of three columns"),
                        ]));
                ...
                new e.code({
                    outputAttr: { class: ["col-box", "row-10"] },
                    output: () => {
                        return new bsts_1.h.div({ container: true, textAlign: "center" }, new bsts_1.h.div({ row: true, alignItem: "end" }, [
                            new bsts_1.h.div({ col: true }, "One of three columns"),
                            new bsts_1.h.div({ col: true }, "One of three columns"),
                            new bsts_1.h.div({ col: true }, "One of three columns"),
                        ]));
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.h.div({ container: true, textAlign: "center" }, new bsts_1.h.div({ row: true }, [
                            new bsts_1.h.div({ col: true, alignSelf: "start" }, "One of three columns"),
                            new bsts_1.h.div({ col: true, alignSelf: "center" }, "One of three columns"),
                            new bsts_1.h.div({ col: true, alignSelf: "end" }, "One of three columns"),
                        ]));
                    },
                }),
            ]),
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.h.div({ container: true, textAlign: "center" }, [
                            new bsts_1.h.div({ row: true, justifyContent: "start" }, [
                                new bsts_1.h.div({ col: 4 }, "One of two columns"),
                                new bsts_1.h.div({ col: 4 }, "One of two columns"),
                            ]),
                            new bsts_1.h.div({ row: true, justifyContent: "center" }, [
                                new bsts_1.h.div({ col: 4 }, "One of two columns"),
                                new bsts_1.h.div({ col: 4 }, "One of two columns"),
                            ]),
                            new bsts_1.h.div({ row: true, justifyContent: "end" }, [
                                new bsts_1.h.div({ col: 4 }, "One of two columns"),
                                new bsts_1.h.div({ col: 4 }, "One of two columns"),
                            ]),
                            new bsts_1.h.div({ row: true, justifyContent: "around" }, [
                                new bsts_1.h.div({ col: 4 }, "One of two columns"),
                                new bsts_1.h.div({ col: 4 }, "One of two columns"),
                            ]),
                            new bsts_1.h.div({ row: true, justifyContent: "between" }, [
                                new bsts_1.h.div({ col: 4 }, "One of two columns"),
                                new bsts_1.h.div({ col: 4 }, "One of two columns"),
                            ]),
                            new bsts_1.h.div({ row: true, justifyContent: "evenly" }, [
                                new bsts_1.h.div({ col: 4 }, "One of two columns"),
                                new bsts_1.h.div({ col: 4 }, "One of two columns"),
                            ]),
                        ]);
            ...
            new e.section([
                ...
                new e.code({
                    outputAttr: { class: "col-box" },
                    output: () => {
                        return new bsts_1.h.div({ container: true }, new bsts_1.h.div({ row: true }, [
                            new bsts_1.h.div({ col: 9 }, ".col-9"),
                            new bsts_1.h.div({ col: 4 }, [
                                ".col-4",
                                new bsts_1.h.br(),
                                "Since 9 + 4 = 13 > 12, this 4-column-wide div gets wrapped onto a new line as one contiguous unit.",
                            ]),
                            new bsts_1.h.div({ col: 6 }, [
                                ".col-6",
                                new bsts_1.h.br(),
            ...
            new e.section([
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.h.div({ container: true, textAlign: "center" }, new bsts_1.h.div({ row: true }, [
                            new bsts_1.h.div({ col: [6, "sm-3"] }, ".col-6 .col-sm-3"),
                            new bsts_1.h.div({ col: [6, "sm-3"] }, ".col-6 .col-sm-3"),
                            //Force next columns to break to new line
                            new bsts_1.h.div({ width: 100 }),
                            new bsts_1.h.div({ col: [6, "sm-3"] }, ".col-6 .col-sm-3"),
                            new bsts_1.h.div({ col: [6, "sm-3"] }, ".col-6 .col-sm-3"),
                        ]));
                    },
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.h.div({ container: true, textAlign: "center" }, new bsts_1.h.div({ row: true }, [
                            new bsts_1.h.div({ col: [6, "sm-4"] }, ".col-6 .col-sm-4"),
                            new bsts_1.h.div({ col: [6, "sm-4"] }, ".col-6 .col-sm-4"),
                            //Force next columns to break to new line
                            new bsts_1.h.div({ width: 100, display: ["none", "md-block"] }),
                            new bsts_1.h.div({ col: [6, "sm-4"] }, ".col-6 .col-sm-4"),
                            new bsts_1.h.div({ col: [6, "sm-4"] }, ".col-6 .col-sm-4"),
                        ]));
                    },
            ...
            new e.section([
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.h.div({ container: true, textAlign: "center" }, new bsts_1.h.div({ row: true }, [
                            new bsts_1.h.div({ col: true, order: "last" }, "First in DOM, ordered last"),
                            new bsts_1.h.div({ col: true }, "Second in DOM, unordered"),
                            new bsts_1.h.div({ col: true, order: "first" }, "Third in DOM, ordered first"),
                        ]));
                    },
                }),
            ]),
            ...
            new e.section([
                ...
                new e.text("You can offset grid columns in two ways: Bootstrap responsive {{.offset-}} grid classes and Bootstrap {{nav:docs/utilities/spacing::margin utilities}}. Grid classes are sized to match columns while margins are more useful for quick layouts where the width of the offset is variable."),
            ]),
            //----------------------
            new e.section([
                    ...
                    output: () => {
                        return new bsts_1.h.div({ container: true, textAlign: "center" }, [
                            new bsts_1.h.div({ row: true }, [
                                new bsts_1.h.div({ col: "md-4" }, ".col-md-4"),
                                new bsts_1.h.div({ col: "md-4", offset: "md-4" }, ".col-md-4 .offset-md-4"),
                            ]),
                            new bsts_1.h.div({ row: true }, [
                                new bsts_1.h.div({ col: "md-3", offset: "md-3" }, ".col-md-3 .offset-md-3"),
                                new bsts_1.h.div({ col: "md-3", offset: "md-3" }, ".col-md-3 .offset-md-3"),
                            ]),
                            new bsts_1.h.div({ row: true }, [
                                new bsts_1.h.div({ col: "md-6", offset: "md-3" }, ".col-md-6 .offset-md-3"),
                            ]),
                        ]);
                    },
                }),
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.h.div({ container: true, textAlign: "center" }, [
                            new bsts_1.h.div({ row: true }, [
                                new bsts_1.h.div({ col: ["sm-5", "md-6"] }, ".col-sm-5 .col-md-6"),
                                new bsts_1.h.div({ col: ["sm-5", "md-6"], offset: ["sm-2", "md-0"] }, ".col-sm-5 .offset-sm-2 .col-md-6 .offset-md-0"),
                            ]),
                            new bsts_1.h.div({ row: true }, [
                                new bsts_1.h.div({ col: ["sm-6", "md-5", "lg-6"] }, ".col-sm-6 .col-md-5 .col-lg-6"),
                                new bsts_1.h.div({ col: ["sm-6", "md-5", "lg-6"], offset: ["md-2", "lg-0"] }, ".col-sm-6 .col-md-5 .offset-md-2 .col-lg-6 .offset-lg-0"),
                            ]),
                        ]);
                    },
                }),
                ...
                new e.code({
                    ...
                    output: () => {
                        return new bsts_1.h.div({ container: true, textAlign: "center" }, [
                            new bsts_1.h.div({ row: true }, [
                                new bsts_1.h.div({ col: "md-4" }, ".col-md-4"),
                                new bsts_1.h.div({ col: "md-4", marginStart: "auto" }, ".col-md-4 .ms-auto"),
                            ]),
                            new bsts_1.h.div({ row: true }, [
                                new bsts_1.h.div({ col: "md-3", marginStart: "md-auto" }, ".col-md-3 .ms-md-auto"),
                                new bsts_1.h.div({ col: "md-3", marginStart: "md-auto" }, ".col-md-3 .ms-md-auto"),
                            ]),
                            new bsts_1.h.div({ row: true }, [
                                new bsts_1.h.div({ col: "auto", marginEnd: "auto" }, ".col-auto .me-auto"),
                                new bsts_1.h.div({ col: "auto" }, ".col-auto"),
                            ]),
                        ]);
                    },
                }),
            ...
            new e.section([
                ...
                new e.code({
                    ...
                    output: () => {
                        return [
                            new bsts_1.h.div({ col: 3, padding: 3, marginBottom: 2 }, ".col-3: width of 25%"),
                            new bsts_1.h.div({ col: "sm-9", padding: 3 }, ".col-sm-9: width of 75% above sm breakpoint"),
                        ];
                    },
                }),
                ...
                new e.code({
                    showViewport: true,
                    output: () => {
                        return new bsts_1.h.div({ clearfix: true }, [
                            new bsts_1.h.img({
                                col: "md-6",
                                float: "end",
                                marginBottom: 3,
                            ...
                            new bsts_1.h.p("A paragraph of placeholder text. Bootstrap're using it here to show the use of the clearfix class. Bootstrap're adding quite a few meaningless phrases here to demonstrate how the columns interact here with the floated image."),
                            new bsts_1.h.p("As you can see the paragraphs gracefully wrap around the floated image. Now imagine how this would look with some actual content in here, rather than just this boring placeholder text that goes on and on, but actually conveys no tangible information at. It simply takes up space and should not really be read."),
                            new bsts_1.h.p("And yet, here you are, still persevering in reading this placeholder text, hoping for some more insights, or some hidden easter egg of content. A joke, perhaps. Unfortunately, there's none of that here."),
                        ]);
                    },
                }),
            ]),
