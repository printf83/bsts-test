    ...
    item: () => {
        return [
            new e.section([
                ...
                new e.alert({ color: "info", callout: true }, "When icons are purely decorative, they should be hidden from assistive technologies using {{aria-hidden='true'}}, as Bootstrap done in Bootstrap examples. For icons that convey meaning, provide an appropriate text alternative by adding {{role='img'}} and an appropriate {{aria-label='...'}} to the SVGs."),
            ]),
            //----------------------
            new e.section([
                new e.title("Example"),
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.h.a({ href: "#", iconLink: true }, [
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.h.a({ href: "#", iconLink: "hover" }, [
                            "Icon link",
                            new bsts_1.s('<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"/></svg>'),
                        ]);
                    },
            ...
            new e.section([
                ...
                new e.text("Modify the styling of an icon link with Bootstrap link CSS variables, Sass variables, utilities, or custom styles."),
            ]),
            //----------------------
            new e.section([
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.button(new bsts_1.h.span({
                            iconLink: "hover",
                        }, [
                            "Icon link",
                            new bsts_1.s('<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"/></svg>'),
