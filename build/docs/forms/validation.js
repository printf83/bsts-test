...
exports.validation = {
    ...
    item: () => {
        return [
            new e.section([
                new e.alert({ color: "warning", callout: true }, "Bootstrap are aware that currently the client-side custom validation styles and tooltips are not accessible, since they are not exposed to assistive technologies. While Bootstrap work on a solution, Bootstrap’d recommend either using the server-side option or the default browser validation method."),
            ]),
            //----------------------
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.h.form({
                            ...
                            new bsts_1.h.div({ col: 12 }, new bsts_1.b.button({ type: "submit" }, "Submit form")),
                        ]);
                    },
                }),
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.h.form({
                            ...
                            bsts_1.b.form.floatinglabel.select({
                                container: { col: "md-3" },
                                label: "State",
                                required: true,
                                item: [
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.h.form({ class: "was-validated" }, [
                            ...
                            new bsts_1.h.div({ marginBottom: 3 }, new bsts_1.b.button({ type: "submit", disabled: true }, "Submit form")),
                        ]);
                    },
                }),
            ]),
            ...
            new e.section([
                ...
                new e.text("If your form layout allows it, you can swap the {{.{valid|invalid}-feedback}} classes for {{.{valid|invalid}-tooltip}} classes to display validation feedback in a styled tooltip. Be sure to have a parent with {{position: relative}} on it for tooltip positioning. In the example below, Bootstrap column classes have this already, but your project may require an alternative setup."),
                new e.code({
                    output: () => {
                        return new bsts_1.h.form({
                            row: true,
