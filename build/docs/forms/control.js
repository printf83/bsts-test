    ...
    item: () => {
        return [
                    ...
                    output: () => {
                        return [
                            new bsts_1.h.div({ marginBottom: 3 }, [
                                new bsts_1.b.label({ for: "exampleFormControlInput1", class: "form-label" }, "Email address"),
                                new bsts_1.b.input({
                                    type: "email",
                            ...
                            new bsts_1.h.div([
                                new bsts_1.b.label({ for: "exampleFormControlTextarea1", class: "form-label" }, "Example textarea"),
                                new bsts_1.b.textarea({ id: "exampleFormControlTextarea1" }),
                            ]),
                        ];
                    },
                }),
            ...
            new e.section([
                ...
                new e.alert({ color: "warning", callout: true }, "Form text should be explicitly associated with the form control it relates to using the {{aria-labelledby}} (for mandatory information such as data format) or {{aria-describedby}} (for complementary information) attribute. This will ensure that assistive technologies—such as screen readers—will announce this form text when the user focuses or enters the control."),
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.h.div([
                            new bsts_1.b.label({ for: "inputPassword5", class: "form-label" }, "Password"),
                            new bsts_1.b.input({ type: "password", id: "inputPassword5", describedby: "passwordHelpBlock" }),
                            new bsts_1.h.div({ id: "passwordHelpBlock", class: "form-text" }, "Your password must be 8-20 characters long, contain letters and numbers, and must not contain spaces, special characters, or emoji."),
                        ]);
                    },
                }),
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.h.div({ row: true, gutter: 3, alignItem: "center" }, [
                            new bsts_1.h.div({ col: "auto" }, new bsts_1.b.label({ for: "inputPassword6", class: "col-form-label" }, "Password")),
                            new bsts_1.h.div({ col: "auto" }, new bsts_1.b.input({
                                type: "password",
                                id: "inputPassword6",
                                describedby: "passwordHelpBlock",
                            })),
                            new bsts_1.h.div({ col: "auto" }, new bsts_1.h.span({ id: "passwordHelpInline", class: "form-text" }, " Must be 8-20 characters long. ")),
                        ]);
                    },
                }),
                new e.text("Using {{b.form.input}}"),
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.h.div({ row: true }, [
                            ...
                            new bsts_1.h.div({ col: "auto" }, new bsts_1.b.button({ type: "submit" }, "Confirm identity")),
                        ]);
                    },
                }),
            ]),
            ...
            new e.section([
                ...
                new e.text([new bsts_1.h.span({ class: "teal-700" }, "This teal-700")]),
                new e.code({
                    output: () => {
                        return bsts_1.b.form.input({
                            label: "Color picker",
            ...
            new e.section([
                ...
                new e.text("Datalists allow you to create a group of {{<option>}}s that can be accessed (and autocompleted) from within an {{<input>}}. These are similar to {{<select>}} elements, but come with more menu styling limitations and differences. While most browsers and operating systems include some support for {{<datalist>}} elements, their styling is inconsistent at best."),
