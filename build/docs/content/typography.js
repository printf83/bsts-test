    ...
    item: () => {
        return [
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return [1, 2, 3, 4, 5, 6].map((i) => new bsts_1.h.p({ h: i }, `h${i}. Bootstrap heading`));
                    },
                }),
            ]),
            //----------------------
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return [1, 2, 3, 4, 5, 6]
                            .map((i) => [
                            new bsts_1.h.h(1, { fontDisplay: i }, `Display ${i}`),
                            i < 6 ? new bsts_1.h.hr() : "",
                        ])
                            .flat();
                    },
            ...
            new e.section([
                ...
                new e.text("Change text alignment, transform, style, weight, line-height, decoration and color with Bootstrap {{nav:docs/utilities/text::text utilities}} and {{nav:docs/utilities/colors::color utilities}}."),
            ]),
            //----------------------
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return [
                            new bsts_1.h.p(new bsts_1.h.abbr({ title: "attribute" }, "attr")),
                            new bsts_1.h.p(new bsts_1.h.abbr({ title: "HyperText Markup Language", small: true }, "HTML")),
                        ];
                    },
                }),
            ]),
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.blockquote.container(new bsts_1.h.p("A well-known quote, contained in a blockquote element."));
                    },
                }),
            ]),
            //----------------------
            new e.section([
                ...
                new e.text("The HTML spec requires that blockquote attribution be placed outside the {{<blockquote>}}. When providing attribution, wrap your {{<blockquote>}} in a {{<figure>}} and use a {{<figcaption>}} or a block level element (e.g., {{<p>}}) with the {{.blockquote-footer}} class. Be sure to wrap the name of the source work in {{<cite>}} as well."),
                new e.code({
                    output: () => {
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.h.ul({
                            unstyle: true,
                        }, [
                            new bsts_1.h.li("This is a list."),
                            new bsts_1.h.li("It appears completely unstyled."),
                            new bsts_1.h.li("Structurally, it's still a list."),
                            new bsts_1.h.li("However, this style only applies to immediate child elements."),
                            new bsts_1.h.li([
                                "Nested lists: ",
                                new bsts_1.h.ul([
                            ...
                            new bsts_1.h.li("This may still come in handy in some situations."),
                        ]);
                    },
                }),
            ]),
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.h.ul({ inline: true }, [
                            new bsts_1.h.li({ inline: true }, "This is a list item."),
                            new bsts_1.h.li({ inline: true }, "And another one."),
                            new bsts_1.h.li({ inline: true }, "But they're displayed inline."),
                        ]);
                    },
                }),
            ]),
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.h.dl({ row: true }, [
                            new bsts_1.h.dt({ col: "sm-3" }, "Description lists"),
                            new bsts_1.h.dd({ col: "sm-9" }, "A description list is perfect for defining terms."),
                            new bsts_1.h.dt({ col: "sm-3" }, "Term"),
                            new bsts_1.h.dd({ col: "sm-9" }, [
                                new bsts_1.h.p("Definition for the term."),
                                new bsts_1.h.p("And some more placeholder definition text."),
                            ]),
                            new bsts_1.h.dt({ col: "sm-3" }, "Another term"),
                            new bsts_1.h.dd({ col: "sm-9" }, "his definition is short, so no extra paragraphs or anything."),
                            new bsts_1.h.dt({ col: "sm-3", textTruncate: true }, "Truncated term is truncated"),
                            new bsts_1.h.dd({ col: "sm-9" }, "This can be useful when space is tight. Adds an ellipsis at the end."),
                            new bsts_1.h.dt({ col: "sm-3" }, "Nesting"),
                            new bsts_1.h.dd({ col: "sm-9" }, new bsts_1.h.dl({ row: true }, [
                                new bsts_1.h.dt({ col: "sm-4" }, "Nested definition list"),
                                new bsts_1.h.dd({ col: "sm-8" }, "I heard you like definition lists. Let me put a definition list inside your definition list."),
                            ])),
                        ]);
                    },
                }),
            ...
            new e.section([
                ...
                new e.text("There are no dedicated mixins for typography, but Bootstrap does use {{https://getbootstrap.com/docs/5.3/getting-started/rfs/::Responsive Font Sizing (RFS)}}."),
            ]),
        ];
    },
};
