    ...
    item: () => {
        return [
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return [10, 25, 50, 75, 100].map((i) => new bsts_1.h.p(new bsts_1.h.a({ href: "#", linkOpacity: i }, `Link opacity ${i}`)));
                    },
                }),
                new e.text("You can even change the opacity level on hover."),
                new e.code({
                    output: () => {
                        return [10, 25, 50, 75, 100].map((i) => new bsts_1.h.p(new bsts_1.h.a({ href: "#", linkOpacityHover: i }, `Link hover opacity ${i}`)));
                    },
                }),
            ]),
            //----------------------
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return ["primary", "secondary", "success", "danger", "warning", "info", "light", "dark"].map((i) => new bsts_1.h.p(new bsts_1.h.a({ href: "#", linkUnderlineColor: i }, `${bsts_1.core.uppercaseFirst(i)} underline`)));
                    },
                }),
            ]),
            //----------------------
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return [undefined, 1, 2, 3].map((i) => new bsts_1.h.p(new bsts_1.h.a({ href: "#", linkOffset: i }, i ? `Offset ${i} link` : "Default link")));
                    },
                }),
            ]),
            //----------------------
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return [0, 10, 25, 50, 75, 100].map((i) => new bsts_1.h.p(new bsts_1.h.a({
                            href: "#",
                            linkOffset: 2,
                            linkUnderline: true,
