        ...
        return [
            new e.section([
                ...
                new e.code({
                    ...
                    output: () => {
                        return [
                            new bsts_1.h.p({ textAlign: "start" }, "Start aligned text on all viewport sizes."),
                            new bsts_1.h.p({ textAlign: "center" }, "Center aligned text on all viewport sizes."),
                            new bsts_1.h.p({ textAlign: "end" }, "End aligned text on all viewport sizes."),
                            new bsts_1.h.p({ textAlign: "sm-end" }, "End aligned text on viewports sized SM (small) or wider."),
                            new bsts_1.h.p({ textAlign: "md-end" }, "End aligned text on viewports sized MD (medium) or wider."),
                            new bsts_1.h.p({ textAlign: "lg-end" }, "End aligned text on viewports sized LG (large) or wider."),
                            new bsts_1.h.p({ textAlign: "xl-end" }, "End aligned text on viewports sized XL (extra-large) or wider."),
                        ];
                    },
                }),
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.b.badge({ bgColor: "primary", textWrap: true, style: { width: "6rem" } }, "This text should wrap.");
                    },
                }),
                new e.text("Prevent text from wrapping with a {{.text-nowrap}} class."),
                new e.code({
                    output: () => {
                        return new bsts_1.h.div({ bgColor: "body-secondary", textWrap: false, style: { width: "8rem" } }, "This text should overflow the parent.");
                    },
                }),
            ]),
            //----------------------
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return [
                            new bsts_1.h.p({ textTransform: "lowercase" }, "Lowercased text."),
                            new bsts_1.h.p({ textTransform: "uppercase" }, "Uppercased text."),
                            new bsts_1.h.p({ textTransform: "capitalize" }, "CapiTaliZed text."),
                        ];
                    },
                }),
            ...
            new e.section([
                ...
                new e.text("Quickly change the {{font-size}} of text. While Bootstrap heading classes (e.g., {{.h1}}–{{.h6}}) apply {{font-size}}, {{font-weight}}, and {{line-height}}, these utilities only apply {{font-size}}. Sizing for these utilities matches HTML’s heading elements, so as the number increases, their size decreases."),
                new e.code({
                    output: () => {
                        return [1, 2, 3, 4, 5, 6].map((i) => new bsts_1.h.p({ fontSize: i }, `.fs-${i} text`));
                    },
                }),
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return [
                            new bsts_1.h.p({ fontWeight: "bold" }, "Bold text"),
                            new bsts_1.h.p({ fontWeight: "bolder" }, "Bolder weight text (relative to the parent element)."),
                            new bsts_1.h.p({ fontWeight: "semibold" }, "Semibold weight text."),
                            new bsts_1.h.p({ fontWeight: "medium" }, "Medium weight text."),
                            new bsts_1.h.p({ fontWeight: "normal" }, "Normal weight text."),
                            new bsts_1.h.p({ fontWeight: "light" }, "Light weight text."),
                            new bsts_1.h.p({ fontWeight: "lighter" }, "Lighter weight text (relative to the parent element)."),
                            new bsts_1.h.p({ fontItalic: true }, "Italic text."),
                            new bsts_1.h.p({ fontItalic: false }, "Text with normal font style"),
                        ];
                    },
                }),
            ]),
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        ...
                        return [
                            new bsts_1.h.p({ lineHeight: 1 }, text),
                            new bsts_1.h.p({ lineHeight: "sm" }, text),
                            new bsts_1.h.p({ lineHeight: "base" }, text),
                            new bsts_1.h.p({ lineHeight: "lg" }, text),
                        ];
                    },
                }),
            ]),
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.h.p({ monospace: true }, "This is in monospace");
                    },
                }),
            ]),
            //----------------------
                ...
                new e.code({
                    output: () => {
                        return new bsts_1.h.p({ textColor: "body-secondary" }, [
                            "Muted text with a ",
                            new bsts_1.h.a({ href: "#", textColor: "reset" }, "reset link"),
                            ".",
                        ]);
                    },
                }),
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return [
                            new bsts_1.h.p({ textDecoration: "underline" }, "This text has a line underneath it."),
                            new bsts_1.h.p({ textDecoration: "line-through" }, "This text has a line going through it."),
                            new bsts_1.h.a({ href: "#", textDecoration: "none" }, "This link has its text decoration removed"),
                        ];
                    },
                }),
            ]),
