    ...
    item: () => {
        return [
            ...
            new e.section([
                ...
                new e.alert({ color: "warning", callout: true }, "{{b::Deprecation:}} With the addition of the expanded theme colors and variables, the {{.text-muted}} utility has been deprecated as of v5.3.0. Its default value has also been reassigned to the new {{--bs-secondary-color}} CSS variable to better support color modes. It will be removed in v6.0.0."),
            ]),
            //----------------------
            new e.section([
                new e.title("Opacity"),
                new e.text("As of v5.1.0, {{text-color}} utilities are generated with Sass using CSS variables. This allows for real-time color changes without compilation and dynamic alpha transparency changes."),
            ]),
            //----------------------
            new e.section([
                ...
                new e.text("Bootstrap use an RGB version of Bootstrap {{--bs-primary}} (with the value of {{13}}, {{110}}, {{253}}) CSS variable and attached a second CSS variable, {{--bs-text-opacity}}, for the alpha transparency (with a default value {{1}} thanks to a local CSS variable). That means anytime you use {{.text-primary}} now, your computed {{color}} value is {{rgba(13, 110, 253, 1)}}. The local CSS variable inside each {{.text-*}} class avoids inheritance issues so nested instances of the utilities don’t automatically have a modified alpha transparency."),
            ]),
            //----------------------
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return [
                            new bsts_1.h.div({ textColor: "primary" }, "This is default primary text"),
                            new bsts_1.h.div({ textColor: "primary", style: { "--bs-text-opacity": ".5" } }, "This is 50% opacity primary text"),
                        ];
                    },
                }),
            ...
            new e.section([
                ...
                new e.text("Sometimes contextual classes cannot be applied due to the specificity of another selector. In some cases, a sufficient workaround is to wrap your element’s content in a {{<div>}} or more semantic element with the desired class."),
            ]),
            //----------------------
            new e.section([
                new e.title("CSS"),
                new e.text("In addition to the following Sass functionality, consider reading about Bootstrap included {{https://getbootstrap.com/docs/5.3/customize/css-variables/::CSS custom properties}} (aka CSS variables) for colors and more."),
            ]),
            //----------------------
            new e.section([
