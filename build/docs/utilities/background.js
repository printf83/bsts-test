...
exports.background = {
    ...
    item: () => {
        return [
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        ...
                        return data.map((i) => {
                            return new bsts_1.h.div({ padding: 3, marginBottom: 2, bgColor: i.bgColor, textColor: i.textColor }, `bgColor:'${i.bgColor}'`);
                        });
                    },
                }),
            ]),
            ...
            new e.section([
                new e.title("Opacity"),
                new e.text("As of v5.1.0, {{bgColor}} property are generated with Sass using CSS variables. This allows for real-time color changes without compilation and dynamic alpha transparency changes."),
            ]),
            //----------------------
            new e.section([
                ...
                new e.text("Bootstrap use an RGB version of Bootstrap {{--bs-success}} (with the value of {{25}}, {{135}}, {{84}}) CSS variable and attached a second CSS variable, {{--bs-bg-opacity}}, for the alpha transparency (with a default value 1 thanks to a local CSS variable). That means anytime you use {{.bg-success}} now, your computed {{color}} value is {{rgba(25, 135, 84, 1)}}. The local CSS variable inside each {{.bg-*}} class avoids inheritance issues so nested instances of the utilities don’t automatically have a modified alpha transparency."),
            ]),
            //----------------------
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return [
                            new bsts_1.h.div({ bgColor: "success", textColor: "white", padding: 2 }, "This is default success background"),
                            new bsts_1.h.div({
                                bgColor: "success",
                                textColor: "white",
                                padding: 2,
