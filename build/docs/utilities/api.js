    ...
    item: () => {
        return [
            ...
            new e.section([
                ...
                new e.text("The required {{property}} key must be set for any utility, and it must contain a valid CSS property. This property is used in the generated utility’s ruleset. When the {{class}} key is omitted, it also serves as the default class name. Consider the {{text-decoration}} utility:"),
                new e.codepreview({
                    type: "css",
                    code: `
						$utilities: (
            ...
            new e.section([
                ...
                new e.text("Use the {{local-vars}} option to specify a Sass map that will generate local CSS variables within the utility class’s ruleset. Please note that it may require additional work to consume those local CSS variables in the generated CSS rules. For example, consider Bootstrap {{.bg-*}} utilities:"),
                new e.codepreview({
                    type: "css",
                    code: `
						$utilities: (
            ...
            new e.section([
                ...
                new e.text("Use the {{state}} option to generate pseudo-class variations. Example pseudo-classes are {{:hover}} and {{:focus}}. When a list of states are provided, classnames are created for that pseudo-class. For example, to change opacity on hover, add {{state: hover}} and you’ll get {{.opacity-hover:hover}} in your compiled CSS."),
            ...
            new e.section([
                ...
                new e.text("Now that you’re familiar with how the utilities API works, learn how to add your own custom classes and modify Bootstrap default utilities."),
            ]),
            //----------------------
            new e.section([
            ...
            new e.section([
                ...
                new e.text("New utilities can be added to the default {{$utilities}} map with a {{map-merge}}. Make sure Bootstrap required Sass files and {{_utilities.scss}} are imported first, then use the {{map-merge}} to add your additional utilities. For example, here’s how to add a responsive {{cursor}} utility with three values."),
                new e.codepreview({
                    type: "css",
                    code: `
            ...
            new e.section([
                ...
                new e.text("Modify existing utilities in the default {{$utilities}} map with {{map-get}} and {{map-merge}} functions. In the example below, Bootstrap’re adding an additional value to the {{width}} utilities. Start with an initial {{map-merge}} and then specify which utility you want to modify. From there, fetch the nested {{'width'}} map with {{map-get}} to access and modify the utility’s options and values."),
                new e.codepreview({
                    type: "css",
                    code: `
						@import "bootstrap/scss/functions";
