...
exports.borders = {
    ...
    item: () => {
        return [
            new e.section([
                new e.title("Border"),
                new e.text("Use border utilities to add or remove an element’s borders. Choose from all borders or one at a time."),
            ]),
            //----------------------
            new e.section([
            ...
            new e.section([
                new e.title("Opacity"),
                new e.text("Bootstrap {{border-{color} }}utilities are generated with Sass using CSS variables. This allows for real-time color changes without compilation and dynamic alpha transparency changes."),
            ]),
            //----------------------
            new e.section([
            ...
            new e.section([
                ...
                new e.code({
                    output: () => {
                        return [
                            new bsts_1.h.div({ border: true, borderColor: "success", padding: 2, marginBottom: 2 }, "This is default success border"),
                            new bsts_1.h.div({
                                border: true,
                                borderColor: "success",
                                padding: 2,
