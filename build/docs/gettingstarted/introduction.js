        ...
        return [
            new e.section([
                new e.alert({ color: "warning", callout: true }, [
                    new bsts_1.b.alert.header(3, "Disclaimer"),
            ...
            new e.section([
                ...
                new e.item({ display: "flex", gap: 3, justifyContent: "center" }, [
                    new bsts_1.b.tooltip({ content: "@printf83/bsts" }, new bsts_1.h.a({ href: "https://github.com/printf83/bsts", target: "_blank" }, new bsts_1.b.pill({ icon: "github", color: "danger", weight: "lg" }, "v0.2.0"))),
                ]),
                ...
                new e.item({ display: "flex", flex: ["wrap", "md-row"], gap: 3, justifyContent: "center" }, [
                    new bsts_1.b.tooltip({ content: "Bootstrap" }, new bsts_1.h.a({ href: "https://getbootstrap.com/", target: "_blank" }, new bsts_1.b.pill({ icon: "bootstrap", color: "primary" }, "v5.3"))),
                    new bsts_1.b.tooltip({ content: "Bootstrap Icon" }, new bsts_1.h.a({ href: "https://icons.getbootstrap.com/", target: "_blank" }, new bsts_1.b.pill({ icon: "bootstrap", color: "warning" }, "v1.10"))),
                    new bsts_1.b.tooltip({ content: "Bootswatch" }, new bsts_1.h.a({ href: "https://bootswatch.com/", target: "_blank" }, new bsts_1.b.pill({ icon: "palette2", color: "success" }, "v5.3"))),
                    // new b.tooltip(
                    // 	{ content: "FontAwesome" },
                    // 	new h.a(
                        ...
                        on: {
                            click: () => {
                                e.codePen({
                                    ...
                                    head: e.codeBeautify("html", `<meta charset="utf-8">
											<meta name="viewport" content="width=device-width, initial-scale=1">`),
                                    html: e.codeBeautify("html", `<div id="root"></div>`),
                                    js: e.codeBeautify("js", `
            ...
            new e.section([
                ...
                new e.item(new bsts_1.h.details([
                    new bsts_1.h.summary({ textColor: "primary" }, "Components requiring JavaScript"),
            ...
            new e.section([
                ...
                new e.text("Bootstrap employs a handful of important global styles and settings, all of which are almost exclusively geared towards the normalization of cross browser styles. Let’s dive in."),
            ]),
            //----------------------
            new e.section([
            ...
            new e.section([
                ...
                new e.text("Bootstrap is developed {{i::mobile first}}, a strategy in which Bootstrap optimize code for mobile devices first and then scale up components as necessary using CSS media queries. To ensure proper rendering and touch zooming for all devices, add the responsive viewport meta tag to your {{<head>}}."),
                new e.codepreview({
                    type: "html",
                    code: `
						<meta name="viewport" content="width=device-width, initial-scale=1">
            ...
            new e.section([
                ...
                new e.text("For improved cross-browser rendering, Bootstrap use {{nav:docs/content/reboot::Reboot}} to correct inconsistencies across browsers and devices while providing slightly more opinionated resets to common HTML elements."),
            ]),
            //----------------------
            new e.section([
