...
export const Alert = (AttrOrElem?: b.alert.IBsAlertContainer | core.IElem, Elem?: core.IElem) =>
	core.genTagClass<alert, b.alert.IBsAlertContainer>(alert, AttrOrElem, Elem);
