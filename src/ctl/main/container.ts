					...
					new h.div({ col: "lg-3", marginBottom: 3 }, [
						...
						new h.ul({ unstyle: true, class: "small" }, [
							new h.li({ marginBottom: 2 }, [
								...
								"This is {{s::not a real Bootstrap}} website. This is only a {{s::Bootstrap TS test website}} to test Bootstrap {{https://github.com/printf83/bsts::@printf83/bsts}} library and make sure it's fully support Bootstrap. ",
