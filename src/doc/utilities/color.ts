...
export const color: IAttrContent = {
	...
	item: [
		...
		new e.text("Consider our default {{.text-primary}} utility."),
		new e.codepreview({
			type: "css",
			code: `
				.text-primary {
		...
		new e.text(
			"Color utilities are declared in our utilities API in {{scss/_utilities.scss}}. {{https://getbootstrap.com/docs/5.3/utilities/api/#using-the-api::Learn how to use the utilities API}}."
		),
		new e.codepreview({
			type: "css",
