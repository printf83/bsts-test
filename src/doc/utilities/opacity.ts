...
export const opacity: IAttrContent = {
	...
	item: [
		...
		new e.text(
			"Opacity utilities are declared in our utilities API in {{scss/_utilities.scss}}. {{https://getbootstrap.com/docs/5.3/utilities/api/#using-the-api::Learn how to use the utilities API}}."
		),
		new e.codepreview({
			type: "css",
