	...
	item: [
		...
		new e.ul({
			item: [
				...
				"Similarly, some source {{nav:doc/component/offcanvas#sass_variables::Sass variables}} for offcanvas’s styles and dimensions are inherited from the modal’s variables.",
