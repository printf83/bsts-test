...
export const doc_component_list: IAttrContent = {
	...
	item: [
		...
		new e.alert(
			...
			"{{b::Heads up!}} As of v5.3.0, the {{list-group-item-variant()}} Sass mixin is deprecated. List group item variants now have their CSS variables overridden in {{nav:doc_component_list#sass_loop::the Sass loop}}."
		),
