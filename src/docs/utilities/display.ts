	...
	item: (db?: e.IBsExampleData[]) => {
		...
		return [
			...
			new e.section([
				...
				new e.ul({
					item: ["{{display:'{value}' }}for {{xs}}", "{{display:'{breakpoint}-{value}' }}for {{sm}}, {{md}}, {{lg}}, {{xl}}, and {{xxl}}."],
				}),
				new e.text("Where {{i::value}} is one of:"),
				new e.ul({
					item: ["{{none}}", "{{inline}}", "{{inline-block}}", "{{block}}", "{{grid}}", "{{inline-grid}}", "{{table}}", "{{table-cell}}", "{{table-row}}", "{{flex}}", "{{inline-flex}}"],
				}),
			...
			new e.section([
				...
				new e.ul({
					item: ["{{print:'none'}}", "{{print:'inline'}}", "{{print:'inline-block'}}", "{{print:'block'}}", "{{print:'grid'}}", "{{print:'inline-grid'}}", "{{print:'table'}}", "{{print:'table-row'}}", "{{print:'table-cell'}}", "{{print:'flex'}}", "{{print:'inline-flex'}}"],
				}),
...
return [new h.div({
display: "lg-none"
}, "hide on lg and wider screens"), new h.div({
...
return [new h.div({
print: "none"
}, "Screen Only (Hide on print only)"), new h.div({
display: "none",
print: "block"
}, "Print Only (Hide on screen only)"), new h.div({
display: ["none", "lg-block"],
print: "block"
