			...
			new e.section([
				...
				new e.code({
					...
					output: () => {
						return [
							new h.div(
								{ display: "inline", padding: 2, textBgColor: "primary" },
								"d-inline"
							),
							new h.div(
								{ display: "inline", padding: 2, textBgColor: "dark" },
								"d-inline"
							),
						];
					},
				...
				new e.code({
					...
					output: () => {
						return [
							new h.div(
								{ display: "block", padding: 2, textBgColor: "primary" },
								"d-block"
							),
							new h.div(
								{ display: "block", padding: 2, textBgColor: "dark" },
								"d-block"
							),
						];
					},
