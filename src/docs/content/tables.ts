	...
	db: [
		{
			source: `() => {
return new b.table.container([
new b.table.thead(new b.table.tr([new b.table.th({
scope: "col"
}, "#"), new b.table.th({
scope: "col"
}, "First"), new b.table.th({
scope: "col"
}, "Last"), new b.table.th({
scope: "col"
}, "Handle")])),
new b.table.tbody([
new b.table.tr([new b.table.th({
scope: "row"
}, "1"), new b.table.td("Mark"), new b.table.td("Otto"), new b.table.td("@mdo")]),
new b.table.tr([new b.table.th({
scope: "row"
}, "2"), new b.table.td("Jacob"), new b.table.td("Thornton"), new b.table.td("@fat")]),
new b.table.tr([new b.table.th({
scope: "row"
}, "3"), new b.table.td({
colspan: 2
}, "Larry the Bird"), new b.table.td("@twitter")]),
]),
]);
}`,
		},
...
new b.table.thead(new b.table.tr([new b.table.th({
scope: "col"
}, "Class"), new b.table.th({
scope: "col"
}, "Heading"), new b.table.th({
scope: "col"
}, "Heading")])),
new b.table.tbody([undefined, "primary", "secondary", "success", "danger", "warning", "info", "light", "dark"].map((i) => new b.table.tr({
color: i
}, [new b.table.th({
scope: "row"
}, i ? core.uppercaseFirst(i) : "Default"), new b.table.td("Cell"), new b.table.td("Cell")]))),
]);
}`,
		},
		{
...
colspan: 2
		...
		{
			source: `() => {
return new b.table.responsive(new b.table.container({
verticalAlign: "middle"
}, [
new b.table.thead(new b.table.tr([new b.table.th({
scope: "col",
width: 25
}, "Heading 1"), new b.table.th({
scope: "col",
width: 25
}, "Heading 2"), new b.table.th({
scope: "col",
width: 25
}, "Heading 3"), new b.table.th({
scope: "col",
width: 25
}, "Heading 4")])),
new b.table.tbody([
...
new b.table.thead(new b.table.tr([new b.table.th({
scope: "col"
}, "Header"), new b.table.th({
scope: "col"
}, "Header"), new b.table.th({
scope: "col"
}, "Header")])),
new b.table.tbody(["A", "B", "C"].map((i) => new b.table.tr([new b.table.th({
scope: "row"
}, i), new b.table.td("First"), new b.table.td("Last")]))),
]))),
new b.table.tr([new b.table.th({
scope: "row"
}, "3"), new b.table.td("Larry"), new b.table.td("the Bird"), new b.table.td("@twitter")]),
]),
]);
}`,
		},
		{
			source: `() => {
return new b.table.container([new b.table.thead({
color: "light"
}, TABLEHEAD()), new b.table.tbody(TABLEBODY())]);
}`,

			extention: [
				`() => {
return new b.table.tr([new b.table.th({
scope: "col"
}, "#"), new b.table.th({
scope: "col"
}, "First"), new b.table.th({
...
return new b.table.container([new b.table.thead({
color: "light"
}, TABLEHEAD()), new b.table.tbody(TABLEBODY()), new b.table.tfoot(new b.table.tr([new b.table.td("Footer"), new b.table.td("Footer"), new b.table.td("Footer"), new b.table.td("Footer")]))]);
}`,
...
return new b.table.container({
small: true
}, [new h.caption("List of user"), new b.table.thead(TABLEHEAD()), new b.table.tbody(TABLEBODY())]);
}`,
...
return new b.table.responsive(new b.table.container(TABLEBIG(3, 9)));
			...
			extention: [
				`(row, col) => {
return [
new b.table.thead(new b.table.tr(Array(col).fill("").map((_i, ix) => new b.table.th({
scope: "col"
}, ix === 0 ? "#" : \`Head#\${ix + 1}\`)))),
new b.table.tbody(Array(row).fill("").map((_i, ix) => new b.table.tr(Array(col).fill("").map((_j, jx) => (jx === 0 ? new b.table.th({
scope: "row"
}, (ix + 1).toString()) : new b.table.td(\`Cell#\${jx + 1}\`)))))),
];
}`,
			],
		},
...
return new b.table.responsive(new b.table.container({
captionLocation: "top"
}, [new h.caption(".table-responsive"), ...TABLEBIG(3, 12)]));
}`,
...
captionLocation: "top"
}, [new h.caption(".table-responsive-sm"), ...TABLEBIG(3, 12)]));
}`,
...
captionLocation: "top"
}, [new h.caption(".table-responsive-md"), ...TABLEBIG(3, 12)]));
}`,
...
captionLocation: "top"
}, [new h.caption(".table-responsive-lg"), ...TABLEBIG(3, 12)]));
}`,
...
captionLocation: "top"
}, [new h.caption(".table-responsive-xxl"), ...TABLEBIG(3, 12)]));
}`,
