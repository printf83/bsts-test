...
return [
new h.ul({
item: ["All lists have their top margin removed", "And their bottom margin normalized",
new h.div(["Nested lists have no bottom margin",
new h.ul({
item: ["This way they have a more even appearance", "Particularly when followed by more list items"],
}),
]), "The left padding has also been reset",
...
new h.p([new h.label({
for: "input"
}, "Example input"), " ", new h.input({
id: "input",
placeholder: "Example input"
})]),
new h.p([new h.label({
for: "email"
}, "Example email"), " ", new h.input({
id: "email",
type: "email",
...
new h.p([new h.label({
for: "tel"
}, "Example telephone"), " ", new h.input({
id: "tel",
type: "tel"
})]),
new h.p([new h.label({
for: "url"
}, "Example url"), " ", new h.input({
id: "url",
type: "url"
})]),
new h.p([new h.label({
for: "number"
}, "Example number"), " ", new h.input({
id: "number",
type: "number"
})]),
new h.p([new h.label({
for: "search"
}, "Example search"), " ", new h.input({
id: "search",
type: "search"
})]),
new h.p([new h.label({
for: "range"
}, "Example range"), " ", new h.input({
id: "range",
type: "range",
min: 0,
max: 10
...
new h.p([new h.label({
for: "file"
}, "Example file input"), " ", new h.input({
id: "file",
type: "file"
})]),
new h.p([
...
new h.p(new h.label([new h.input({
type: "checkbox",
value: ""
}), "Check this checkbox"])),
new h.p([
...
new h.p([new h.label({
for: "textarea"
}, "Example textarea"), " ", new h.textarea({
id: "textarea",
rows: 3
})]),
new h.p([new h.label({
for: "date"
}, "Example date"), " ", new h.input({
id: "date",
type: "date"
})]),
new h.p([new h.label({
for: "time"
}, "Example time"), " ", new h.input({
id: "time",
type: "time"
})]),
new h.p([new h.label({
for: "datetime-local"
}, "Example datetime-local"), " ", new h.input({
id: "datetime-local",
type: "datetime-local"
})]),
new h.p([new h.label({
for: "week"
}, "Example week"), " ", new h.input({
id: "week",
type: "week"
})]),
new h.p([new h.label({
for: "month"
}, "Example month"), " ", new h.input({
id: "month",
type: "month"
})]),
new h.p([new h.label({
for: "color"
}, "Example color"), " ", new h.input({
id: "color",
type: "color"
})]),
new h.p([new h.label({
for: "output"
}, "Example output"), " ", new h.output({
id: "output",
name: "result"
}, "100")]),
new h.p([new h.button({
type: "submit"
}, "Button sumbit"), " ", new h.input({
type: "submit",
...
tabindex: "0"
		...
		},
		{
			source: `() => {
return [
new h.address([new h.strong("ACME Corporation"), new h.br(), "1123 Fictional St,", new h.br(), "San Francisco, CA 94103", new h.br(), new h.abbr({
title: "Phone"
}, "P:"), "(123) 456-7890 "]),
new h.address([new h.strong("Full Name"), new h.br(), new h.a({
href: "mailto:first.last@example.com"
		...
		{
			source: `() => {
return [new b.blockquote.container(new h.p("A well-known quote, contained in a blockquote element.")), new h.p(["Someone famous in", new h.cite({
title: "Source Title"
}, "Source Title")])];
}`,
		},
