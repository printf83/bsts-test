...
return [
new h.div({ display: "flex", gap: 2 }, [
new b.collapse.button({ href: "#collapseExample", controlfor: "collapseExample" }, "Link with href"),
new b.collapse.button({ target: "#collapseExample", controlfor: "collapseExample" }, "Button with data-bs-target"),
]),
...
const rowDiv = new h.div({ padding: 0 }, new h.div({ row: true, gutter: 2 }, [
new h.div({ col: 6 }, collapse1),
new h.div({ col: 6 }, collapse2),
]));
return [toggle1, toggle2, toggleBoth, rowDiv];
