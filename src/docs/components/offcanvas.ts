...
id: "offcanvasLabel"
}, "Offcanvas"), new b.offcanvas.btnclose()]), new b.offcanvas.body("Content for the offcanvas goes here. You can place just about any Bootstrap component or custom elements here.")]);
}`,
		},
		{
			source: `() => {
...
}, "Offcanvas with body scrolling"), new b.offcanvas.btnclose()]), new b.offcanvas.body(new h.p("Try scrolling the rest of the page to see this option in action."))]),
];
}`,
		},
		{
...
}, "Backdrop with scrolling"), new b.offcanvas.btnclose()]), new b.offcanvas.body(new h.p("Try scrolling the rest of the page to see this option in action."))]),
];
}`,
		},
		{
...
}, "Offcanvas"), new b.offcanvas.btnclose()]), new b.offcanvas.body(new h.div("I will not close if you click outside of me."))]),
];
}`,
		},
		{
...
}, "Offcanvas"), new b.offcanvas.btnclose()]), new b.offcanvas.body("Place offcanvas content here.")]);
}`,
		},
		{
			source: `() => {
...
}, "Responsive offcanvas"), new b.offcanvas.btnclose({
target: "#offcanvasResponsive"
})]), new b.offcanvas.body(new h.p({
marginBottom: 0
...
}, "Offcanvas top"), new b.offcanvas.btnclose()]), new b.offcanvas.body("...")]),
];
}`,
		},
		{
...
}, "Offcanvas end"), new b.offcanvas.btnclose()]), new b.offcanvas.body("...")]),
];
}`,
		},
		{
...
}, "Offcanvas bottom"), new b.offcanvas.btnclose()]), new b.offcanvas.body("...")]),
];
}`,
		},
		{
...
vertical: true,
weight: "sm"
}, [initButton, getInstanceButton, getOrCreateInstanceButton, showButton, hideButton, toggleButton, disposeButton]);
const previewContainer = new h.div({
width: 100,
marginEnd: 3,
bgColor: "body-tertiary",
