		...
		return [
			new e.section([
				...
				new e.alert({ color: "warning", callout: true }, [
					...
					new h.p("In order for assistive technologies (such as screen readers) to convey that a series of buttons is grouped, an appropriate {{role}} attribute needs to be provided. For button groups, this would be {{role:'group'}}, while toolbars should have a {{role:'toolbar'}}."),
					new h.p(
...
role: "group"
		...
		{
			source: `() => {
return new b.btngroup([new b.button({
href: "#",
active: true
}, "Left"), new b.button({
href: "#"
...
weight: "lg",
display: "block"
}, ["Left", "Middle", "Right"].map((i) => new b.button({
color: "primary",
outline: true
}, i))),
new b.btngroup({
