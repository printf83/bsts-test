...
}, "Third"), new b.dropdown.item({
href: "#scrollspyHeading4"
}, "Fourth"), new b.dropdown.divider(), new b.dropdown.item({
...
let contentItems = [];
["First", "Second", "Third", "Forth", "Fifth"].forEach((i, ix) => {
contentItems.push(new h.h(4, {
id: \`scrollspyHeading\${ix + 1}\`
}, \`\${i} heading\`));
...
href: "#"
}, "Navbar"), new b.nav.header.container({
type: "pill"
}, headerItems)]),
new b.scrollspy({
target: "#navbar-example",
...
marginStart: 3,
marginY: 1
}, "Item 1-1"), new b.nav.header.link({
href: "#item-1-2",
marginStart: 3,
marginY: 1
}, "Item 1-2")]),
...
marginStart: 3,
marginY: 1
}, "Item 3-1"), new b.nav.header.link({
href: "#item-3-2",
marginStart: 3,
marginY: 1
}, "Item 3-2")]),
