...
return new b.list.container([new b.list.item("An item"), new b.list.item("A second item"), new b.list.item("A third item"), new b.list.item("A fourth item"), new b.list.item("And a fifth one")]);
		...
		{
			source: `() => {
return new b.list.container([new b.list.item({
active: true
}, "An active item"), new b.list.item("A second item"), new b.list.item("A third item"), new b.list.item("A fourth item"), new b.list.item("And a fifth one")]);
}`,
		},
		{
			source: `() => {
return new b.list.container([new b.list.item({
disabled: true
}, "A disabled item"), new b.list.item("A second item"), new b.list.item("A third item"), new b.list.item("A fourth item"), new b.list.item("And a fifth one")]);
}`,
		},
		{
			source: `() => {
...
return new b.list.container({
flush: true
}, [new b.list.item("An item"), new b.list.item("A second item"), new b.list.item("A third item"), new b.list.item("A fourth item"), new b.list.item("And a fifth one")]);
}`,
		},
		{
			source: `() => {
return new b.list.container({
numbered: true
}, [new b.list.item("A list item"), new b.list.item("A list item"), new b.list.item("A list item")]);
}`,
		},
		{
			source: `() => {
...
horizontal: "xxl"
		...
		{
			source: `() => {
let items = [new b.list.item({
flex: "fill"
}, "An item"), new b.list.item({
flex: "fill"
}, "A second item"), new b.list.item({
flex: "fill"
}, "A third item")];
return [
new b.list.container({
...
return new b.list.item([new b.input({
type: "checkbox",
id: \`\${i}Checkbox\`,
marginEnd: 2
}), new b.label({
