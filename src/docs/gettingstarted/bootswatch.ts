...
let id = core.UUID();
return new b.navbar.innercontainer({
container: "fluid"
}, [
new b.navbar.brand({
href: "#"
...
new b.navbar.item(new b.navbar.link({
href: "#",
active: true
}, "Home")),
new b.navbar.item(new b.navbar.link({
...
href: "#"
}, "Another action"), new b.dropdown.divider(), new b.dropdown.item({
href: "#"
}, "Something else here")]),
]),
]),
...
bgColor: "primary",
theme: "dark"
}, navbarItem("light")), new b.navbar.container({
bgColor: "dark",
theme: "dark"
}, navbarItem("light")), new b.navbar.container({
bgColor: "light",
...
return [new b.button({
weight: "lg"
}, "Large button"), new b.button("Default button"), new b.button({
weight: "sm"
}, "Small button")];
}`,
		},
...
label: "Basic example",
role: "group"
}, [new b.button("Left"), new b.button("Middle"), new b.button("Right")]);
}`,
		},
		{
			source: `() => {
...
label: "Second group",
marginEnd: 2
}, ["5", "6", "7"].map((i) => new b.button({
color: "secondary"
}, i))),
new b.btngroup({
label: "Third group"
}, ["8"].map((i) => new b.button({
color: "info"
}, i))),
]);
}`,
...
new b.button("Button"),
new b.button("Button"),
new b.btngroup([new b.dropdown.button({}, "Dropdown"), new b.dropdown.menu([new b.dropdown.item({
href: "#"
}, "Dropdown link 1"), new b.dropdown.item({
href: "#"
}, "Dropdown link 2")])]),
new b.button("Button"),
new b.button("Button"),
...
return [1, 2, 3, 4, 5, 6].map((i) => new h.h(i, \`h\${i}. Bootstrap heading\`));
		...
		{
			source: `() => {
return [1, 2, 3, 4, 5, 6].map((i) => new h.h(i, [\`h\${i}. Heading\`, new h.small({
textColor: "body-secondary"
...
textOpacity: i.textOpacity
		...
		{
			source: `() => {
return new h.figure([new b.blockquote.container(new h.p("A well-known quote, contained in a blockquote element.")), new b.blockquote.caption(["Someone famous in ", new h.cite({
title: "Source Title"
}, "Source Title")])]);
}`,
		},
...
return new h.figure({
textAlign: "center"
}, [new b.blockquote.container(new h.p("A well-known quote, contained in a blockquote element.")), new b.blockquote.caption(["Someone famous in ", new h.cite({
title: "Source Title"
}, "Source Title")])]);
}`,
		},
...
rounded: "pill"
		...
		{
			source: `() => {
return new b.list.container(["primary", "secondary", "success", "danger", "warning", "info", "light", "dark"].map((i) => {
return new b.list.item({
color: i,
display: "flex",
justifyContent: "between",
alignItem: "center",
}, [core.uppercaseFirst(i), new b.badge({
textBgColor: i,
rounded: "pill"
		...
		{
			source: `() => {
return new b.list.container(["An item", "A second item", "A third item", "A fourth item", "And a fifth one"].map((i, ix) => {
return new b.list.item({
action: true,
handleActive: true,
active: ix === 0
...
marginBottom: 1
}, "List group item heading"), new h.small({
...
id: "offcanvasExample",
labelledby: "offcanvasExampleLabel"
}, [
new b.offcanvas.header([new b.offcanvas.title({
id: "offcanvasExampleLabel"
}, "Offcanvas"), new b.offcanvas.btnclose()]),
new b.offcanvas.body([
new h.div("Some text as placeholder. In real life you can have the elements you have chosen. Like, text, images, lists, etc."),
