		...
		return [
					...
					output: () => {
						return [
							new h.div({ marginBottom: 3 }, [
								new b.label(
									{ for: "formGroupExampleInput", class: "form-label" },
									"Example label"
								),
								new b.input({
					...
					output: () => {
						return new h.form([
							...
							new h.fieldset({ row: true, marginBottom: 3 }, [
								new h.legend(
									{ class: "col-form-label", col: "sm-3", paddingTop: 0 },
									"Radios"
								),
								new h.div({ col: "sm-9" }, [
									b.form.check({
							...
							new h.div(
								{ row: true },
								b.form.check({
									container: { col: "sm-9", offset: "sm-3" },
			...
			new e.section([
				...
				new e.code({
					...
					output: () => {
						return new h.div(
							{ row: true, gutterY: 2, gutterX: 3, alignItem: "center" },
							[
								b.form.input({
									container: { col: "auto" },
									label: "Name",
			...
			new e.section([
				...
				new e.code({
					...
					output: () => {
						return new h.div(
							{ row: true, rowCol: "lg-auto", gutter: 3, alignItem: "center" },
							[
								b.form.input({
									container: { col: 12 },
									label: "Username",
...
new h.div({ row: true }, b.form.check({
container: { col: "sm-9", offset: "sm-3" },
label: "Example checkbox",
})),
new h.div({ col: 12 }, new b.button({ type: "submit" }, "Sign in")),
