	...
	item: (db?: e.IBsExampleData[]) => {
		...
		return [
			...
			new e.section([
				...
				new e.ul({
					item: ["Extra small (xs)", "Small (sm)", "Medium (md)", "Large (lg)", "Extra large (xl)", "Extra extra large (xxl)"],
				}),
					...
					[
						...
						new b.table.tbody([
							...
							new b.table.tr([
								...
								new b.table.td({ responsiveAttr: "bs-title-name", responsiveTitle: "Extra small" }, "{{.col-}}"),
								...
								new b.table.td({ responsiveAttr: "bs-title-name", responsiveTitle: "XX-Large" }, "{{.col-xxl-}}"),
							]),
							new b.table.tr([new b.table.th({ scope: "row" }, "# of columns"), new b.table.td({ colspan: 6, responsiveAttr: "bs-title-name", responsiveTitle: "All breakpoint" }, "12")]),
							new b.table.tr([new b.table.th({ scope: "row" }, "Gutter width"), new b.table.td({ colspan: 6, responsiveAttr: "bs-title-name", responsiveTitle: "All breakpoint" }, "1.5rem (.75rem on left and right)")]),
							new b.table.tr([new b.table.th({ scope: "row" }, "Custom gutters"), new b.table.td({ colspan: 6, responsiveAttr: "bs-title-name", responsiveTitle: "All breakpoint" }, "{{nav:docs/layout/gutters::Yes}}")]),
							new b.table.tr([new b.table.th({ scope: "row" }, "Nestable"), new b.table.td({ colspan: 6, responsiveAttr: "bs-title-name", responsiveTitle: "All breakpoint" }, "{{nav:docs/layout/grid#nesting::Yes}}")]),
							new b.table.tr([new b.table.th({ scope: "row" }, "Column ordering"), new b.table.td({ colspan: 6, responsiveAttr: "bs-title-name", responsiveTitle: "All breakpoint" }, "{{nav:docs/layout/columns#reordering::Yes}}")]),
						]),
					]
				),
			]),
			...
			new e.section([new e.title("Auto-layout columns"), new e.text("Utilize breakpoint-specific column classes for easy column sizing without an explicit numbered class like {{.col-sm-6}}.")]),
				...
				new e.code({
					...
					output: () => {
						return new h.div({ container: true, textAlign: "center" }, [
							...
							new h.div({ row: true }, [new h.div({ col: true }, "1 of 3"), new h.div({ col: true }, "2 of 3"), new h.div({ col: true }, "3 of 3")]),
						]);
					},
				}),
			]),
			...
			new e.section([
				...
				new e.code({
					...
					output: () => {
						return new h.div({ container: true, textAlign: "center" }, [
							new h.div({ row: true }, [new h.div({ col: true }, "1 of 3"), new h.div({ col: 6 }, "2 of 3 (wider)"), new h.div({ col: true }, "2 of 3")]),
							new h.div({ row: true }, [new h.div({ col: true }, "1 of 3"), new h.div({ col: 5 }, "2 of 3 (wider)"), new h.div({ col: true }, "3 of 3")]),
						]);
					},
				}),
			]),
			...
			new e.section([
				...
				new e.code({
					...
					output: () => {
						return new h.div({ container: true, textAlign: "center" }, [
							new h.div({ row: true, justifyContent: "md-center" }, [new h.div({ col: [true, "lg-2"] }, "1 of 3"), new h.div({ col: "md-auto" }, "Variable width content"), new h.div({ col: [true, "lg-2"] }, "2 of 3")]),
							new h.div({ row: true }, [new h.div({ col: true }, "1 of 3"), new h.div({ col: "md-auto" }, "Variable witth content"), new h.div({ col: true }, "3 of 3")]),
						]);
					},
				}),
			]),
			...
			new e.section([new e.title("Responsive classes"), new e.text("Bootstrap’s grid includes six tiers of predefined classes for building complex responsive layouts. Customize the size of your columns on extra small, small, medium, large, or extra large devices however you see fit.")]),
			...
			new e.section([
				...
				new e.code({
					...
					output: () => {
						return new h.div({ container: true, textAlign: "center" }, [
							new h.div({ row: true }, [new h.div({ col: true }, "col"), new h.div({ col: true }, "col"), new h.div({ col: true }, "col"), new h.div({ col: true }, "col")]),
			...
			new e.section([
				...
				new e.code({
					...
					output: () => {
						return new h.div({ container: true, textAlign: "center" }, [
							new h.div({ row: true }, [new h.div({ col: "sm-8" }, "col-sm-8"), new h.div({ col: "sm-4" }, "col-sm-4")]),
							new h.div({ row: true }, [new h.div({ col: "sm" }, "col-sm"), new h.div({ col: "sm" }, "col-sm"), new h.div({ col: "sm" }, "col-sm")]),
						]);
					},
				}),
			]),
				...
				new e.code({
					...
					output: () => {
						return new h.div({ container: true, textAlign: "center" }, [
							...
							new h.div({ row: true }, [new h.div({ col: "md-8" }, ".col-md-8"), new h.div({ col: [6, "md-4"] }, ".col-6.col-md-4")]),
							//Columns start at 50% wide on mobile and bump up to 33.3% wide on desktop
							new h.div({ row: true }, [new h.div({ col: [6, "md-4"] }, ".col-6.col-md-4"), new h.div({ col: [6, "md-4"] }, ".col-6.col-md-4"), new h.div({ col: [6, "md-4"] }, ".col-6.col-md-4")]),
			...
			new e.section([
				...
				new e.code({
					...
					outputAttr: { class: "col-box" },
					output: () => {
						return new h.div({ container: true, textAlign: "center" }, new h.div({ row: true, rowCol: [1, "sm-2", "md-4"] }, [new h.div({ col: true }, "Column"), new h.div({ col: true }, "Column"), new h.div({ col: true }, "Column"), new h.div({ col: true }, "Column")]));
					},
				}),
				...
				new e.code({
					...
					output: () => {
						return new h.div(
							...
							new h.div({ row: true }, [new h.div({ col: "sm-3" }, "Level 1: .col-sm-3"), new h.div({ col: "sm-9" }, new h.div({ row: true }, [new h.div({ col: [8, "sm-6"] }, "Level 2: .col-8 .col-sm-6"), new h.div({ col: [4, "sm-6"] }, "Level 2: .col-4 .col-sm-6")]))])
						);
					},
				}),
			]),
			...
			new e.section([new e.title("Customizing the grid"), new e.text("Using Bootstrap built-in grid Sass variables and maps, it’s possible to completely customize the predefined grid classes. Change the number of tiers, the media query dimensions, and the container widths—then recompile.")]),
...
col: "md-auto"
}, "Variable width content"), new h.div({
col: [true, "lg-2"]
}, "2 of 3")]),
new h.div({
row: true
...
col: "md-auto"
}, "Variable witth content"), new h.div({
col: true
}, "3 of 3")]),
]);
}`,
...
col: "sm-3"
}, "Level 1: .col-sm-3"), new h.div({
col: "sm-9"
}, new h.div({
row: true
}, [new h.div({
col: [8, "sm-6"]
}, "Level 2: .col-8 .col-sm-6"), new h.div({
col: [4, "sm-6"]
...
class: "example-content-main"
}, "Main content"), new h.div({
class: "example-content-secondary"
}, "Secondary content")]));
}`,
		},
	],
