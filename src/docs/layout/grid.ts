					...
					[
						new b.table.thead(
							new b.table.tr([
								...
								new b.table.th({ scope: "col" }, [
									"xs",
									new h.div({ fontWeight: "normal" }, "<576px"),
								]),
								new b.table.th({ scope: "col" }, [
									"sm",
									new h.div({ fontWeight: "normal" }, "≥576px"),
								...
								new b.table.th({ scope: "col" }, [
									"md",
									new h.div({ fontWeight: "normal" }, "≥768px"),
								]),
								new b.table.th({ scope: "col" }, [
									"lg",
									new h.div({ fontWeight: "normal" }, "≥992px"),
								]),
								new b.table.th({ scope: "col" }, [
									"xl",
									new h.div({ fontWeight: "normal" }, "≥1200px"),
								]),
								new b.table.th({ scope: "col" }, [
									"xxl",
									new h.div({ fontWeight: "normal" }, "≥1400px"),
								]),
							])
						),
						new b.table.tbody([
							new b.table.tr([
								new b.table.th(
									{ scope: "row" },
									new h.div("Container {{max-width}}")
								),
								new b.table.td(
									{ responsiveAttr: "bs-title-name", responsiveTitle: "Small" },
									"None (auto)"
								),
								new b.table.td(
									{ responsiveAttr: "bs-title-name", responsiveTitle: "Small" },
								...
								new b.table.td(
									{ responsiveAttr: "bs-title-name", responsiveTitle: "Medium" },
									"720px"
								),
								new b.table.td(
									{ responsiveAttr: "bs-title-name", responsiveTitle: "Large" },
									"960px"
								),
								new b.table.td(
									{ responsiveAttr: "bs-title-name", responsiveTitle: "X-Large" },
									"1140px"
								),
								new b.table.td(
									{
										responsiveAttr: "bs-title-name",
										responsiveTitle: "XX-Large",
									},
									"1320px"
								),
							]),
								...
								new b.table.td(
									{
										colspan: 6,
										responsiveAttr: "bs-title-name",
										responsiveTitle: "All breakpoint",
									},
									"12"
								),
							]),
				...
				new e.code({
					...
					output: () => {
						return new h.div({ container: true, textAlign: "center" }, [
							new h.div({ row: true }, [
								new h.div({ col: true }, "1 of 2"),
								new h.div({ col: true }, "2 of 2"),
							]),
							new h.div({ row: true }, [
...
new h.div({ col: 6 }, ".col-6"),
		...
		{
			source: `() => {
return new h.div({ container: true, textAlign: "center" }, new h.div({ row: true, rowCol: 2 }, [
new h.div({ col: true }, "Column"),
new h.div({ col: true }, "Column"),
new h.div({ col: true }, "Column"),
new h.div({ col: true }, "Column"),
		...
		{
			source: `() => {
return new h.div({ container: true, textAlign: "center" }, new h.div({ row: true, rowCol: 3 }, [
new h.div({ col: true }, "Column"),
new h.div({ col: true }, "Column"),
new h.div({ col: true }, "Column"),
new h.div({ col: true }, "Column"),
		...
		{
			source: `() => {
return new h.div({ container: true, textAlign: "center" }, new h.div({ row: true, rowCol: "auto" }, [
new h.div({ col: true }, "Column"),
new h.div({ col: true }, "Column"),
new h.div({ col: true }, "Column"),
new h.div({ col: true }, "Column"),
		...
		{
			source: `() => {
return new h.div({ container: true, textAlign: "center" }, new h.div({ row: true, rowCol: 4 }, [
new h.div({ col: true }, "Column"),
new h.div({ col: true }, "Column"),
new h.div({ col: true }, "Column"),
new h.div({ col: true }, "Column"),
...
new h.div({ col: true }, "Column"),
		...
		{
			source: `() => {
return new h.div({ container: true, textAlign: "center" }, new h.div({ row: true, rowCol: [1, "sm-2", "md-4"] }, [
new h.div({ col: true }, "Column"),
new h.div({ col: true }, "Column"),
new h.div({ col: true }, "Column"),
new h.div({ col: true }, "Column"),
...
return new h.div({ container: true, textAlign: "center" }, new h.div({ row: true }, [
new h.div({ col: "sm-3" }, "Level 1: .col-sm-3"),
new h.div({ col: "sm-9" }, new h.div({ row: true }, [
...
new h.div({ col: [4, "sm-6"] }, "Level 2: .col-4 .col-sm-6"),
		...
		{
			source: `() => {
return new h.div({ class: "example-container" }, new h.div({ class: "example-row" }, [
new h.div({ class: "example-content-main" }, "Main content"),
