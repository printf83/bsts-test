...
export const gutters: IContent = {
	...
	db: [
		{
			source: `() => {
return new h.div({ container: true, paddingX: 4, textAlign: "center" }, new h.div({ row: true, gutterX: 5 }, [
...
new h.div({ col: true }, new h.div({ padding: 3 }, "Custom column padding")),
		...
		{
			source: `() => {
return new h.div({ container: true, overflow: "hidden", textAlign: "center" }, new h.div({ row: true, gutterX: 5 }, [
new h.div({ col: true }, new h.div({ padding: 3 }, "Custom column padding")),
new h.div({ col: true }, new h.div({ padding: 3 }, "Custom column padding")),
]));
}`,
