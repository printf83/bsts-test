...
export const dropdowns: IContent = {
	...
	db: [
		...
		},
		{
			source: `() => {
                        return [
                            new b.dropdown.menu({ theme: "light", debug: true, shadow: true, style: { minWidth: "320px" } }, new b.calendar({
                                paddingX: 2,
                                view: new Date(),
                                startDate: new Date(),
                                on: {
                            ...
                            new b.dropdown.menu({ theme: "dark", debug: true, shadow: true, style: { minWidth: "320px" } }, new b.calendar({
                                paddingX: 2,
                                view: new Date(),
                                startDate: new Date(),
                                on: {
