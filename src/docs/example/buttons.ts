					...
					output: () => {
						return [
							new b.button(
								{ color: "primary" },
								new b.caption(
									{ icon: "arrow-right-short", iconPosition: "end" },
									"Primary icon"
								)
							),
							new b.button(
...
new b.button({ color: "primary" }, "Primary action"),
		...
		},
		{
			source: `() => {
return [
new b.button({ color: "primary" }, new b.caption({ icon: "arrow-right-short", iconPosition: "end" }, "Primary icon")),
new b.button({ color: "secondary", outline: true }, new b.caption({ icon: "arrow-right-short", iconPosition: "end" }, "Secondary icon")),
];
}`,
		},
		{
...
new b.button({ disabled: true }, new b.caption({ icon: new b.spinner({ type: "border", small: true }, "") }, "Loading...")),
];
}`,
		},
		{
