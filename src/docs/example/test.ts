...
elem: i,
		...
		{
			source: `() => {
return [undefined, 45, 90, 135, 180, 225, 270, 315].map((i) => new h.div({
display: "flex",
justifyContent: "center",
alignItem: "center",
padding: 2,
...
elem: i ? i : "normal",
		...
		{
			source: `() => {
return [undefined, "vertical", "horizontal", "both"].map((i) => new h.div({
display: "flex",
justifyContent: "center",
alignItem: "center",
padding: 2,
...
//dialog show after 300 ms
setTimeout((target) => {
new chart_js_auto__WEBPACK_IMPORTED_MODULE_3__["default"](target, {
type: "line",
data: {
labels: Array(arg.data.length).fill(""),
datasets: [
